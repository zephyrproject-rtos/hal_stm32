...
#include "stm32_hal_psa_driver_interface.h"
#endif
...
typedef union {
    ...
    stm32_hal_transparent_driver_hash_operation_t stm32_hal_driver_ctx;
#endif
...
typedef union {
    ...
    stm32_hal_transparent_driver_cipher_operation_t stm32_hal_driver_ctx;
#endif
