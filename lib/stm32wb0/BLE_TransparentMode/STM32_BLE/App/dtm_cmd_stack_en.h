...
#define HCI_LE_ADD_DEVICE_TO_MONITORED_ADVERTISERS_LIST_ENABLED\
    (CONTROLLER_SCAN_ENABLED)
...
#define HCI_LE_CLEAR_ADVERTISING_SETS_ENABLED\
    (CONTROLLER_EXT_ADV_SCAN_ENABLED)
#define HCI_LE_CLEAR_MONITORED_ADVERTISERS_LIST_ENABLED\
    (CONTROLLER_SCAN_ENABLED)
...
#define HCI_LE_ENABLE_MONITORING_ADVERTISERS_ENABLED\
    (CONTROLLER_SCAN_ENABLED)
...
#define HCI_LE_PERIODIC_ADVERTISING_TERMINATE_SYNC_ENABLED\
    (CONTROLLER_SCAN_ENABLED &\
     CONTROLLER_EXT_ADV_SCAN_ENABLED &\
     CONTROLLER_PERIODIC_ADV_ENABLED)
#define HCI_LE_READ_ALL_REMOTE_FEATURES_ENABLED\
    (CONNECTION_ENABLED)
...
#define HCI_LE_READ_MAXIMUM_DATA_LENGTH_ENABLED\
    (CONTROLLER_DATA_LENGTH_EXTENSION_ENABLED &\
     CONNECTION_ENABLED)
#define HCI_LE_READ_MONITORED_ADVERTISERS_LIST_SIZE_ENABLED\
    (CONTROLLER_SCAN_ENABLED)
...
#define HCI_LE_READ_PHY_ENABLED\
    (CONTROLLER_2M_CODED_PHY_ENABLED &\
     CONNECTION_ENABLED)
#define HCI_LE_READ_REMOTE_FEATURES_PAGE_0_ENABLED\
    (CONNECTION_ENABLED)
...
#define HCI_LE_REMOVE_DEVICE_FROM_MONITORED_ADVERTISERS_LIST_ENABLED\
    (CONTROLLER_SCAN_ENABLED)
...
#define HCI_LE_SET_HOST_FEATURE_ENABLED\
    (CONTROLLER_EXT_ADV_SCAN_ENABLED |\
     CONNECTION_ENABLED)
#define HCI_LE_SET_HOST_FEATURE_V2_ENABLED\
    (CONTROLLER_EXT_ADV_SCAN_ENABLED |\
     CONNECTION_ENABLED)
