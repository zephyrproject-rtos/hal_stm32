...
#ifndef STM32U3xx_HAL_LCD_H
#define STM32U3xx_HAL_LCD_H
...
#define __HAL_LCD_BLINK_CONFIG(__HANDLE__, __BLINKMODE__, __BLINKFREQUENCY__)         \
  do {                                                                    \
    MODIFY_REG((__HANDLE__)->Instance->FCR, \
               (LCD_FCR_BLINKF | LCD_FCR_BLINK), \
...
void HAL_LCD_UpdateDisplayDoneCallback(LCD_HandleTypeDef *hlcd);
void HAL_LCD_StartOfFrameCallback(LCD_HandleTypeDef *hlcd);
