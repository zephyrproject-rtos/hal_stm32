...
/**
  * @brief STM32C0xx HAL Driver version number
   */
#define __STM32C0xx_HAL_VERSION_MAIN   (0x01UL) /*!< [31:24] main version */
#define __STM32C0xx_HAL_VERSION_SUB1   (0x04UL) /*!< [23:16] sub1 version */
#define __STM32C0xx_HAL_VERSION_SUB2   (0x01UL) /*!< [15:8]  sub2 version */
#define __STM32C0xx_HAL_VERSION_RC     (0x00UL) /*!< [7:0]  release candidate */
