  ...
  ******************************************************************************
  ...
  [..]
    ...
    (+) Debug mode: When the microcontroller enters debug mode (core halted),
        ...
        __HAL_DBGMCU_FREEZE_IWDG1() to __HAL_DBGMCU_FREEZE_IWDG5() and
        __HAL_DBGMCU_UNFREEZE_IWDG1() to __HAL_DBGMCU_UNFREEZE_IWDG5() macros.

    [..] Min-max timeout value @32KHz (LSI): ~125us / ~131.04s
         The IWDG timeout may vary due to LSI clock frequency dispersion.
         STM32MP2xx devices provide the capability to measure the LSI clock
