...
/** @defgroup MDF_Private_Constants  MDF Private Constants
  * @{
  */
#define MDF_INSTANCE_NUMBER 9U /* 8 instances for MDF1 and 1 instance for ADF1 */
/**
  * @}
  */
...
static uint32_t MDF_GetHandleNumberFromInstance(const MDF_Filter_TypeDef *const pInstance)
{
  ...
  else if (pInstance == MDF1_Filter6)
  {
    handle_number = 6U;
  }
  else if (pInstance == MDF1_Filter7)
  {
    handle_number = 7U;
  }
  else /* ADF1_Filter0 */
