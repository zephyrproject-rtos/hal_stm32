...
#if defined (USART1) || defined (USART2) || defined (USART3) || defined (UART4) || defined (UART5) || defined (USART6) || defined (UART7) || defined (UART8) || defined (UART9)
...
#define IS_LL_USART_BAUDRATE(__BAUDRATE__) ((__BAUDRATE__) <= 25000000U)
...
ErrorStatus LL_USART_DeInit(const USART_TypeDef *USARTx)
{
  ...
  if (USARTx == USART1)
  {
    ...
    LL_RCC_USART1_ForceReset();

    /* Release reset of USART clock */
    LL_RCC_USART1_ReleaseReset();
  }
  else if (USARTx == USART2)
  {
    /* Force reset of USART clock */
    LL_RCC_USART2_ForceReset();

    /* Release reset of USART clock */
    LL_RCC_USART2_ReleaseReset();
  }
  else if (USARTx == USART3)
  {
    /* Force reset of USART clock */
    LL_RCC_USART3_ForceReset();

    /* Release reset of USART clock */
    LL_RCC_USART3_ReleaseReset();
  }
  else if (USARTx == UART4)
  {
    /* Force reset of UART clock */
    LL_RCC_UART4_ForceReset();

    /* Release reset of UART clock */
    LL_RCC_UART4_ReleaseReset();
  }
  else if (USARTx == UART5)
  {
    /* Force reset of UART clock */
    LL_RCC_UART5_ForceReset();

    /* Release reset of UART clock */
    LL_RCC_UART5_ReleaseReset();
  }
  else if (USARTx == USART6)
  {
    /* Force reset of USART clock */
    LL_RCC_USART6_ForceReset();

    /* Release reset of USART clock */
    LL_RCC_USART6_ReleaseReset();
  }
  else if (USARTx == UART7)
  {
    /* Force reset of UART clock */
    LL_RCC_UART7_ForceReset();
...
ErrorStatus LL_USART_Init(USART_TypeDef *USARTx, const LL_USART_InitTypeDef *USART_InitStruct)
{
  ...
  if (LL_USART_IsEnabled(USARTx) == 0U)
  {
    ...
    {
      periphclk = LL_RCC_GetUARTClockFreq(LL_RCC_USART35_CLKSOURCE);
    }
    else if (USARTx == UART4)
    {
      periphclk = LL_RCC_GetUARTClockFreq(LL_RCC_UART24_CLKSOURCE);
...
#endif /* USART1 || USART2 || USART3 || UART4 || UART5 || USART6 || UART7 || UART8 || UART9 */
