...
ErrorStatus LL_LPTIM_DeInit(const LPTIM_TypeDef *LPTIMx)
{
  ...
  if (LPTIMx == LPTIM1)
  {
    LL_RCC_LPTIM1_ForceReset();
    LL_RCC_LPTIM1_ReleaseReset();
  }
  else if (LPTIMx == LPTIM2)
  {
    LL_RCC_LPTIM2_ForceReset();
    LL_RCC_LPTIM2_ReleaseReset();
  }
  else if (LPTIMx == LPTIM3)
  {
    LL_RCC_LPTIM3_ForceReset();
    LL_RCC_LPTIM3_ReleaseReset();
  }
  else if (LPTIMx == LPTIM4)
  {
    LL_RCC_LPTIM4_ForceReset();
    LL_RCC_LPTIM4_ReleaseReset();
  }
  else if (LPTIMx == LPTIM5)
  {
    LL_RCC_LPTIM5_ForceReset();
    LL_RCC_LPTIM5_ReleaseReset();
  }
#endif /* CORE_CM0PLUS */
  else
  {
