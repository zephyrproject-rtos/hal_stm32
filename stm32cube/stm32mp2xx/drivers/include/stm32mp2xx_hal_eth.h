...
#ifndef STM32MP2xx_HAL_ETH_H
#define STM32MP2xx_HAL_ETH_H
...
/** @defgroup ETH_Tx_DMA_Burst_Length ETH Tx DMA Burst Length
  * @{
  */
#define ETH_TXDMABURSTLENGTH_1BEAT          ETH_DMAC0TXCR_TXPBL_1PBL
#define ETH_TXDMABURSTLENGTH_2BEAT          ETH_DMAC0TXCR_TXPBL_2PBL
#define ETH_TXDMABURSTLENGTH_4BEAT          ETH_DMAC0TXCR_TXPBL_4PBL
#define ETH_TXDMABURSTLENGTH_8BEAT          ETH_DMAC0TXCR_TXPBL_8PBL
#define ETH_TXDMABURSTLENGTH_16BEAT         ETH_DMAC0TXCR_TXPBL_16PBL
#define ETH_TXDMABURSTLENGTH_32BEAT         ETH_DMAC0TXCR_TXPBL_32PBL
/**
  * @}
  */
...
/** @defgroup ETH_Rx_DMA_Burst_Length ETH Rx DMA Burst Length
  * @{
  */
#define ETH_RXDMABURSTLENGTH_1BEAT          ETH_DMAC0RXCR_RXPBL_1PBL
#define ETH_RXDMABURSTLENGTH_2BEAT          ETH_DMAC0RXCR_RXPBL_2PBL
#define ETH_RXDMABURSTLENGTH_4BEAT          ETH_DMAC0RXCR_RXPBL_4PBL
#define ETH_RXDMABURSTLENGTH_8BEAT          ETH_DMAC0RXCR_RXPBL_8PBL
#define ETH_RXDMABURSTLENGTH_16BEAT         ETH_DMAC0RXCR_RXPBL_16PBL
#define ETH_RXDMABURSTLENGTH_32BEAT         ETH_DMAC0RXCR_RXPBL_32PBL
/**
  * @}
  */
...
#define ETH_TRANSMITTHRESHOLD_96       ETH_MTLTXQ0OMR_TTC_96BITS
#define ETH_TRANSMITTHRESHOLD_128      ETH_MTLTXQ0OMR_TTC_128BITS
#define ETH_TRANSMITTHRESHOLD_192      ETH_MTLTXQ0OMR_TTC_192BITS
#define ETH_TRANSMITTHRESHOLD_256      ETH_MTLTXQ0OMR_TTC_256BITS
#define ETH_TRANSMITTHRESHOLD_384      ETH_MTLTXQ0OMR_TTC_384BITS
#define ETH_TRANSMITTHRESHOLD_512      ETH_MTLTXQ0OMR_TTC_512BITS
/**
  * @}
  */
...
#define ETH_RECEIVETHRESHOLD8_96       ETH_MTLRXQ0OMR_RTC_96BITS
#define ETH_RECEIVETHRESHOLD8_128      ETH_MTLRXQ0OMR_RTC_128BITS
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
#define __HAL_ETH_DMA_ENABLE_IT(__HANDLE__, __INTERRUPT__) ((__HANDLE__)->Instance->DMAC0IER |= (__INTERRUPT__))
...
/**
  ...
  * @retval None
  */
#define __HAL_ETH_DMA_DISABLE_IT(__HANDLE__, __INTERRUPT__) ((__HANDLE__)->Instance->DMAC0IER &= ~(__INTERRUPT__))
...
#define __HAL_ETH_DMA_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) \
  (((__HANDLE__)->Instance->DMAC0IER &  (__INTERRUPT__)) == (__INTERRUPT__))
...
#define __HAL_ETH_DMA_GET_IT(__HANDLE__, __INTERRUPT__) \
  (((__HANDLE__)->Instance->DMAC0SR &  (__INTERRUPT__)) == (__INTERRUPT__))
...
#define ETH_WAKEUP_EXTI_LINE  0x00000040U  /* !<  IM70 in EXTI IMR3 register is bit 6 */
...
/**
  ...
  * @retval None.
  */
#define __HAL_ETH_WAKEUP_EXTI_ENABLE_IT(__EXTI_LINE__)   (EXTI1_C1->IMR3 |= (__EXTI_LINE__))
...
/**
  ...
  */
#define __HAL_ETH_WAKEUP_EXTI_GET_FLAG(__EXTI_LINE__)  (EXTI1_C1->IMR3 & (__EXTI_LINE__))
...
/**
  ...
  * @retval None.
  */
#define __HAL_ETH_WAKEUP_EXTID2_ENABLE_IT(__EXTI_LINE__)   (EXTI1_C2->IMR3 |= (__EXTI_LINE__))
...
/**
  ...
  * @retval EXTI ETH WAKEUP Line Status.
  */
#define __HAL_ETH_WAKEUP_EXTID2_GET_FLAG(__EXTI_LINE__)  (EXTI1_C2->IMR3 & (__EXTI_LINE__))
...
/**
  ...
  * @retval None
  */
#define __HAL_ETH_WAKEUP_EXTI_ENABLE_RISING_EDGE(__EXTI_LINE__) (EXTI1->FTSR3 &= ~(__EXTI_LINE__)); \
  (EXTI1->RTSR3 |= (__EXTI_LINE__))
...
/**
  ...
  * @retval None
  */
#define __HAL_ETH_WAKEUP_EXTI_ENABLE_FALLING_EDGE(__EXTI_LINE__) (EXTI1->RTSR3 &= ~(__EXTI_LINE__));\
  (EXTI1->FTSR3 |= (__EXTI_LINE__))
...
/**
  ...
  * @retval None
  */
#define __HAL_ETH_WAKEUP_EXTI_ENABLE_RISING_FALLING_EDGE(__EXTI_LINE__) (EXTI1->RTSR3 |= (__EXTI_LINE__));\
  (EXTI1->FTSR3 |= (__EXTI_LINE__))
...
/**
  ...
  * @retval None
  */
#define __HAL_ETH_WAKEUP_EXTI_GENERATE_SWIT(__EXTI_LINE__) (EXTI1->SWIER3 |= (__EXTI_LINE__))
...
#include "stm32mp2xx_hal_eth_ex.h"
