...
#ifndef STM32MP2xx_HAL_PSSI_H
#define STM32MP2xx_HAL_PSSI_H
...
typedef struct __PSSI_HandleTypeDef
{
  ...
  uint8_t              *pBuffPtr;    /*!< PSSI Data buffer.              */
...
/**
  ...
  * @param  __DATAWIDTH__ PSSI Data width
  * @retval Valid or not.
  */

#define IS_PSSI_DATAWIDTH(__DATAWIDTH__) (((__DATAWIDTH__) == HAL_PSSI_8BITS    ) || \
                                          ((__DATAWIDTH__) == HAL_PSSI_16BITS   ) || \
                                          ((__DATAWIDTH__) == HAL_PSSI_32BITS   ))
