/**
  ******************************************************************************
  * @file    stm32mp2xx_hal_smartcard.h
...
#ifndef STM32MP2xx_HAL_SMARTCARD_H
#define STM32MP2xx_HAL_SMARTCARD_H
...
/** @brief  Report the SMARTCARD clock source.
  ...
  * @retval the SMARTCARD clocking source, written in __CLOCK__.
  */
#define SMARTCARD_GETCLOCK(__HANDLE__,__CLOCK__)          \
  do {                                                    \
...
/** @brief  Check the Baud rate range.
  * @note   The maximum Baud Rate is derived from the maximum clock on MP2 (200 MHz)
  ...
  */
#define IS_SMARTCARD_BAUDRATE(__BAUDRATE__) ((__BAUDRATE__) < 25000001U)
...
#include "stm32mp2xx_hal_smartcard_ex.h"
...
#endif /* STM32MP2xx_HAL_SMARTCARD_H */
