...
#ifndef STM32MP2xx_HAL_SD_H
#define STM32MP2xx_HAL_SD_H
...
/* Includes ------------------------------------------------------------------*/
#include "stm32mp2xx_ll_sdmmc.h"
#if defined (DLYB_SDMMC1) || defined (DLYB_SDMMC2) || defined (DLYB_SDMMC3)
#include "stm32mp2xx_ll_delayblock.h"
...
#include "stm32mp2xx_hal_sd_ex.h"
