...
#ifndef STM32MP2xx_HAL_ADC_EX_H
#define STM32MP2xx_HAL_ADC_EX_H
...
#define ADC_EXTERNALTRIGINJEC_T20_TRGO      (LL_ADC_INJ_TRIG_EXT_TIM20_TRGO)     /*!< ADC group injected conversion trigger from external peripheral: TIM20 TRGO event. Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T20_TRGO2     (LL_ADC_INJ_TRIG_EXT_TIM20_TRGO2)    /*!< ADC group injected conversion trigger from external peripheral: TIM20 TRGO2 event.Trigger edge set to rising edge (default setting). */
...
#define ADC_EXTERNALTRIGINJEC_T5_TRGO       (LL_ADC_INJ_TRIG_EXT_TIM5_TRGO)      /*!< ADC group injected conversion trigger from external peripheral: TIM5 TRGO event.  Trigger edge set to rising edge (default setting). */
...
#define ADC_EXTERNALTRIGINJEC_T7_TRGO       (LL_ADC_INJ_TRIG_EXT_TIM7_TRGO)      /*!< ADC group injected conversion trigger from external peripheral: TIM7 TRGO event.  Trigger edge set to rising edge (default setting). */
...
#define ADC_EXTERNALTRIGINJEC_T16_CC1       (LL_ADC_INJ_TRIG_EXT_TIM16_CC1)      /*!< ADC group injected conversion trigger from external peripheral: TIM16 channel 1 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T1_CC3_ADC12  (LL_ADC_INJ_TRIG_EXT_TIM1_CC3_ADC12) /*!< ADC group injected conversion trigger from external peripheral: TIM1  channel 3 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T8_CC1        (LL_ADC_INJ_TRIG_EXT_TIM8_CC1)       /*!< ADC group injected conversion trigger from external peripheral: TIM8  channel 1 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T20_CC1       (LL_ADC_INJ_TRIG_EXT_TIM20_CC1)      /*!< ADC group injected conversion trigger from external peripheral: TIM20 channel 1 event.(capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T2_CC1        (LL_ADC_INJ_TRIG_EXT_TIM2_CC1)       /*!< ADC group injected conversion trigger from external peripheral: TIM2  channel 1 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T2_CC3        (LL_ADC_INJ_TRIG_EXT_TIM2_CC3)       /*!< ADC group injected conversion trigger from external peripheral: TIM2  channel 3 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T3_CC1        (LL_ADC_INJ_TRIG_EXT_TIM3_CC1)       /*!< ADC group injected conversion trigger from external peripheral: TIM3  channel 1 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T4_CC1        (LL_ADC_INJ_TRIG_EXT_TIM4_CC1)       /*!< ADC group injected conversion trigger from external peripheral: TIM4  channel 1 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T5_CC3        (LL_ADC_INJ_TRIG_EXT_TIM5_CC3)       /*!< ADC group injected conversion trigger from external peripheral: TIM5  channel 3 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T12_CC1       (LL_ADC_INJ_TRIG_EXT_TIM12_CC1)      /*!< ADC group injected conversion trigger from external peripheral: TIM12 channel 1 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
...
#define ADC_EXTERNALTRIGINJEC_LPTIM1_CH2    (LL_ADC_INJ_TRIG_EXT_LPTIM1_CH2)     /*!< ADC group injected conversion trigger from external peripheral: LPTIM1 channel 2 event. Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_LPTIM2_CH2    (LL_ADC_INJ_TRIG_EXT_LPTIM2_CH2)     /*!< ADC group injected conversion trigger from external peripheral: LPTIM2 channel 2 event. Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_LPTIM3_CH1    (LL_ADC_INJ_TRIG_EXT_LPTIM3_CH1)     /*!< ADC group injected conversion trigger from external peripheral: LPTIM3 channel 1 event. Trigger edge set to rising edge (default setting). */
...
#define ADC_EXTERNALTRIGINJEC_T8_CC4        (LL_ADC_INJ_TRIG_EXT_TIM8_CC4)       /*!< ADC group injected conversion trigger from external peripheral: TIM8 channel 4 event  (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T20_CC2       (LL_ADC_INJ_TRIG_EXT_TIM20_CC2)      /*!< ADC group injected conversion trigger from external peripheral: TIM20 channel 2 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T4_CC3        (LL_ADC_INJ_TRIG_EXT_TIM4_CC3)       /*!< ADC group injected conversion trigger from external peripheral: TIM4 channel 3 event  (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T4_CC4        (LL_ADC_INJ_TRIG_EXT_TIM4_CC4)       /*!< ADC group injected conversion trigger from external peripheral: TIM4 channel 4 event  (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T5_CC1        (LL_ADC_INJ_TRIG_EXT_TIM5_CC1)       /*!< ADC group injected conversion trigger from external peripheral: TIM5 channel 1 event  (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T12_CC2       (LL_ADC_INJ_TRIG_EXT_TIM12_CC2)      /*!< ADC group injected conversion trigger from external peripheral: TIM12 channel 2 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
#define ADC_EXTERNALTRIGINJEC_T15_CC1       (LL_ADC_INJ_TRIG_EXT_TIM15_CC1)      /*!< ADC group injected conversion trigger from external peripheral: TIM15 channel 1 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
...
#define ADC_AWD23THRESHOLD_SHIFT_RESOLUTION(__HANDLE__, __THRESHOLD__)                                       \
  ((((__HANDLE__)->Instance->CFGR1 & ADC_CFGR1_RES) != (ADC_CFGR1_RES_1 | ADC_CFGR1_RES_0))                    ? \
   ((__THRESHOLD__) >> ((4UL - ((((__HANDLE__)->Instance->CFGR1 & ADC_CFGR1_RES) >> 2UL) * 2UL)) & 0x1FUL)) : \
   ((__THRESHOLD__) << 2UL)                                                                                 \
  )
...
/**
  * @brief Verify the ADC instance connected to the internal voltage reference VREFPLUS.
  * @param __HANDLE__ ADC handle.
  * @retval SET (ADC instance is valid) or RESET (ADC instance is invalid)
  */
#if defined(ADC3)
#define ADC_VREFPLUS_INSTANCE(__HANDLE__)  ((((__HANDLE__)->Instance) == ADC1) ||\
                                            (((__HANDLE__)->Instance) == ADC2) ||\
                                            (((__HANDLE__)->Instance) == ADC3) )
#else
#define ADC_VREFPLUS_INSTANCE(__HANDLE__)  ((((__HANDLE__)->Instance) == ADC1) ||\
...
#endif /* ADC3 */
/**
  * @brief Verify the ADC instance connected to the internal VDDCPU.
  * @param __HANDLE__ ADC handle.
  * @retval SET (ADC instance is valid) or RESET (ADC instance is invalid)
  */
#if defined(ADC3)
...
#endif /* ADC3 */
/**
  * @brief Verify the ADC instance connected to the internal VDDGPU.
  * @param __HANDLE__ ADC handle.
  * @retval SET (ADC instance is valid) or RESET (ADC instance is invalid)
  */
#if defined(ADC3)
#define ADC_VDDGPU_INSTANCE(__HANDLE__)  ((((__HANDLE__)->Instance) == ADC2) ||\
                                          (((__HANDLE__)->Instance) == ADC3) )
#else
#define ADC_VDDGPU_INSTANCE(__HANDLE__)  ((((__HANDLE__)->Instance) == ADC2) )
#endif /* ADC3 */
...
#define IS_ADC_CHANNEL(__CHANNEL__) (((__CHANNEL__) == ADC_CHANNEL_0)           || \
                                     ...
                                     ((__CHANNEL__) == ADC_CHANNEL_VDDCPU)      || \
                                     ((__CHANNEL__) == ADC_CHANNEL_VDDGPU)      || \
...
#define IS_ADC_EXTTRIGINJEC_ADC12(__INJ_TRIG_SOURCE__)                    \
  (   ((__INJ_TRIG_SOURCE__) == ADC_INJECTED_SOFTWARE_START)              \
      ...
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T20_TRGO)        \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T20_TRGO2)       \
      ...
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T16_CC1)         \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T1_CC3_ADC12)    \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T8_CC1)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T20_CC1)         \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T2_CC1)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T2_CC3)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T3_CC1)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T4_CC1)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T5_CC3)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T12_CC1)         \
      ...
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_LPTIM4_CH1)      \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_LPTIM5_OUT)      \
  )

#define IS_ADC_EXTTRIGINJEC_ADC3(__INJ_TRIG_SOURCE__)                      \
  (   ((__INJ_TRIG_SOURCE__) == ADC_INJECTED_SOFTWARE_START)               \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T1_TRGO)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T1_TRGO2)         \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T8_TRGO)          \
      ...
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T7_TRGO)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T15_TRGO)         \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T1_CC3_ADC3)      \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T1_CC4)           \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T8_CC2)           \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T8_CC4)           \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T20_CC2)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T4_CC3)           \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T4_CC4)           \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T5_CC1)           \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T12_CC2)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_T15_CC1)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_EXT_IT3)          \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_LPTIM1_CH2)       \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_LPTIM2_CH2)       \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_LPTIM3_CH1)       \
      || ((__INJ_TRIG_SOURCE__) == ADC_EXTERNALTRIGINJEC_LPTIM4_CH1)       \
