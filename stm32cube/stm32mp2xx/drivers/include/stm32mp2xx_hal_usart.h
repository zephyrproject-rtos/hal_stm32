...
#ifndef STM32MP2xx_HAL_USART_H
#define STM32MP2xx_HAL_USART_H
...
/** @brief  Check USART Baud rate.
  ...
  *         The maximum Baud Rate is derived from the maximum clock on MP2 (i.e. 200 MHz)
  *         divided by the smallest oversampling used on the USART (i.e. 8)
  * @retval SET (__BAUDRATE__ is valid) or RESET (__BAUDRATE__ is invalid)  */
#define IS_USART_BAUDRATE(__BAUDRATE__) ((__BAUDRATE__) <= 25000000U)
...
#include "stm32mp2xx_hal_usart_ex.h"
