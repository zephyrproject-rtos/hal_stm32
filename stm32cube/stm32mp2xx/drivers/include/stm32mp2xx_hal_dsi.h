...
#ifndef STM32MP2xx_HAL_DSI_H
#define STM32MP2xx_HAL_DSI_H
...
#define DSI_THREE_DATA_LANES       2U
#define DSI_FOUR_DATA_LANES        3U
/**
  * @}
  */
...
/** @defgroup DSI_PLL_IDF DSI PLL IDF
  * @{
  */
#define DSI_PLL_IN_DIV1             0x00000000U
#define DSI_PLL_IN_DIV2             0x00000001U
#define DSI_PLL_IN_DIV3             0x00000002U
#define DSI_PLL_IN_DIV4             0x00000003U
#define DSI_PLL_IN_DIV5             0x00000004U
#define DSI_PLL_IN_DIV6             0x00000005U
#define DSI_PLL_IN_DIV7             0x00000006U
#define DSI_PLL_IN_DIV8             0x00000007U
#define DSI_PLL_IN_DIV9             0x00000008U
#define DSI_PLL_IN_DIV10            0x00000009U
#define DSI_PLL_IN_DIV11            0x0000000AU
#define DSI_PLL_IN_DIV12            0x0000000BU
#define DSI_PLL_IN_DIV13            0x0000000CU
#define DSI_PLL_IN_DIV14            0x0000000DU
#define DSI_PLL_IN_DIV15            0x0000000EU
#define DSI_PLL_IN_DIV16            0x0000000FU
/**
  * @}
  */
...
#define DSI_FLAG_LAE                DSI_WISR_LAEIF
/**
  * @}
  */
...
#define DSI_IT_LAE                  DSI_WIER_LAEIE
/**
  * @}
  */
...
#define DSI_DATA_LANE2              0x00000003U
#define DSI_DATA_LANE3              0x00000004U
/**
  * @}
  */
...
#define __HAL_DSI_PLL_ENABLE(__HANDLE__) do { \
                                              __IO uint32_t tmpreg = 0x00U; \
                                              SET_BIT((__HANDLE__)->Instance->WRPCR2, DSI_WRPCR2_PLLEN);\
                                              /* Delay after an DSI PLL enabling */ \
                                              tmpreg = READ_BIT((__HANDLE__)->Instance->WRPCR2, DSI_WRPCR2_PLLEN);\
                                              UNUSED(tmpreg); \
                                            } while(0U)
...
#define __HAL_DSI_PLL_DISABLE(__HANDLE__) do { \
                                               __IO uint32_t tmpreg = 0x00U; \
                                               CLEAR_BIT((__HANDLE__)->Instance->WRPCR2, DSI_WRPCR2_PLLEN);\
...
/**
  ...
  *            @arg DSI_FLAG_LAE  : LCD APB Error Interrupt Flag
...
/**
  ...
  *            @arg DSI_IT_LAE : LCD APB Error Interrupt
  * @retval None
  */
...
/** @defgroup DSI_Private_Macros DSI Private Macros
  * @{
  */
#define IS_DSI_PLL_NDIV(NDIV)                       ((64U <= (NDIV)) && ((NDIV) <= 625U))
#define IS_DSI_PLL_IDF(IDF)                         (((IDF) == DSI_PLL_IN_DIV1) || \
                                                     ...
                                                     ((IDF) == DSI_PLL_IN_DIV8) || \
                                                     ((IDF) == DSI_PLL_IN_DIV9) || \
                                                     ((IDF) == DSI_PLL_IN_DIV10) || \
                                                     ((IDF) == DSI_PLL_IN_DIV11) || \
                                                     ((IDF) == DSI_PLL_IN_DIV12) || \
                                                     ((IDF) == DSI_PLL_IN_DIV13) || \
                                                     ((IDF) == DSI_PLL_IN_DIV14) || \
                                                     ((IDF) == DSI_PLL_IN_DIV15) || \
                                                     ((IDF) == DSI_PLL_IN_DIV16))
