...
#ifndef STM32MP2xx_HAL_TIM_H
#define STM32MP2xx_HAL_TIM_H
...
/** @defgroup TIM_Break_System TIM Break System
  * @{
  */
#define TIM_BREAK_SYSTEM_RETRAM              SYSCFG_CBR_RETRAML  /*!< Enables and locks the RETRAM ECC error signal with Break Input of TIM1/8/15/16/17/20 */
#define TIM_BREAK_SYSTEM_BKPRAM              SYSCFG_CBR_BKRAML   /*!< Enables and locks the BKPRAM ECC error signal with Break Input of TIM1/8/15/16/17/20 */
#define TIM_BREAK_SYSTEM_PVD                 SYSCFG_CBR_PVDL     /*!< Enables and locks the PVD connection with TIM1/8/15/16/17/20 Break Input and also the PVDE and PLS bits of the Power Control Interface */
#define TIM_BREAK_SYSTEM_LOCKUP              SYSCFG_CBR_CLL      /*!< Enables and locks the LOCKUP output of CortexM4 with Break Input of TIM1/8/15/16/17/20 */
/**
  * @}
  */
...
#define IS_TIM_BREAK_SYSTEM(__CONFIG__)    (((__CONFIG__) == TIM_BREAK_SYSTEM_RETRAM)               || \
                                            ((__CONFIG__) == TIM_BREAK_SYSTEM_BKPRAM)               || \
...
#include "stm32mp2xx_hal_tim_ex.h"
