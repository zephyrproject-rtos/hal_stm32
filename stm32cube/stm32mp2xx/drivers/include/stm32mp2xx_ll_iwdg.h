...
#ifndef STM32MP2xx_LL_IWDG_H
#define STM32MP2xx_LL_IWDG_H
...
#if defined(IWDG1) || defined(IWDG2) || defined(IWDG3) || defined(IWDG4) || defined(IWDG5)
...
#endif /* IWDG1 || IWDG2 || IWDG3 || IWDG4 || IWDG5 */
