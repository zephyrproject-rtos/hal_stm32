...
#ifndef STM32MP2xx_HAL_UART_EX_H
#define STM32MP2xx_HAL_UART_EX_H
...
/** @brief  Report the UART clock.
  * @param  __HANDLE__ specifies the UART Handle.
  * @param  __CLOCKSOURCE__ output variable.
  * @retval UART clock, written in __CLOCKSOURCE__.
  */
...
#define UART_GETCLOCKSOURCE(__HANDLE__,__CLOCKSOURCE__)   \
  do {                                                    \
    ...
    {                                                     \
      (__CLOCKSOURCE__) = RCC_PERIPHCLK_UART7_8;          \
    }                                                     \
    else if((__HANDLE__)->Instance == UART9)              \
    {                                                     \
      (__CLOCKSOURCE__) = RCC_PERIPHCLK_UART9;            \
    }                                                     \
...
/**
  ...
  */
/* no trigger 6 */
#define IS_LPUART_TRIGGER_SELECTION(__SOURCE__)  ( ((__SOURCE__) <= 11U) && ((__SOURCE__) != 6U) )
...
#endif /* STM32MP2xx_HAL_UART_EX_H */
