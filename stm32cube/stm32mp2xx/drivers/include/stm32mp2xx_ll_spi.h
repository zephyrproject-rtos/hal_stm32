...
#ifndef STM32MP2xx_LL_SPI_H
#define STM32MP2xx_LL_SPI_H
...
#define LL_SPI8_LPDMA_CH0_TCF_TRG          (uint32_t)(0x00000000U)
/*!< HW Trigger signal is LPDMA_CH1_TRG     */
#define LL_SPI8_LPDMA_CH1_TCF_TRG          (uint32_t)(0x1U << SPI_AUTOCR_TRIGSEL_Pos)
/*!< HW Trigger signal is LPDMA_CH2_TRG     */
#define LL_SPI8_LPDMA_CH2_TCF_TRG          (uint32_t)(0x2U << SPI_AUTOCR_TRIGSEL_Pos)
/*!< HW Trigger signal is LPDMA_CH3_TRG     */
#define LL_SPI8_LPDMA_CH3_TCF_TRG          (uint32_t)(0x3U << SPI_AUTOCR_TRIGSEL_Pos)
/*!< HW Trigger signal is EXTI4_TRG         */
#define LL_SPI8_EXTI4_TRG                  (uint32_t)(0x4U << SPI_AUTOCR_TRIGSEL_Pos)
/*!< HW Trigger signal is EXTI8_TRG         */
#define LL_SPI8_EXTI5_TRG                  (uint32_t)(0x5U << SPI_AUTOCR_TRIGSEL_Pos)
/*!< HW Trigger signal is LPTIM3_CH1_TRG    */
#define LL_SPI8_LPTIM3_CH1_TRG             (uint32_t)(0x7U << SPI_AUTOCR_TRIGSEL_Pos)
/*!< HW Trigger signal is LPTIM4_CH1_TRG    */
#define LL_SPI8_LPTIM4_CH1_TRG             (uint32_t)(0x8U << SPI_AUTOCR_TRIGSEL_Pos)
/*!< HW Trigger signal is LPTIM5_CH1_TRG    */
#define LL_SPI8_LPTIM5_CH1_TRG             (uint32_t)(0x9U << SPI_AUTOCR_TRIGSEL_Pos)
...
/**
  ...
  *         @arg @ref  LL_SPI8_LPDMA_CH3_TCF_TRG
  *         @arg @ref  LL_SPI8_EXTI4_TRG
  *         @arg @ref  LL_SPI8_EXTI5_TRG
  *         @arg @ref  LL_SPI8_LPTIM3_CH1_TRG
  *         @arg @ref  LL_SPI8_LPTIM4_CH1_TRG
...
{
  return (uint32_t)(READ_BIT(SPIx->AUTOCR, SPI_AUTOCR_TRIGSEL));
}
