...
#ifndef STM32MP2xx_HAL_SPI_H
#define STM32MP2xx_HAL_SPI_H
...
#include "stm32mp2xx_hal_spi_ex.h"
...
/**
  * @brief  DataSize for Partial instance
  */
#define IS_SPI_PARTIAL_DATASIZE(DATASIZE)          (((DATASIZE) == SPI_DATASIZE_16BIT) || \
                                                    ((DATASIZE) == SPI_DATASIZE_15BIT) || \
                                                    ((DATASIZE) == SPI_DATASIZE_14BIT) || \
                                                    ((DATASIZE) == SPI_DATASIZE_13BIT) || \
                                                    ((DATASIZE) == SPI_DATASIZE_12BIT) || \
...
/**
  * @brief  CRC Length for partial instance
  */
#define IS_SPI_PARTIAL_CRC_LENGTH(LENGTH)          (((LENGTH) == SPI_CRC_LENGTH_16BIT)    || \
                                                    ((LENGTH) == SPI_CRC_LENGTH_15BIT)    || \
                                                    ((LENGTH) == SPI_CRC_LENGTH_14BIT)    || \
                                                    ((LENGTH) == SPI_CRC_LENGTH_13BIT)    || \
                                                    ((LENGTH) == SPI_CRC_LENGTH_12BIT)    || \
