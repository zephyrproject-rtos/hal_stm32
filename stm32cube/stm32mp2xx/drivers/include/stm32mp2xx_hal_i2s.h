...
#ifndef STM32MP2xx_HAL_I2S_H
#define STM32MP2xx_HAL_I2S_H
...
/** @defgroup I2S_Fifo_Threshold I2S Fifo Threshold
  * @{
  */
#define I2S_FIFO_THRESHOLD_01DATA                     (0x00000000UL)
#define I2S_FIFO_THRESHOLD_02DATA                     (0x00000020UL)
#define I2S_FIFO_THRESHOLD_03DATA                     (0x00000040UL)
#define I2S_FIFO_THRESHOLD_04DATA                     (0x00000060UL)
#define I2S_FIFO_THRESHOLD_05DATA                     (0x00000080UL)
#define I2S_FIFO_THRESHOLD_06DATA                     (0x000000A0UL)
#define I2S_FIFO_THRESHOLD_07DATA                     (0x000000C0UL)
#define I2S_FIFO_THRESHOLD_08DATA                     (0x000000E0UL)
#define I2S_FIFO_THRESHOLD_09DATA                     (0x00000100UL)
#define I2S_FIFO_THRESHOLD_10DATA                     (0x00000120UL)
#define I2S_FIFO_THRESHOLD_11DATA                     (0x00000140UL)
#define I2S_FIFO_THRESHOLD_12DATA                     (0x00000160UL)
#define I2S_FIFO_THRESHOLD_13DATA                     (0x00000180UL)
#define I2S_FIFO_THRESHOLD_14DATA                     (0x000001A0UL)
#define I2S_FIFO_THRESHOLD_15DATA                     (0x000001C0UL)
#define I2S_FIFO_THRESHOLD_16DATA                     (0x000001E0UL)
/**
  * @}
  */
...
#define I2S_IT_EOT                       SPI_IER_EOTIE
#define I2S_IT_TXTF                      SPI_IER_TXTFIE
#define I2S_IT_UDR                       SPI_IER_UDRIE
#define I2S_IT_OVR                       SPI_IER_OVRIE
#define I2S_IT_FRE                       SPI_IER_TIFREIE
#define I2S_IT_MODF                      SPI_IER_MODFIE
...
/** @brief  Clear the I2S EOT pending flag.
  * @param  __HANDLE__: specifies the I2S Handle.
  * @retval None
  */
#define __HAL_I2S_CLEAR_EOTFLAG(__HANDLE__) SET_BIT((__HANDLE__)->Instance->IFCR , SPI_IFCR_EOTC)

/** @brief  Clear the I2S TXTF pending flag.
  * @param  __HANDLE__: specifies the I2S Handle.
  * @retval None
  */
#define __HAL_I2S_CLEAR_TXTFFLAG(__HANDLE__) SET_BIT((__HANDLE__)->Instance->IFCR , SPI_IFCR_TXTFC)
...
#define IS_I2S_IO_SWAP(__IOSWAP__)                  (((__IOSWAP__) == I2S_IO_SWAP_DISABLE)               || \
                                                     ((__IOSWAP__) == I2S_IO_SWAP_ENABLE))
...
#define IS_I2S_FIFO_THRESHOLD(THRESHOLD)            (((THRESHOLD) == I2S_FIFO_THRESHOLD_01DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_02DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_03DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_04DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_05DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_06DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_07DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_08DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_09DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_10DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_11DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_12DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_13DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_14DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_15DATA) || \
                                                     ((THRESHOLD) == I2S_FIFO_THRESHOLD_16DATA))
