...
ErrorStatus LL_USART_DeInit(const USART_TypeDef *USARTx)
{
  ...
  if (USARTx == USART1)
  {
    ...
    LL_APB6_GRP1_ForceReset(LL_APB6_GRP1_PERIPH_USART1);

    /* Release reset of USART clock */
    LL_APB6_GRP1_ReleaseReset(LL_APB6_GRP1_PERIPH_USART1);
  }
  else if (USARTx == USART2)
  {
    /* Force reset of USART clock */
    LL_APB6_GRP1_ForceReset(LL_APB6_GRP1_PERIPH_USART2);

    /* Release reset of USART clock */
    LL_APB6_GRP1_ReleaseReset(LL_APB6_GRP1_PERIPH_USART2);
  }
...
ErrorStatus LL_USART_Init(USART_TypeDef *USARTx, const LL_USART_InitTypeDef *USART_InitStruct)
{
  ...
  if (LL_USART_IsEnabled(USARTx) == 0U)
  {
    ...
    {
      periphclk = LL_RCC_GetUARTClockFreq(LL_RCC_USART2_CLKSOURCE);
    }
    else if (USARTx == USART3)
    {
