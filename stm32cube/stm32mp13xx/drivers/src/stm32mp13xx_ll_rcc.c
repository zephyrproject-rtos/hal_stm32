...
#define IS_LL_RCC_UART_CLKSOURCE(__VALUE__)     (((__VALUE__) == LL_RCC_USART1_CLKSOURCE) \
                                                 ...
                                                 || ((__VALUE__) == LL_RCC_USART35_CLKSOURCE) \
...
#define IS_LL_RCC_ETH_CLKSOURCE(__VALUE__)      (((__VALUE__) == LL_RCC_ETH1_CLKSOURCE) \
                                                 || ((__VALUE__) == LL_RCC_ETH2_CLKSOURCE))
...
#define IS_LL_RCC_ADC_CLKSOURCE(__VALUE__)      (((__VALUE__) == LL_RCC_ADC1_CLKSOURCE) \
                                                 || ((__VALUE__) == LL_RCC_ADC2_CLKSOURCE))
...
uint32_t RCC_GetMLAHBSClockFreq(void);
...
uint32_t RCC_GetPCLK6ClockFreq(uint32_t ACLK_Frequency);
...
ErrorStatus LL_RCC_DeInit(void)
{
  ...
  /* Reset MLAHB Sub-System Clock Selection */
  LL_RCC_SetMLAHBSClkSource(LL_RCC_MLAHBS_CLKSOURCE_HSI);
  ...
  /* Reset RCC APB6 Clock Divider */
  LL_RCC_SetAPB6Prescaler(LL_RCC_APB6_DIV_1);

  /* Reset RCC MLHCLK (MLHCLK, MLAHB, FCLK, HCLK4, HCLK2 and HCLK1) Clock Divider */
  LL_RCC_SetMLHCLKPrescaler(LL_RCC_MLAHB_DIV_1);
...
void LL_RCC_GetSystemClocksFreq(LL_RCC_ClocksTypeDef *RCC_Clocks)
{
  ...
  /*!< MLAHBS clock frequency */
  RCC_Clocks->MLAHBS_Frequency = RCC_GetMLAHBSClockFreq();

  /*!< ACLK clock frequency */
  RCC_Clocks->ACLK_Frequency = RCC_GetACLKClockFreq(RCC_Clocks->AXISS_Frequency);

  /*!< MLHCLK clock frequency */
  RCC_Clocks->MLHCLK_Frequency = RCC_GetMLHCLKClockFreq(RCC_Clocks->MLAHBS_Frequency);
  ...
  /*!< PCLK5 clock frequency */
  RCC_Clocks->PCLK6_Frequency = RCC_GetPCLK6ClockFreq(RCC_Clocks->ACLK_Frequency);
...
void LL_RCC_GetPLL1ClockFreq(LL_PLL_ClocksTypeDef *PLL_Clocks)
{
  ...
  rcc_get_m = LL_RCC_PLL1_GetM();
  rcc_get_n = LL_RCC_PLL1_GetN();
  ...
  if (rcc_get_m != 0U)
  {
    ...
    {
      PLL_Clocks->PLL_P_Frequency = LL_RCC_CalcPLLClockFreq(pllinputfreq, rcc_get_m, rcc_get_n, \
                                                            fracv, LL_RCC_PLL1_GetP());
    }
  }
}
...
void LL_RCC_GetPLL2ClockFreq(LL_PLL_ClocksTypeDef *PLL_Clocks)
{
  ...
  rcc_get_m = LL_RCC_PLL2_GetM();
  rcc_get_n = LL_RCC_PLL2_GetN();
  ...
  if (rcc_get_m != 0U)
  {
    ...
    {
      PLL_Clocks->PLL_P_Frequency = LL_RCC_CalcPLLClockFreq(pllinputfreq, \
                                                            rcc_get_m, rcc_get_n, fracv, LL_RCC_PLL2_GetP());
    }

    if (LL_RCC_PLL2Q_IsEnabled() != 0U)
    {
      PLL_Clocks->PLL_Q_Frequency = LL_RCC_CalcPLLClockFreq(pllinputfreq, \
                                                            rcc_get_m, rcc_get_n, fracv, LL_RCC_PLL2_GetQ());
    }

    if (LL_RCC_PLL2R_IsEnabled() != 0U)
    {
      PLL_Clocks->PLL_R_Frequency = LL_RCC_CalcPLLClockFreq(pllinputfreq, \
                                                            rcc_get_m, rcc_get_n, fracv, LL_RCC_PLL2_GetR());
    }
  }
}
...
void LL_RCC_GetPLL3ClockFreq(LL_PLL_ClocksTypeDef *PLL_Clocks)
{
  ...
  /* Fout3_ck = ((HSE_VALUE, CSI_VALUE or HSI_VALUE/HSIDIV) / PLLrcc_get_m) * (PLLN + (FRACV/(2^13)))
  ...
  rcc_get_m = LL_RCC_PLL3_GetM();
  rcc_get_n = LL_RCC_PLL3_GetN();
  ...
  if (rcc_get_m != 0U)
  {
    ...
    {
      PLL_Clocks->PLL_P_Frequency = LL_RCC_CalcPLLClockFreq(pllinputfreq, \
                                                            rcc_get_m, rcc_get_n, fracv, LL_RCC_PLL3_GetP());
    }

    if (LL_RCC_PLL3Q_IsEnabled() != 0U)
    {
      PLL_Clocks->PLL_Q_Frequency = LL_RCC_CalcPLLClockFreq(pllinputfreq, \
                                                            rcc_get_m, rcc_get_n, fracv, LL_RCC_PLL3_GetQ());
    }

    if (LL_RCC_PLL3R_IsEnabled() != 0U)
    {
      PLL_Clocks->PLL_R_Frequency = LL_RCC_CalcPLLClockFreq(pllinputfreq, \
                                                            rcc_get_m, rcc_get_n, fracv, LL_RCC_PLL3_GetR());
    }
  }
}
...
void LL_RCC_GetPLL4ClockFreq(LL_PLL_ClocksTypeDef *PLL_Clocks)
{
  ...
  rcc_get_m = LL_RCC_PLL4_GetM();
  rcc_get_n = LL_RCC_PLL4_GetN();
  ...
  if (rcc_get_m != 0U)
  {
    ...
    {
      PLL_Clocks->PLL_P_Frequency = LL_RCC_CalcPLLClockFreq(pllinputfreq, \
                                                            rcc_get_m, rcc_get_n, fracv, LL_RCC_PLL4_GetP());
    }

    if (LL_RCC_PLL4Q_IsEnabled() != 0U)
    {
      PLL_Clocks->PLL_Q_Frequency = LL_RCC_CalcPLLClockFreq(pllinputfreq, \
                                                            rcc_get_m, rcc_get_n, fracv, LL_RCC_PLL4_GetQ());
    }

    if (LL_RCC_PLL4R_IsEnabled() != 0U)
    {
      PLL_Clocks->PLL_R_Frequency = LL_RCC_CalcPLLClockFreq(pllinputfreq, \
                                                            rcc_get_m, rcc_get_n, fracv, LL_RCC_PLL4_GetR());
    }
  }
}
...
uint32_t LL_RCC_CalcPLLClockFreq(uint32_t PLLInputFreq, uint32_t M, uint32_t N, uint32_t FRACV, uint32_t PQR)
{
  ...
  freq = ((float32_t)PLLInputFreq / (float32_t)M) * ((float32_t)N + ((float32_t)FRACV / (float32_t)0x2000));

  freq = freq / (float32_t)PQR;
...
uint32_t LL_RCC_GetI2CClockFreq(uint32_t I2CxSource)
{
  ...
  switch (LL_RCC_GetI2CClockSource(I2CxSource))
  {
    ...
    case LL_RCC_I2C3_CLKSOURCE_PCLK6:
    case LL_RCC_I2C4_CLKSOURCE_PCLK6:
    case LL_RCC_I2C5_CLKSOURCE_PCLK6:
      i2c_frequency = RCC_GetPCLK6ClockFreq(RCC_GetMLHCLKClockFreq(RCC_GetMLAHBSClockFreq()));
      break;

    case LL_RCC_I2C12_CLKSOURCE_PLL4R:
    case LL_RCC_I2C3_CLKSOURCE_PLL4R:
    case LL_RCC_I2C4_CLKSOURCE_PLL4R:
    case LL_RCC_I2C5_CLKSOURCE_PLL4R:
    ...
    case LL_RCC_I2C3_CLKSOURCE_CSI:
    case LL_RCC_I2C4_CLKSOURCE_CSI:
    case LL_RCC_I2C5_CLKSOURCE_CSI:
      if (LL_RCC_CSI_IsReady() != 0U)
      {
...
uint32_t LL_RCC_GetSAIClockFreq(uint32_t SAIxSource)
{
  ...
  switch (LL_RCC_GetSAIClockSource(SAIxSource))
  {
    ...
    case LL_RCC_SAI2_CLKSOURCE_SPDIF:
    /*SAI2 manages this SPDIF_CKSYMB_VALUE */
    default:
      /* Do Nothing */
      break;
  }
...
uint32_t LL_RCC_GetSPIClockFreq(uint32_t SPIxSource)
{
  ...
  switch (LL_RCC_GetSPIClockSource(SPIxSource))
  {
    ...
    /* Intended fall through */
    case LL_RCC_SPI4_CLKSOURCE_PCLK6:
    case LL_RCC_SPI5_CLKSOURCE_PCLK6:
      spi_frequency = RCC_GetPCLK6ClockFreq(RCC_GetMLHCLKClockFreq(RCC_GetMLAHBSClockFreq()));
      break;

    /* Intended fall through */
    case LL_RCC_SPI4_CLKSOURCE_PLL4Q:
    case LL_RCC_SPI5_CLKSOURCE_PLL4Q:
      if (LL_RCC_PLL4_IsReady() != 0U)
      {
        LL_RCC_GetPLL4ClockFreq(&PLL_Clocks);
        spi_frequency = PLL_Clocks.PLL_Q_Frequency;
    ...
    case LL_RCC_SPI4_CLKSOURCE_CSI:
    case LL_RCC_SPI5_CLKSOURCE_CSI:
      if (LL_RCC_CSI_IsReady() != 0U)
      {
...
uint32_t LL_RCC_GetUARTClockFreq(uint32_t UARTxSource)
{
  ...
  {
    case LL_RCC_USART1_CLKSOURCE_PCLK6:
    case LL_RCC_USART2_CLKSOURCE_PCLK6:
      uart_frequency = RCC_GetPCLK6ClockFreq(RCC_GetACLKClockFreq(RCC_GetAXISSClockFreq()));
      break;
    ...
    case LL_RCC_USART35_CLKSOURCE_HSI:
    ...
    case LL_RCC_USART2_CLKSOURCE_CSI:
    case LL_RCC_UART4_CLKSOURCE_CSI:
    case LL_RCC_USART35_CLKSOURCE_CSI:
    ...
    case LL_RCC_USART2_CLKSOURCE_PLL4Q:
    case LL_RCC_UART4_CLKSOURCE_PLL4Q:
    case LL_RCC_USART35_CLKSOURCE_PLL4Q:
    ...
    case LL_RCC_USART2_CLKSOURCE_HSE:
    case LL_RCC_UART4_CLKSOURCE_HSE:
    case LL_RCC_USART35_CLKSOURCE_HSE:
    ...
    case LL_RCC_USART35_CLKSOURCE_PCLK1:
    case LL_RCC_UART78_CLKSOURCE_PCLK1:
      uart_frequency = RCC_GetPCLK1ClockFreq(RCC_GetMLHCLKClockFreq(RCC_GetMLAHBSClockFreq()));
      break;

    case LL_RCC_USART6_CLKSOURCE_PCLK2:
      uart_frequency = RCC_GetPCLK2ClockFreq(RCC_GetMLHCLKClockFreq(RCC_GetMLAHBSClockFreq()));
      break;
...
uint32_t LL_RCC_GetSDMMCClockFreq(uint32_t SDMMCxSource)
{
  ...
  {
    case LL_RCC_SDMMC1_CLKSOURCE_HCLK6:
    case LL_RCC_SDMMC2_CLKSOURCE_HCLK6:
      sdmmc_frequency = RCC_GetACLKClockFreq(RCC_GetAXISSClockFreq());
      break;

    case LL_RCC_SDMMC1_CLKSOURCE_PLL3R:
    case LL_RCC_SDMMC2_CLKSOURCE_PLL3R:
      if (LL_RCC_PLL3_IsReady() != 0U)
      {
        LL_RCC_GetPLL3ClockFreq(&PLL_Clocks);
    ...
    case LL_RCC_SDMMC1_CLKSOURCE_PLL4P:
    case LL_RCC_SDMMC2_CLKSOURCE_PLL4P:
      if (LL_RCC_PLL4_IsReady() != 0U)
      {
        LL_RCC_GetPLL4ClockFreq(&PLL_Clocks);
    ...
    case LL_RCC_SDMMC1_CLKSOURCE_HSI:
    case LL_RCC_SDMMC2_CLKSOURCE_HSI:
      if (LL_RCC_HSI_IsReady() != 0U)
      {
...
uint32_t LL_RCC_GetETHClockFreq(uint32_t ETHxSource)
{
  ...
  {
    case LL_RCC_ETH1_CLKSOURCE_PLL4P:
    case LL_RCC_ETH2_CLKSOURCE_PLL4P:
      if (LL_RCC_PLL4_IsReady() != 0U)
      {
        LL_RCC_GetPLL4ClockFreq(&PLL_Clocks);
      ...
      break;
    case LL_RCC_ETH1_CLKSOURCE_PLL3Q:
    case LL_RCC_ETH2_CLKSOURCE_PLL3Q:
      if (LL_RCC_PLL3_IsReady() != 0U)
      {
        LL_RCC_GetPLL3ClockFreq(&PLL_Clocks);
    ...
    case LL_RCC_ETH1_CLKSOURCE_OFF:
    case LL_RCC_ETH2_CLKSOURCE_OFF:
    default:
      /* Do Nothing */
      break;
  }
...
/**
  * @brief  Return DCMIPPx clock frequency
...
{
  uint32_t dcmipp_frequency = LL_RCC_PERIPH_FREQUENCY_NO;
  LL_PLL_ClocksTypeDef PLL_Clocks;
  ...
  {
    case LL_RCC_DCMIPP_CLKSOURCE_ACLK:
      dcmipp_frequency = RCC_GetACLKClockFreq(RCC_GetACLKClockFreq(RCC_GetAXISSClockFreq()));
      break;

    case LL_RCC_DCMIPP_CLKSOURCE_PLL2Q:
      LL_RCC_GetPLL2ClockFreq(&PLL_Clocks);
      dcmipp_frequency = PLL_Clocks.PLL_Q_Frequency;
      break;

    case LL_RCC_DCMIPP_CLKSOURCE_PLL4P:
      if (LL_RCC_PLL4_IsReady() != 0U)
      {
        LL_RCC_GetPLL4ClockFreq(&PLL_Clocks);
        dcmipp_frequency = PLL_Clocks.PLL_P_Frequency;
      }
      break;

    case LL_RCC_DCMIPP_CLKSOURCE_PER:
      dcmipp_frequency = LL_RCC_GetCKPERClockFreq(LL_RCC_CKPER_CLKSOURCE);
      break;
...
/**
  ...
  * @retval SAES clock frequency (in Hz)
  *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator is not ready
  */
uint32_t LL_RCC_GetSAESClockFreq(uint32_t SAESxSource)
{
  uint32_t saes_frequency = LL_RCC_PERIPH_FREQUENCY_NO;
  LL_PLL_ClocksTypeDef PLL_Clocks;
  ...
  {
    case LL_RCC_SAES_CLKSOURCE_ACLK:
      saes_frequency = RCC_GetACLKClockFreq(RCC_GetACLKClockFreq(RCC_GetAXISSClockFreq()));
      break;

    case LL_RCC_SAES_CLKSOURCE_PER:
      saes_frequency = LL_RCC_GetCKPERClockFreq(LL_RCC_CKPER_CLKSOURCE);
      break;

    case LL_RCC_SAES_CLKSOURCE_PLL4R:
      if (LL_RCC_PLL4_IsReady() != 0U)
      {
        LL_RCC_GetPLL4ClockFreq(&PLL_Clocks);
        saes_frequency = PLL_Clocks.PLL_R_Frequency;
      }
      break;

    case LL_RCC_SAES_CLKSOURCE_LSI:
      if (LL_RCC_LSI_IsReady() != 0U)
      {
        saes_frequency = LSI_VALUE;
      }
      break;
...
uint32_t LL_RCC_GetADCClockFreq(uint32_t ADCxSource)
{
  ...
  {
    case LL_RCC_ADC1_CLKSOURCE_PLL4R:
    case LL_RCC_ADC2_CLKSOURCE_PLL4R:
      if (LL_RCC_PLL4_IsReady() != 0U)
      {
        LL_RCC_GetPLL4ClockFreq(&PLL_Clocks);
    ...
    case LL_RCC_ADC1_CLKSOURCE_PER:
    case LL_RCC_ADC2_CLKSOURCE_PER:
      adc_frequency = LL_RCC_GetCKPERClockFreq(LL_RCC_CKPER_CLKSOURCE);
      break;

    case LL_RCC_ADC1_CLKSOURCE_PLL3Q:
    case LL_RCC_ADC2_CLKSOURCE_PLL3Q:
      if (LL_RCC_PLL3_IsReady() != 0U)
      {
        LL_RCC_GetPLL3ClockFreq(&PLL_Clocks);
...
uint32_t LL_RCC_GetLPTIMClockFreq(uint32_t LPTIMxSource)
{
  ...
  switch (LL_RCC_GetLPTIMClockSource(LPTIMxSource))
  {
    case  LL_RCC_LPTIM1_CLKSOURCE_PCLK1:
      lptim_frequency = RCC_GetPCLK1ClockFreq(RCC_GetMLHCLKClockFreq(RCC_GetMLAHBSClockFreq()));
      break;
    ...
    case LL_RCC_LPTIM2_CLKSOURCE_PER:
    case LL_RCC_LPTIM3_CLKSOURCE_PER:
    case LL_RCC_LPTIM45_CLKSOURCE_PER:
      lptim_frequency = LL_RCC_GetCKPERClockFreq(LL_RCC_CKPER_CLKSOURCE);
      break;

    case LL_RCC_LPTIM2_CLKSOURCE_PCLK3:
    case LL_RCC_LPTIM3_CLKSOURCE_PCLK3:
    case LL_RCC_LPTIM45_CLKSOURCE_PCLK3:
      lptim_frequency = RCC_GetPCLK3ClockFreq(RCC_GetMLHCLKClockFreq(RCC_GetMLAHBSClockFreq()));
      break;

    case LL_RCC_LPTIM2_CLKSOURCE_PLL4Q:
    case LL_RCC_LPTIM3_CLKSOURCE_PLL4Q:
      if (LL_RCC_PLL4_IsReady() != 0U)
      {
        LL_RCC_GetPLL4ClockFreq(&PLL_Clocks);
        lptim_frequency = PLL_Clocks.PLL_Q_Frequency;
    ...
    case LL_RCC_LPTIM2_CLKSOURCE_OFF:
    case LL_RCC_LPTIM3_CLKSOURCE_OFF:
...
/**
  ...
  *         located into APB2 domain. It concerns TIM1, TIM8.
  *         LL_RCC_TIMG3PRES returns the frequency of the prescaler of timers
  *         located into APB6 domain. It concerns TIM12, TIM13, TIM14, TIM15,
  *         TIM16 and TIM17.
...
uint32_t LL_RCC_GetTIMGClockFreq(uint32_t TIMGxPrescaler)
{
  ...
  timg_frequency = RCC_GetMLHCLKClockFreq(RCC_GetMLAHBSClockFreq());
  apb1_div = LL_RCC_GetAPB1Prescaler();
  apb2_div = LL_RCC_GetAPB2Prescaler();
  apb6_div = LL_RCC_GetAPB6Prescaler();
  ...
  switch (LL_RCC_GetTIMGPrescaler(TIMGxPrescaler))
  {
    ...
    case LL_RCC_TIMG2PRES_ACTIVATED:
      ...
      break;
    case LL_RCC_TIMG3PRES_ACTIVATED:
      switch (apb6_div)
      {
        case LL_RCC_APB6_DIV_1:
        case LL_RCC_APB6_DIV_2:
        case LL_RCC_APB6_DIV_4:
          break;
        case LL_RCC_APB6_DIV_8:
          timg_frequency /= 2U;
          break;
        case LL_RCC_APB6_DIV_16:
          timg_frequency /= 4U;
          break;
        default:
          /* Do Nothing */
    ...
    case LL_RCC_TIMG2PRES_DEACTIVATED:
      ...
      break;
    case LL_RCC_TIMG3PRES_DEACTIVATED:
      switch (apb6_div)
      {
        case LL_RCC_APB6_DIV_1:
        case LL_RCC_APB6_DIV_2:
...
/**
  * @brief  Return MLAHBS clock frequency
  * @retval MLAHBS clock frequency (in Hz)
  */
uint32_t RCC_GetMLAHBSClockFreq()
{
  uint32_t frequency = 0U;
  LL_PLL_ClocksTypeDef PLL_Clocks;

  /* Get MLAHBS source -------------------------------------------------------*/
  switch (LL_RCC_GetMLAHBSClkSource())
  {
    case LL_RCC_MLAHBS_CLKSOURCE_HSI:
      frequency = (HSI_VALUE >> LL_RCC_HSI_GetDivider());
      break;

    case LL_RCC_MLAHBS_CLKSOURCE_HSE:
      frequency = HSE_VALUE;
      break;

    case LL_RCC_MLAHBS_CLKSOURCE_CSI:
      frequency = CSI_VALUE;
      break;

    case LL_RCC_MLAHBS_CLKSOURCE_PLL3:
      LL_RCC_GetPLL3ClockFreq(&PLL_Clocks);
      frequency = PLL_Clocks.PLL_P_Frequency;
      break;
...
/**
  ...
  */
uint32_t RCC_GetMLHCLKClockFreq(uint32_t MLAHBS_Frequency)
{
  return LL_RCC_CALC_MLHCLK_FREQ(MLAHBS_Frequency, LL_RCC_GetMLHCLKPrescaler());
}
...
/**
  * @brief  Return PCLK6 clock frequency
  * @param  ACLK_Frequency ACLK clock frequency
  * @retval PCLK6 clock frequency (in Hz)
  */
uint32_t RCC_GetPCLK6ClockFreq(uint32_t ACLK_Frequency)
{
  /* PCLK6 clock frequency */
  return LL_RCC_CALC_PCLK6_FREQ(ACLK_Frequency, LL_RCC_GetAPB6Prescaler());
}
