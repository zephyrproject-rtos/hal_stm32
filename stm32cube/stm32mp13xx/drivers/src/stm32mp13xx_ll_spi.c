...
ErrorStatus LL_SPI_DeInit(const SPI_TypeDef *SPIx)
{
  ...
  {
    /* Force reset of SPI clock */
    LL_APB6_GRP1_ForceReset(LL_APB6_GRP1_PERIPH_SPI4);

    /* Release reset of SPI clock */
    LL_APB6_GRP1_ReleaseReset(LL_APB6_GRP1_PERIPH_SPI4);
  ...
  {
    /* Force reset of SPI clock */
    LL_APB6_GRP1_ForceReset(LL_APB6_GRP1_PERIPH_SPI5);

    /* Release reset of SPI clock */
    LL_APB6_GRP1_ReleaseReset(LL_APB6_GRP1_PERIPH_SPI5);
