...
ErrorStatus LL_I2C_DeInit(const I2C_TypeDef *I2Cx)
{
  ...
  {
    /* Force reset of I2C clock */
    LL_APB6_GRP1_ForceReset(LL_APB6_GRP1_PERIPH_I2C3);

    /* Release reset of I2C clock */
    LL_APB6_GRP1_ReleaseReset(LL_APB6_GRP1_PERIPH_I2C3);
  }
  else if (I2Cx == I2C4)
  {
    /* Force reset of I2C clock */
    LL_APB6_GRP1_ForceReset(LL_APB6_GRP1_PERIPH_I2C4);

    /* Release reset of I2C clock */
    LL_APB6_GRP1_ReleaseReset(LL_APB6_GRP1_PERIPH_I2C4);
  }
  else if (I2Cx == I2C5)
  {
    /* Force reset of I2C clock */
    LL_APB6_GRP1_ForceReset(LL_APB6_GRP1_PERIPH_I2C5);

    /* Release reset of I2C clock */
    LL_APB6_GRP1_ReleaseReset(LL_APB6_GRP1_PERIPH_I2C5);
  }
  else
  {
    status = ERROR;
