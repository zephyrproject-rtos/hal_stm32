  ...
  if ((tmpCMP != 0UL) || (tmpARR != 0UL))
  {
    ...
    switch ((uint32_t)LPTIMx)
    {
      case LPTIM1_BASE:
        ...
        break;
      case LPTIM2_BASE:
        LL_RCC_SetLPTIMClockSource(LL_RCC_LPTIM2_CLKSOURCE_PCLK3);
        break;
      case LPTIM3_BASE:
        LL_RCC_SetLPTIMClockSource(LL_RCC_LPTIM3_CLKSOURCE_PCLK3);
        break;
      case LPTIM4_BASE:
      case LPTIM5_BASE:
    ...
    if (tmpCMP != 0UL)
    {
      ...
      do
      {
        rcc_clock.MPUSS_Frequency--; /* Used for timeout */
      } while (((LL_LPTIM_IsActiveFlag_CMPOK(LPTIMx) != 1UL)) && ((rcc_clock.MPUSS_Frequency) > 0UL));
    ...
    if (tmpARR != 0UL)
    {
      ...
      {
        rcc_clock.MPUSS_Frequency--; /* Used for timeout */
      } while (((LL_LPTIM_IsActiveFlag_ARROK(LPTIMx) != 1UL)) && ((rcc_clock.MPUSS_Frequency) > 0UL));
