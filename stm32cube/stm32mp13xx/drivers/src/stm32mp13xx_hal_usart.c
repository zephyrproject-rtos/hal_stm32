  ...
  *  force OVER8 to 1 to allow to reach the maximum speed (Fclock/8) */
  ...
  switch (clocksource)
  {
    ...
    case USART_CLOCKSOURCE_PCLK5:
      ...
      usartdiv = (uint32_t)(USART_DIV_SAMPLING8(pclk, husart->Init.BaudRate, husart->Init.ClockPrescaler));
      break;
    case USART_CLOCKSOURCE_PCLK6:
      usartdiv = (uint32_t)(USART_DIV_SAMPLING8(HAL_RCC_GetPCLK6Freq(), husart->Init.BaudRate, husart->Init.ClockPrescaler));
      break;
    ...
    case USART_CLOCKSOURCE_HSE:
      usartdiv = (uint32_t)(USART_DIV_SAMPLING8(HSE_VALUE, husart->Init.BaudRate, husart->Init.ClockPrescaler));
      break;
    default:
      ret = HAL_ERROR;
      break;
