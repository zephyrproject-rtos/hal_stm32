...
#define IS_LL_MDMA_ALL_CHANNEL_INSTANCE(INSTANCE, CHANNEL) (((INSTANCE) == MDMA) && \
                                                            (((CHANNEL) == LL_MDMA_CHANNEL_0) || \
                                                             ...
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_16)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_17)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_18)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_19)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_20)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_21)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_22)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_23)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_24)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_25)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_26)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_27)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_28)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_29)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_30)|| \
                                                             ((CHANNEL) == LL_MDMA_CHANNEL_31)|| \
...
#define IS_LL_MDMA_HWTRIGGER(__VALUE__)                   (((__VALUE__) == LL_MDMA_REQ_DMA1_STREAM0_TC)      || \
                                                           ...
                                                           ((__VALUE__) == LL_MDMA_REQ_DMA3_STREAM0_TC)      || \
                                                           ((__VALUE__) == LL_MDMA_REQ_DMA3_STREAM1_TC)      || \
                                                           ((__VALUE__) == LL_MDMA_REQ_DMA3_STREAM2_TC)      || \
                                                           ((__VALUE__) == LL_MDMA_REQ_DMA3_STREAM3_TC)      || \
                                                           ((__VALUE__) == LL_MDMA_REQ_DMA3_STREAM4_TC)      || \
                                                           ((__VALUE__) == LL_MDMA_REQ_DMA3_STREAM5_TC)      || \
                                                           ((__VALUE__) == LL_MDMA_REQ_DMA3_STREAM6_TC)      || \
                                                           ((__VALUE__) == LL_MDMA_REQ_DMA3_STREAM7_TC)      || \
                                                           ((__VALUE__) == LL_MDMA_REQ_FMC_DATA)             || \
                                                           ((__VALUE__) == LL_MDMA_REQ_FMC_ERROR)            || \
                                                           ((__VALUE__) == LL_MDMA_REQ_QUADSPI_FIFO_TH)      || \
                                                           ((__VALUE__) == LL_MDMA_REQ_QUADSPI_TC)           || \
                                                           ((__VALUE__) == LL_MDMA_REQ_CRYP1_IN)             || \
                                                           ((__VALUE__) == LL_MDMA_REQ_CRYP1_OUT)            || \
                                                           ((__VALUE__) == LL_MDMA_REQ_HASH1_IN)             || \
                                                           ((__VALUE__) == LL_MDMA_REQ_SAES_IN)              || \
                                                           ((__VALUE__) == LL_MDMA_REQ_SAES_OUT))
...
uint32_t LL_MDMA_DeInit(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  {
    LL_AHB6_GRP1_ForceReset(LL_AHB6_S_GRP1_PERIPH_MDMA);
    LL_AHB6_GRP1_ReleaseReset(LL_AHB6_S_GRP1_PERIPH_MDMA);
  }
  else
  {
