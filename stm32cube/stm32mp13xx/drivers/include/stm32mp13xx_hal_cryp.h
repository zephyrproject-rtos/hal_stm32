...
#ifndef STM32MP13xx_HAL_CRYP_H
#define STM32MP13xx_HAL_CRYP_H
...
#endif /* (USE_HAL_CRYP_REGISTER_CALLBACKS) */
{
  ...
  uint32_t                    SuspendedProcessing;     /*< Report whether interruption or MDMA-mode processing
                                                           was suspended */
#endif /* USE_HAL_CRYP_SUSPEND_RESUME */
...
#define HAL_CRYP_ERROR_MDMA              0x00000004U  /*!< MDMA error       */
...
/**
  ...
  * @retval None
  */
#define IS_CRYP_INSTANCE(INSTANCE) ((INSTANCE) == CRYP1)
...
#include "stm32mp13xx_hal_cryp_ex.h"
