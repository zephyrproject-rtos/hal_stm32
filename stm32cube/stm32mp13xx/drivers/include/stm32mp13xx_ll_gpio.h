...
#ifndef __STM32MP13xx_LL_GPIO_H
#define __STM32MP13xx_LL_GPIO_H
...
{
  MODIFY_REG(GPIOx->MODER, (GPIO_MODER_MODER0 << (POSITION_VAL(Pin) * GPIO_MODER_MODER1_Pos)),
             (Mode << (POSITION_VAL(Pin) * GPIO_MODER_MODER1_Pos)));
}
...
{
  return (uint32_t)(READ_BIT(GPIOx->MODER, (GPIO_MODER_MODER0 << (POSITION_VAL(Pin) * GPIO_MODER_MODER1_Pos)))
                    >> (POSITION_VAL(Pin) * GPIO_MODER_MODER1_Pos));
}
...
{
  MODIFY_REG(GPIOx->OSPEEDR, (GPIO_OSPEEDR_OSPEEDR0 << (POSITION_VAL(Pin) * GPIO_OSPEEDR_OSPEEDR1_Pos)),
             (Speed << (POSITION_VAL(Pin) * GPIO_OSPEEDR_OSPEEDR1_Pos)));
}
...
{
  return (uint32_t)(READ_BIT(GPIOx->OSPEEDR, (GPIO_OSPEEDR_OSPEEDR0 << (POSITION_VAL(Pin) * GPIO_OSPEEDR_OSPEEDR1_Pos)))
                    >> (POSITION_VAL(Pin) * GPIO_OSPEEDR_OSPEEDR1_Pos));
}
...
{
  MODIFY_REG(GPIOx->PUPDR, (GPIO_PUPDR_PUPDR0 << (POSITION_VAL(Pin) * GPIO_PUPDR_PUPDR1_Pos)),
             (Pull << (POSITION_VAL(Pin) * GPIO_PUPDR_PUPDR1_Pos)));
}
...
{
  return (uint32_t)(READ_BIT(GPIOx->PUPDR, (GPIO_PUPDR_PUPDR0 << (POSITION_VAL(Pin) * GPIO_PUPDR_PUPDR1_Pos)))
                    >> (POSITION_VAL(Pin) * GPIO_PUPDR_PUPDR1_Pos));
}
...
{
  MODIFY_REG(GPIOx->AFR[0], (GPIO_AFRL_AFR0 << (POSITION_VAL(Pin) * GPIO_AFRL_AFR1_Pos)),
             (Alternate << (POSITION_VAL(Pin) * GPIO_AFRL_AFR1_Pos)));
}
...
{
  return (uint32_t)(READ_BIT(GPIOx->AFR[0], (GPIO_AFRL_AFR0 << (POSITION_VAL(Pin) * GPIO_AFRL_AFR1_Pos)))
                    >> (POSITION_VAL(Pin) * GPIO_AFRL_AFR1_Pos));
}
...
{
  MODIFY_REG(GPIOx->AFR[1], (GPIO_AFRH_AFR8 << (POSITION_VAL(Pin >> 8U) * GPIO_AFRH_AFR9_Pos)),
             (Alternate << (POSITION_VAL(Pin >> 8U) * GPIO_AFRH_AFR9_Pos)));
}
...
{
  return (uint32_t)(READ_BIT(GPIOx->AFR[1], (GPIO_AFRH_AFR8 << (POSITION_VAL(Pin >> 8U) * GPIO_AFRH_AFR9_Pos)))
                    >> (POSITION_VAL(Pin >> 8U) * GPIO_AFRH_AFR9_Pos));
}
