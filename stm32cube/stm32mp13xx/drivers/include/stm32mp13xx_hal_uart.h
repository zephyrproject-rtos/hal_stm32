...
#ifndef STM32MP13xx_HAL_UART_H
#define STM32MP13xx_HAL_UART_H
...
typedef enum
{
  ...
  UART_CLOCKSOURCE_PCLK6      = 0x80U,    /*!< PCLK6 clock source  */
  UART_CLOCKSOURCE_UNDEFINED  = 0x100U    /*!< Undefined clock source */
