...
#ifndef STM32MP13xx_HAL_RTC_H
#define STM32MP13xx_HAL_RTC_H
...
typedef struct
{
  ...
  uint32_t BinaryAutoClr;        /*!< Clear synchronously counter (RTC_SSR) on binary alarm.
                                      RTC_ALARMSUBSECONDBIN_AUTOCLR_YESmust only be used if Binary mode is
                                      RTC_BINARY_ONLY.This parameter can be a value of
  ...
  uint8_t AlarmDateWeekDay;      /*!< Specifies the RTC Alarm Date/WeekDay.
                                      ...
                                      in the 1-31 range.If the Alarm WeekDay is selected, this parameter can
                                      be a value of @ref RTC_WeekDay_Definitions */
...
typedef enum
{
  ...
  HAL_RTC_ALARM_A_EVENT_CB_S_ID          = 25U,    /*!< RTC Alarm A Event Callback secure ID      */
  HAL_RTC_ALARM_B_EVENT_CB_S_ID          = 26U,    /*!< RTC Alarm B Event Callback secure ID      */
  HAL_RTC_TIMESTAMP_EVENT_CB_S_ID        = 27U,    /*!< RTC TimeStamp Event Callback secure ID    */
  HAL_RTC_WAKEUPTIMER_EVENT_CB_S_ID      = 28U,    /*!< RTC WakeUp Timer Event Callback secure ID */
  HAL_RTC_TAMPER1_EVENT_CB_S_ID          = 29U,    /*!< RTC Tamper 1 Callback secure ID           */
  HAL_RTC_TAMPER2_EVENT_CB_S_ID          = 30U,    /*!< RTC Tamper 2 Callback secure ID           */
  HAL_RTC_TAMPER3_EVENT_CB_S_ID          = 31U,    /*!< RTC Tamper 3 Callback secure ID           */
  HAL_RTC_TAMPER4_EVENT_CB_S_ID          = 32U,    /*!< RTC Tamper 4 Callback secure ID           */
  HAL_RTC_TAMPER5_EVENT_CB_S_ID          = 33U,    /*!< RTC Tamper 5 Callback secure ID           */
  HAL_RTC_TAMPER6_EVENT_CB_S_ID          = 34U,    /*!< RTC Tamper 6 Callback secure ID           */
  HAL_RTC_TAMPER7_EVENT_CB_S_ID          = 35U,    /*!< RTC Tamper 7 Callback secure ID           */
  HAL_RTC_TAMPER8_EVENT_CB_S_ID          = 36U,    /*!< RTC Tamper 8 Callback secure ID           */
  HAL_RTC_INTERNAL_TAMPER1_EVENT_CB_S_ID = 37U,    /*!< RTC Internal Tamper 1 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER2_EVENT_CB_S_ID = 38U,    /*!< RTC Internal Tamper 2 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER3_EVENT_CB_S_ID = 39U,    /*!< RTC Internal Tamper 3 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER4_EVENT_CB_S_ID = 40U,    /*!< RTC Internal Tamper 4 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER5_EVENT_CB_S_ID = 41U,    /*!< RTC Internal Tamper 5 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER6_EVENT_CB_S_ID = 42U,    /*!< RTC Internal Tamper 6 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER7_EVENT_CB_S_ID = 43U,    /*!< RTC Internal Tamper 7 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER8_EVENT_CB_S_ID = 44U,    /*!< RTC Internal Tamper 8 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER9_EVENT_CB_S_ID = 45U,    /*!< RTC Internal Tamper 9 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER10_EVENT_CB_S_ID = 46U,    /*!< RTC Internal Tamper 10 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER11_EVENT_CB_S_ID = 47U,    /*!< RTC Internal Tamper 11 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER12_EVENT_CB_S_ID = 48U,    /*!< RTC Internal Tamper 12 Callback secure ID  */
  HAL_RTC_INTERNAL_TAMPER13_EVENT_CB_S_ID = 49U,    /*!< RTC Internal Tamper 13 Callback secure ID  */
#endif /* #if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U) */
  HAL_RTC_MSPINIT_CB_ID                  = 50U,    /*!< RTC Msp Init callback ID           */
  HAL_RTC_MSPDEINIT_CB_ID                = 51U     /*!< RTC Msp DeInit callback ID         */
