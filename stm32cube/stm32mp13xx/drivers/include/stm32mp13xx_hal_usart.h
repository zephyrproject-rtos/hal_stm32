...
#ifndef STM32MP13xx_HAL_USART_H
#define STM32MP13xx_HAL_USART_H
...
typedef enum
{
  ...
  USART_CLOCKSOURCE_PCLK6      = 0x80U,    /*!< PCLK6 clock source  */
  USART_CLOCKSOURCE_UNDEFINED  = 0x100U    /*!< Undefined clock source */
    ...
    {                                                          \
      ...
      {                                                        \
        case RCC_USART1CLKSOURCE_PCLK6:                        \
          (__CLOCKSOURCE__) = USART_CLOCKSOURCE_PCLK6;         \
          break;                                               \
...
#include "stm32mp13xx_hal_usart_ex.h"
