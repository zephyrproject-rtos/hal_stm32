...
#ifndef STM32MP13xx_HAL_DMA_EX_H
#define STM32MP13xx_HAL_DMA_EX_H
...
#define HAL_DMAMUX2_SYNC_TIM12_TRGO        7U   /*!< DMAMUX2 synchronization Signal is TIM12 TRGO             */
/**
  * @}
  */
...
#define HAL_DMAMUX2_REQ_GEN_TIM12_TRGO        7U   /*!< DMAMUX2 Request generator Signal is TIM12 TRGO             */
...
#define IS_DMAMUX1_SYNC_SIGNAL_ID(SIGNAL_ID) ((SIGNAL_ID) <= HAL_DMAMUX1_SYNC_TIM12_TRGO)
#define IS_DMAMUX2_SYNC_SIGNAL_ID(SIGNAL_ID) ((SIGNAL_ID) <= HAL_DMAMUX2_SYNC_TIM12_TRGO)
...
#define IS_DMAMUX1_REQUEST_GEN_SIGNAL_ID(SIGNAL_ID) ((SIGNAL_ID) <= HAL_DMAMUX1_REQ_GEN_TIM12_TRGO)
#define IS_DMAMUX2_REQUEST_GEN_SIGNAL_ID(SIGNAL_ID) ((SIGNAL_ID) <= HAL_DMAMUX2_REQ_GEN_TIM12_TRGO)
...
#endif /* STM32MP13xx_HAL_DMA_EX_H */
