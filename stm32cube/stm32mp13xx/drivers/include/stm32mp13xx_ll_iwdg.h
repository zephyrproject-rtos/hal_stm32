...
#ifndef STM32MP13xx_LL_IWDG_H
#define STM32MP13xx_LL_IWDG_H
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE uint32_t LL_IWDG_IsEnableIT_EWI(const IWDG_TypeDef *IWDGx)
{
