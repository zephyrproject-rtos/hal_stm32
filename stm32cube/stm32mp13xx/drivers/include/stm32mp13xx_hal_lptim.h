...
#ifndef STM32MP13xx_HAL_LPTIM_H
#define STM32MP13xx_HAL_LPTIM_H
...
#define LPTIM_INPUT1SOURCE_HSE_CLOCK     LPTIM_CFGR2_IN1SEL_0 /*!< For LPTIM3 */
/**
  * @}
  */
...
#define IS_LPTIM_INPUT1_SOURCE(__INSTANCE__, __SOURCE__)   \
  ((((__INSTANCE__) == LPTIM1) &&                          \
   ...
   ||                                                      \
   (((__INSTANCE__) == LPTIM3) &&                          \
    ((__SOURCE__) == LPTIM_INPUT1SOURCE_HSE_CLOCK)))
