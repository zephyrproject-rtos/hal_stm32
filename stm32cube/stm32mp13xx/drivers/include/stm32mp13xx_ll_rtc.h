...
#ifndef STM32MP13xx_LL_RTC_H
#define STM32MP13xx_LL_RTC_H
...
typedef struct
{
  ...
  uint8_t Minutes;     /*!< Specifies the RTC Time Minutes.
                            ...
                            function @ref LL_RTC_TIME_SetMinute(). */

  uint8_t Seconds;     /*!< Specifies the RTC Time Seconds.
                            This parameter must be a number between Min_Data = 0 and Max_Data = 59

                            This feature can be modified afterwards using unitary
                            function @ref LL_RTC_TIME_SetSecond(). */
} LL_RTC_TimeTypeDef;
...
typedef struct
{
  uint8_t WeekDay;  /*!< Specifies the RTC Date WeekDay.
                         ...
                         This feature can be modified afterwards using unitary
                         function @ref LL_RTC_DATE_SetWeekDay(). */
...
typedef struct
{
  ...
  uint32_t AlarmMask;            /*!< Specifies the RTC Alarm Masks.
                                      ...
                                      for ALARM A or @ref RTC_LL_EC_ALMB_MASK for ALARM B.
  ...
  uint8_t AlarmDateWeekDay;      /*!< Specifies the RTC Alarm Day/WeekDay.
                                      If AlarmDateWeekDaySel set to day, this parameter
                                      must be a number between Min_Data = 1 and Max_Data = 31.

                                      This feature can be modified afterwards using unitary
                                      function @ref LL_RTC_ALMA_SetDay()
                                      for ALARM A or @ref LL_RTC_ALMB_SetDay() for ALARM B.

                                      If AlarmDateWeekDaySel set to Weekday, this parameter
                                      can be a value of @ref RTC_LL_EC_WEEKDAY.

                                      This feature can be modified afterwards using unitary
                                      function @ref LL_RTC_ALMA_SetWeekDay()
...
#define LL_RTC_TAMPER_MASK_TAMPER4         TAMP_CR2_TAMP4MSK /*!< Tamper 4 event generates a trigger event. TAMP4F is masked and internally cleared by hardware. The backup registers are not erased */
#define LL_RTC_TAMPER_MASK_TAMPER5         TAMP_CR2_TAMP5MSK /*!< Tamper 5 event generates a trigger event. TAMP5F is masked and internally cleared by hardware. The backup registers are not erased. */
#define LL_RTC_TAMPER_MASK_TAMPER6         TAMP_CR2_TAMP6MSK /*!< Tamper 6 event generates a trigger event. TAMP6F is masked and internally cleared by hardware. The backup registers are not erased. */
#define LL_RTC_TAMPER_MASK_TAMPER7         TAMP_CR2_TAMP7MSK /*!< Tamper 7 event generates a trigger event. TAMP7F is masked and internally cleared by hardware. The backup registers are not erased */
#define LL_RTC_TAMPER_MASK_TAMPER8         TAMP_CR2_TAMP8MSK /*!< Tamper 8 event generates a trigger event. TAMP8F is masked and internally cleared by hardware. The backup registers are not erased. */
...
#define LL_RTC_TAMPER_ITAMP1               TAMP_CR1_ITAMP1E  /*!< Internal tamper 1: Backup domain voltage monitoring */
...
#define LL_RTC_TAMPER_ITAMP6               TAMP_CR1_ITAMP6E  /*!< Internal tamper 6: JTAG/SWD access */
...
#define LL_RTC_TAMPER_ITAMP10              TAMP_CR1_ITAMP10E /*!< Internal tamper 10: Monotonic counter 2 overflow */
#define LL_RTC_TAMPER_ITAMP11              TAMP_CR1_ITAMP11E /*!< Internal tamper 11: IWDG reset */
#define LL_RTC_TAMPER_ITAMP12              TAMP_CR1_ITAMP12E /*!< Internal tamper 12: ADC2 watchdog monitoring 2 */
#define LL_RTC_TAMPER_ITAMP13              TAMP_CR1_ITAMP13E /*!< Internal tamper 13: ADC2 watchdog monitoring 3 */
...
#define LL_RTC_SECURE_FULL_NO              0U                  /*!< RTC is not full secure, features can be unsecure. See RTC_LL_EC_UNSECURE_RTC_FEATURE */
/**
  * @}
  */
...
/** @defgroup RTC_LL_EC_SECURE_TAMP  Secure tamp
  * @{
  */
#define LL_TAMP_SECURE_FULL_YES            TAMP_TAMPSECCFGR_TAMPSEC  /*!< TAMP full secure */
#define LL_TAMP_SECURE_FULL_NO             0U                        /*!< TAMP is not full secure */
/**
  * @}
  */

/** @defgroup RTC_LL_EC_SECURE_TAMP_FEATURE  Secure features rtc in case of LL_TAMP_SECURE_FULL_NO.
  * @{
  */
#define LL_TAMP_SECURE_FEATURE_BKP        TAMP_SECCFGR_BKPWSEC   /*!< BKP feature is secure */
#define LL_TAMP_SECURE_FEATURE_BKPR       TAMP_SECCFGR_BKPRSEC   /*!< BKPR feature is secure */
#define LL_TAMP_SECURE_FEATURE_CNT1       TAMP_SECCFGR_CNT1SEC   /*!< Monotonic1 feature is secure */
#define LL_TAMP_SECURE_FEATURE_CNT2       TAMP_SECCFGR_CNT2SEC   /*!< Monotonic2 feature is secure */
/**
  * @}
  */

/** @defgroup RTC_LL_EC_PRIV_RTC_FULL  Priv full rtc
  * @{
  */
#define LL_RTC_PRIV_FULL_YES             RTC_PRIVCFGR_PRIV        /*!< RTC full priv */
#define LL_RTC_PRIV_FULL_NO              0U                       /*!< RTC is not full priv */
/**
  * @}
  */

/** @defgroup RTC_LL_EC_PRIV_RTC_FEATURE  Priv features rtc in case of LL_RTC_PRIV_FULL_NO.
  * @{
  */
#define LL_RTC_PRIV_FEATURE_INIT       RTC_PRIVCFGR_INITPRIV   /*!< Initialization feature is priv */
#define LL_RTC_PRIV_FEATURE_CAL        RTC_PRIVCFGR_CALPRIV    /*!< Calibration feature is priv */
#define LL_RTC_PRIV_FEATURE_TS         RTC_PRIVCFGR_TSPRIV     /*!< Time stamp feature is priv */
#define LL_RTC_PRIV_FEATURE_WUT        RTC_PRIVCFGR_WUTPRIV    /*!< Wake up timer feature is priv */
#define LL_RTC_PRIV_FEATURE_ALRA       RTC_PRIVCFGR_ALRAPRIV   /*!< Alarm A feature is priv */
#define LL_RTC_PRIV_FEATURE_ALRB       RTC_PRIVCFGR_ALRBPRIV   /*!< Alarm B feature is priv */
/**
  * @}
  */

/** @defgroup RTC_LL_EC_Priv_TAMP  Priv tamp
  * @{
  */
#define LL_TAMP_PRIV_FULL_YES            TAMP_PRIVCR_TAMPPRIV /*!< TAMP full priv */
#define LL_TAMP_PRIV_FULL_NO             0U                   /*!< TAMP is not full priv */
/**
  * @}
  */

/** @defgroup RTC_LL_EC_PRIV_TAMP_FEATURE  Priv features rtc in case of LL_TAMP_SECURE_FULL_NO.
  * @{
  */
#define LL_TAMP_PRIV_FEATURE_BKP          TAMP_PRIVCR_BKPWPRIV   /*!< BKPW feature is priv */
#define LL_TAMP_PRIV_FEATURE_BKPR         TAMP_PRIVCR_BKPRPRIV   /*!< BKPR feature is priv */
#define LL_TAMP_PRIV_FEATURE_CNT1         TAMP_PRIVCR_CNT1PRIV   /*!< Monotonic1 feature is priv */
#define LL_TAMP_PRIV_FEATURE_CNT2         TAMP_PRIVCR_CNT2PRIV   /*!< Monotonic2 feature is priv */
/**
  * @}
  */
                                            ...
                                            uint32_t Hours, uint32_t Minutes, uint32_t Seconds)
{
  ...
  MODIFY_REG(RTCx->ALRMAR, RTC_ALRMAR_PM | RTC_ALRMAR_HT | RTC_ALRMAR_HU | RTC_ALRMAR_MNT | \
             RTC_ALRMAR_MNU | RTC_ALRMAR_ST | RTC_ALRMAR_SU, temp);
}
                                            ...
                                            uint32_t Hours, uint32_t Minutes, uint32_t Seconds)
{
  ...
  MODIFY_REG(RTCx->ALRMBR, RTC_ALRMBR_PM | RTC_ALRMBR_HT | RTC_ALRMBR_HU | RTC_ALRMBR_MNT | \
             RTC_ALRMBR_MNU | RTC_ALRMBR_ST | RTC_ALRMBR_SU, temp);
}
...
/**
  ...
  *         TAMP_CR1       ITAMP9E       LL_RTC_TAMPER_ITAMP_Enable\n
  *         TAMP_CR1       ITAMP10E      LL_RTC_TAMPER_ITAMP_Enable\n
  *         TAMP_CR1       ITAMP11E      LL_RTC_TAMPER_ITAMP_Enable\n
  *         TAMP_CR1       ITAMP12E      LL_RTC_TAMPER_ITAMP_Enable\n
  *         TAMP_CR1       ITAMP13E      LL_RTC_TAMPER_ITAMP_Enable
  * @param  RTCx RTC Instance
...
/**
  ...
  *         TAMP_CR1       ITAMP9E       LL_RTC_TAMPER_ITAMP_Disable\n
  *         TAMP_CR1       ITAMP10E      LL_RTC_TAMPER_ITAMP_Disable\n
  *         TAMP_CR1       ITAMP11E      LL_RTC_TAMPER_ITAMP_Disable\n
  *         TAMP_CR1       ITAMP12E      LL_RTC_TAMPER_ITAMP_Disable\n
  *         TAMP_CR1       ITAMP13E      LL_RTC_TAMPER_ITAMP_Disable
  * @param  RTCx RTC Instance
  * @param  InternalTamper This parameter can be a combination of the following values:
  *         @arg @ref RTC_LL_EC_INTERNAL
  *
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP10(const RTC_TypeDef *RTCx)
{
  UNUSED(RTCx);
...
/**
  * @brief  Get internal tamper 10 interrupt masked flag.
  * @rmtoll TAMP_MISR          ITAMP10MF        LL_RTC_IsActiveFlag_ITAMP10M
  * @param  RTCx RTC Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP10M(const RTC_TypeDef *RTCx)
{
  UNUSED(RTCx);
  return ((READ_BIT(TAMP->MISR, TAMP_MISR_ITAMP10MF) == (TAMP_MISR_ITAMP10MF)) ? 1U : 0U);
}
...
/**
  * @brief  Clear internal tamper 10 detection flag.
  * @rmtoll TAMP_SCR          CITAMP10F         LL_RTC_ClearFlag_ITAMP10
  * @param  RTCx RTC Instance
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_ITAMP10(const RTC_TypeDef *RTCx)
{
  UNUSED(RTCx);
  WRITE_REG(TAMP->SCR, TAMP_SCR_CITAMP10F);
}
...
/**
  ...
  * @rmtoll RTC_SECCFGRR          CALSEC          LL_RTC_SetRtcSecure
  * @rmtoll RTC_SECCFGR           TSSEC           LL_RTC_SetRtcSecure
  * @rmtoll RTC_SECCFGRR          WUTSEC          LL_RTC_SetRtcSecure
  * @rmtoll RTC_SECCFGR           ALRASEC         LL_RTC_SetRtcSecure
  * @rmtoll RTC_SECCFGRR          ALRBSEC         LL_RTC_SetRtcSecure
  * @param  RTCx RTC Instance
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetRtcSecure(const RTC_TypeDef *RTCx, uint32_t rtcSecure)
{
...
{
  return READ_BIT(RTCx->SECCFGR, RTC_SECCFGR_SEC | RTC_SECCFGR_INITSEC | RTC_SECCFGR_CALSEC | \
                  RTC_SECCFGR_TSSEC | RTC_SECCFGR_WUTSEC | RTC_SECCFGR_ALRASEC | RTC_SECCFGR_ALRBSEC);
}

#if defined (CORTEX_IN_SECURE_STATE)
/**
  * @brief  Set TAMPER secure level.
  * @rmtoll TAMP_TAMPSECCFGR          TAMPSEC           LL_RTC_SetTampSecure
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetTampSecure(TAMP_TypeDef *TAMPx, uint32_t tampSecure)
{
  UNUSED(TAMPx);
...
/**
  ...
  * @rmtoll TAMP_TAMPSECCFGR          TAMPSEC           LL_RTC_GetTampSecure
  * @param  TAMPx TAMP Instance
  * @retval This parameter can be one of the following values:
  *         @arg @ref LL_TAMP_SECURE_FULL_YES
  *         @arg @ref LL_TAMP_SECURE_FULL_NO
  */
__STATIC_INLINE uint32_t LL_RTC_GetTampSecure(const TAMP_TypeDef *TAMPx)
{
  UNUSED(TAMPx);
...
#if defined (CORTEX_IN_SECURE_STATE)
/**
  * @brief  Set RTC priv level.
  * @note   Secure features are relevant if LL_RTC_PRIV_FULL_NO.
  * @rmtoll RTC_PRIVCR           PRIV             LL_RTC_SetRtcPriv
  * @rmtoll RTC_PRIVCR           INITPRIV         LL_RTC_SetRtcPriv
  * @rmtoll RTC_PRIVCR           CALPRIV          LL_RTC_SetRtcPriv
  * @rmtoll RTC_PRIVCR           TSPRIV           LL_RTC_SetRtcPriv
  * @rmtoll RTC_PRIVCR           WUTPRIV          LL_RTC_SetRtcPriv
  * @rmtoll RTC_RTC_PRIVCR       ALRAPRIV         LL_RTC_SetRtcPriv
  * @rmtoll RTC_RTC_PRIVCR       ALRBPRIV         LL_RTC_SetRtcPriv
  * @param  RTCx RTC Instance
  * @param  rtcPriv This parameter can be a combination of the following values:
  *         @arg @ref LL_RTC_PRIV_FULL_YES
  *         @arg @ref LL_RTC_PRIV_FULL_NO
  *         @arg @ref LL_RTC_PRIV_FEATURE_INIT
  *         @arg @ref LL_RTC_PRIV_FEATURE_CAL
  *         @arg @ref LL_RTC_PRIV_FEATURE_TS
  *         @arg @ref LL_RTC_PRIV_FEATURE_WUT
  *         @arg @ref LL_RTC_PRIV_FEATURE_ALRA
  *         @arg @ref LL_RTC_PRIV_FEATURE_ALRB

  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetRtcPriv(RTC_TypeDef *RTCx, uint32_t rtcPriv)
{
  MODIFY_REG(RTCx->PRIVCR, RTC_PRIVCR_PRIV | RTC_PRIVCR_INITPRIV | RTC_PRIVCR_CALPRIV | \
             RTC_PRIVCR_TSPRIV | RTC_PRIVCR_WUTPRIV | RTC_PRIVCR_ALRAPRIV | RTC_PRIVCR_ALRBPRIV, rtcPriv);
}
#endif /* #if defined (CORTEX_IN_SECURE_STATE) */

/**
  * @brief  Get RTC priv level.
  * @note   Secure features are relevant if LL_RTC_PRIV_FULL_NO.
  * @rmtoll RTC_PRIVCR           PRIV             LL_RTC_SetRtcPriv
  * @rmtoll RTC_PRIVCR           INITPRIV         LL_RTC_SetRtcPriv
  * @rmtoll RTC_PRIVCR           CALPRIV          LL_RTC_SetRtcPriv
  ...
  * @retval None
  */
__STATIC_INLINE uint32_t LL_RTC_GetRtcPriv(const RTC_TypeDef *RTCx)
{
  return READ_BIT(RTCx->PRIVCR, RTC_PRIVCR_PRIV | RTC_PRIVCR_INITPRIV | RTC_PRIVCR_CALPRIV | \
                  RTC_PRIVCR_TSPRIV | RTC_PRIVCR_WUTPRIV | RTC_PRIVCR_ALRAPRIV | RTC_PRIVCR_ALRBPRIV);
}

#if defined (CORTEX_IN_SECURE_STATE)
/**
  * @brief  Set TAMPER priv level.
  * @note   Secure features are relevant if LL_TAMP_PRIV_FULL_NO.
  * @rmtoll TAMP_PRIVCR           TAMPPRIV         LL_TAMP_SetTampPriv
  * @rmtoll TAMP_PRIVCR           BKPRWPRIV         LL_TAMP_SetTampPriv
  * @rmtoll TAMP_PRIVCR           BKPWPRIV         LL_TAMP_SetTampPriv
  * @rmtoll TAMP_PRIVCR           CNT1PRIV         LL_TAMP_SetTampPriv
  * @rmtoll TAMP_PRIVCR           CNT2PRIV         LL_TAMP_SetTampPriv
  * @param  TAMPx TAMP Instance
  * @param  tampPriv This parameter can be a combination of the following values:
  *         @arg @ref LL_TAMP_PRIV_FULL_YES
  *         @arg @ref LL_TAMP_PRIV_FULL_NO
  *         @arg @ref LL_TAMP_SECURE_FEATURE_BKP
  *         @arg @ref LL_TAMP_SECURE_FEATURE_BKPR
  *         @arg @ref LL_TAMP_PRIV_FEATURE_CNT1
  *         @arg @ref LL_TAMP_PRIV_FEATURE_CNT2
  * @retval None
  */
__STATIC_INLINE void LL_TAMP_SetTampPriv(TAMP_TypeDef *TAMPx, uint32_t tampPriv)
{
  MODIFY_REG(TAMPx->PRIVCR, TAMP_PRIVCR_TAMPPRIV | TAMP_PRIVCR_BKPRWPRIV | TAMP_PRIVCR_BKPWPRIV \
             | TAMP_PRIVCR_CNT1PRIV | TAMP_PRIVCR_CNT2PRIV, tampPriv);
}
#endif /* #if defined (CORTEX_IN_SECURE_STATE) */

/**
  * @brief  Get TAMPER priv level.
  * @note   Secure features are relevant if LL_TAMP_PRIV_FULL_NO.
  * @rmtoll TAMP_PRIVCR           TAMPPRIV         LL_TAMP_SetTampPriv
  * @rmtoll TAMP_PRIVCR           BKPRWPRIV         LL_TAMP_SetTampPriv
  * @rmtoll TAMP_PRIVCR           BKPWPRIV         LL_TAMP_SetTampPriv
  ...
  * @retval None
  */
__STATIC_INLINE uint32_t LL_TAMP_GetTampPriv(const TAMP_TypeDef *TAMPx)
{
  return READ_BIT(TAMPx->PRIVCR, TAMP_PRIVCR_TAMPPRIV | TAMP_PRIVCR_BKPRWPRIV | \
                  TAMP_PRIVCR_BKPWPRIV | TAMP_PRIVCR_CNT1PRIV | TAMP_PRIVCR_CNT2PRIV);
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_ITAMP10(const RTC_TypeDef *RTCx)
{
  UNUSED(RTCx);
...
/**
  ...
  * @rmtoll TAMP_IER           ITAMP10IE          LL_RTC_DisableIT_ITAMP10
  * @param  RTCx RTC Instance
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_ITAMP10(const RTC_TypeDef *RTCx)
{
  UNUSED(RTCx);
...
/**
  * @brief  Check if internal tamper 10 interrupt is enabled or not.
  * @rmtoll TAMP_IER           ITAMP10IE        LL_RTC_IsEnabledIT_ITAMP10
  * @param  RTCx RTC Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ITAMP10(const RTC_TypeDef *RTCx)
{
  UNUSED(RTCx);
  return ((READ_BIT(TAMP->IER, TAMP_IER_ITAMP10IE) == (TAMP_IER_ITAMP10IE)) ? 1U : 0U);
}
