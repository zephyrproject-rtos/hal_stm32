...
#ifndef STM32MP13xx_LL_MDMA_H
#define STM32MP13xx_LL_MDMA_H
...
static const uint32_t LL_MDMA_CH_OFFSET_TAB[] =
{
  ...
  (uint32_t)(MDMA_Channel16_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel17_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel18_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel19_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel20_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel21_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel22_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel23_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel24_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel25_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel26_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel27_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel28_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel29_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel30_BASE - MDMA_BASE),
  (uint32_t)(MDMA_Channel31_BASE - MDMA_BASE)
};
...
typedef struct
{
  ...
  uint32_t HalfWordEndianess;     /*!< Specifies the Half Word transfer endianness
                                       ...
                                       This feature can be modified afterwards using unitary function
                                       @ref LL_MDMA_SetHalfWordEndianness() */
  ...
  uint32_t BufferableWriteMode;   /*!< Specifies the transfer Bufferable Write Mode.
                                       ...
                                       This feature can be modified afterwards using unitary function
                                       @ref LL_MDMA_EnableBufferableWrMode()
  ...
  uint32_t PaddingAlignment;     /*!< Specifies the transfer Padding and Alignment.
                                      ...
                                      This feature can be modified afterwards using unitary function
                                      @ref LL_MDMA_SetPaddingAlignment() */
  ...
  uint32_t PackMode;              /*!< Specifies the transfer Packing enabled or disabled.
                                       ...
                                       This feature can be modified afterwards using unitary function
                                       @ref LL_MDMA_EnablePacking() and LL_MDMA_DisablePacking() */
  ...
  uint32_t DestIncSize;           /*!< Specifies the destination increment size.
                                       ...
                                       This feature can be modified afterwards using unitary function
                                       @ref LL_MDMA_SetDestinationIncSize() */
  ...
  uint32_t DestBus;               /*!< Specifies the destination transfer bus, System AXI or AHB/TCM bus.
                                       ...
                                       This feature can be modified afterwards using unitary function
                                       @ref LL_MDMA_SetDestBusSelection() */
  ...
  uint32_t SrcBus;                /*!< Specifies the source transfer bus, System AXI or AHB/TCM bus.
                                       ...
                                       This feature can be modified afterwards using unitary function
                                       @ref LL_MDMA_SetSrcBusSelection() */

  uint32_t MaskAddress;           /*!< Specifies the address to be updated (written) with MaskData after a request is served.
                                       MaskAddress and MaskData could be used to automatically clear a peripheral flag
                                       when the request is served
                                       This parameter can be a value Between 0 to 0xFFFFFFFF
                                       This feature can be modified afterwards using unitary function
                                       @ref LL_MDMA_SetMaskAddress() */
...
#define LL_MDMA_CHANNEL_16                  0x00000010U
#define LL_MDMA_CHANNEL_17                  0x00000011U
#define LL_MDMA_CHANNEL_18                  0x00000012U
#define LL_MDMA_CHANNEL_19                  0x00000013U
#define LL_MDMA_CHANNEL_20                  0x00000014U
#define LL_MDMA_CHANNEL_21                  0x00000015U
#define LL_MDMA_CHANNEL_22                  0x00000016U
#define LL_MDMA_CHANNEL_23                  0x00000017U
#define LL_MDMA_CHANNEL_24                  0x00000018U
#define LL_MDMA_CHANNEL_25                  0x00000019U
#define LL_MDMA_CHANNEL_26                  0x0000001AU
#define LL_MDMA_CHANNEL_27                  0x0000001BU
#define LL_MDMA_CHANNEL_28                  0x0000001CU
#define LL_MDMA_CHANNEL_29                  0x0000001DU
#define LL_MDMA_CHANNEL_30                  0x0000001EU
#define LL_MDMA_CHANNEL_31                  0x0000001FU
...
#define LL_MDMA_DATAALIGN_RIGHT_SIGNED   MDMA_CTCR_PAM_0          /*!< Right Aligned, Sign extended ,
                                                                       ...
                                                                       Source data size smaller than Destination data
                                                                       size  */
...
#define LL_MDMA_REQ_DMA3_STREAM0_TC          0x00000010U    /*!< MDMA HW Trigger (request) is DMA3 Stream 0 Transfer Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM1_TC          0x00000011U    /*!< MDMA HW Trigger (request) is DMA3 Stream 1 Transfer Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM2_TC          0x00000012U    /*!< MDMA HW Trigger (request) is DMA3 Stream 2 Transfer Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM3_TC          0x00000013U    /*!< MDMA HW Trigger (request) is DMA3 Stream 3 Transfer Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM4_TC          0x00000014U    /*!< MDMA HW Trigger (request) is DMA3 Stream 4 Transfer Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM5_TC          0x00000015U    /*!< MDMA HW Trigger (request) is DMA3 Stream 5 Transfer Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM6_TC          0x00000016U    /*!< MDMA HW Trigger (request) is DMA3 Stream 6 Transfer Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM7_TC          0x00000017U    /*!< MDMA HW Trigger (request) is DMA3 Stream 7 Transfer Complete Flag   */
#define LL_MDMA_REQ_FMC_DATA                 0x00000018U    /*!< MDMA HW Trigger (request) is NAND data transfer (Tx or Rx) channel  */
#define LL_MDMA_REQ_FMC_ERROR                0x00000019U    /*!< MDMA HW Trigger (request) is NAND ECC/BCH Error channel             */
#define LL_MDMA_REQ_QUADSPI_FIFO_TH          0x0000001AU    /*!< MDMA HW Trigger (request) is QSPI FIFO threshold Flag               */
#define LL_MDMA_REQ_QUADSPI_TC               0x0000001BU    /*!< MDMA HW Trigger (request) is QSPI Transfer complete Flag            */
#define LL_MDMA_REQ_CRYP1_IN                 0x0000001CU    /*!< MDMA HW Trigger (request) is CRYP1 4 word request from input        */
#define LL_MDMA_REQ_CRYP1_OUT                0x0000001DU    /*!< MDMA HW Trigger (request) is CRYP1 4 word request from output       */
#define LL_MDMA_REQ_HASH1_IN                 0x0000001EU    /*!< MDMA HW Trigger (request) is HASH1 16 word request from input       */
#define LL_MDMA_REQ_SAES_IN                  0x0000001FU    /*!< MDMA HW Trigger (request) is SAES request from input        */
#define LL_MDMA_REQ_SAES_OUT                 0x00000020U    /*!< MDMA HW Trigger (request) is SAES request from output       */
#define LL_MDMA_REQ_SW                       0x40000000U    /*!< MDMA SW Trigger (request)   */
/**
  * @}
  */
...
#define LL_MDMA_GET_CHANNEL(__CHANNEL_INSTANCE__)   \
  (((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel0 )) ? LL_MDMA_CHANNEL_0  : \
   ...
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel15)) ? LL_MDMA_CHANNEL_15 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel16)) ? LL_MDMA_CHANNEL_16 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel17)) ? LL_MDMA_CHANNEL_17 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel18)) ? LL_MDMA_CHANNEL_18 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel19)) ? LL_MDMA_CHANNEL_19 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel20)) ? LL_MDMA_CHANNEL_20 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel21)) ? LL_MDMA_CHANNEL_21 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel22)) ? LL_MDMA_CHANNEL_22 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel23)) ? LL_MDMA_CHANNEL_23 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel24)) ? LL_MDMA_CHANNEL_24 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel25)) ? LL_MDMA_CHANNEL_25 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel26)) ? LL_MDMA_CHANNEL_26 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel27)) ? LL_MDMA_CHANNEL_27 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel28)) ? LL_MDMA_CHANNEL_28 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel29)) ? LL_MDMA_CHANNEL_29 : \
   ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel30)) ? LL_MDMA_CHANNEL_30 : \
   LL_MDMA_CHANNEL_31)
...
#define LL_MDMA_GET_CHANNEL_INSTANCE(__MDMA_INSTANCE__, __CHANNEL__)   \
  (((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_0 )) ? MDMA_Channel0  : \
   ...
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_15)) ? MDMA_Channel15 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_16)) ? MDMA_Channel16 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_17)) ? MDMA_Channel17 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_18)) ? MDMA_Channel18 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_19)) ? MDMA_Channel19 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_20)) ? MDMA_Channel20 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_21)) ? MDMA_Channel21 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_22)) ? MDMA_Channel22 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_23)) ? MDMA_Channel23 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_24)) ? MDMA_Channel24 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_25)) ? MDMA_Channel25 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_26)) ? MDMA_Channel26 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_27)) ? MDMA_Channel27 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_28)) ? MDMA_Channel28 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_29)) ? MDMA_Channel29 : \
   ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_30)) ? MDMA_Channel30 : \
   MDMA_Channel31)
...
/**
  ...
  *         @arg @ref LL_MDMA_CHANNEL_16
  *         @arg @ref LL_MDMA_CHANNEL_17
  *         @arg @ref LL_MDMA_CHANNEL_18
  *         @arg @ref LL_MDMA_CHANNEL_19
  *         @arg @ref LL_MDMA_CHANNEL_20
  *         @arg @ref LL_MDMA_CHANNEL_21
  *         @arg @ref LL_MDMA_CHANNEL_22
  *         @arg @ref LL_MDMA_CHANNEL_23
  *         @arg @ref LL_MDMA_CHANNEL_24
  *         @arg @ref LL_MDMA_CHANNEL_25
  *         @arg @ref LL_MDMA_CHANNEL_26
  *         @arg @ref LL_MDMA_CHANNEL_27
  *         @arg @ref LL_MDMA_CHANNEL_28
  *         @arg @ref LL_MDMA_CHANNEL_29
  *         @arg @ref LL_MDMA_CHANNEL_30
  *         @arg @ref LL_MDMA_CHANNEL_31
  * @retval None
  */
...
__STATIC_INLINE uint32_t LL_MDMA_IsEnabledChannel(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CCR,
                    MDMA_CCR_EN) == (MDMA_CCR_EN)) ? 1UL : 0UL);
}
...
/**
  ...
  *         @arg @ref LL_MDMA_BUFFER_TRANSFER or @ref LL_MDMA_BLOCK_TRANSFER or
  *         @ref LL_MDMA_REPEAT_BLOCK_TRANSFER or @ref LL_MDMA_FULL_TRANSFER
  ...
  *         @arg @ref LL_MDMA_DEST_BURST_SINGLE or @ref LL_MDMA_DEST_BURST_2BEATS or @ref LL_MDMA_DEST_BURST_4BEATS or
  *         @ref LL_MDMA_DEST_BURST_8BEATS
  *              or @ref LL_MDMA_DEST_BURST_16BEATS or @ref LL_MDMA_DEST_BURST_32BEATS or
  *         @ref LL_MDMA_DEST_BURST_64BEATS or @ref LL_MDMA_DEST_BURST_128BEATS
  *         @arg @ref LL_MDMA_SRC_BURST_SINGLE or @ref LL_MDMA_SRC_BURST_2BEATS or @ref LL_MDMA_SRC_BURST_4BEATS or
  *         @ref LL_MDMA_SRC_BURST_8BEATS
  *              or @ref LL_MDMA_SRC_BURST_16BEATS or @ref LL_MDMA_SRC_BURST_32BEATS or @ref LL_MDMA_SRC_BURST_64BEATS
  *         or @ref LL_MDMA_SRC_BURST_128BEATS
  *         @arg @ref LL_MDMA_DEST_INC_OFFSET_BYTE or @ref LL_MDMA_DEST_INC_OFFSET_HALFWORD or
  *         @ref LL_MDMA_DEST_INC_OFFSET_WORD or @ref LL_MDMA_DEST_INC_OFFSET_DOUBLEWORD
  *         @arg @ref LL_MDMA_SRC_INC_OFFSET_BYTE or @ref LL_MDMA_SRC_INC_OFFSET_HALFWORD or
  *         @ref LL_MDMA_SRC_INC_OFFSET_WORD or @ref LL_MDMA_SRC_INC_OFFSET_DOUBLEWORD
  *         @arg @ref LL_MDMA_DEST_DATA_SIZE_BYTE or @ref LL_MDMA_DEST_DATA_SIZE_HALFWORD or
  *         @ref LL_MDMA_DEST_DATA_SIZE_WORD or @ref LL_MDMA_DEST_DATA_SIZE_DOUBLEWORD
  *         @arg @ref LL_MDMA_SRC_DATA_SIZE_BYTE or @ref LL_MDMA_SRC_DATA_SIZE_HALFWORD or
  *         @ref LL_MDMA_SRC_DATA_SIZE_WORD or @ref LL_MDMA_SRC_DATA_SIZE_DOUBLEWORD
  ...
  * @retval None
  */
__STATIC_INLINE void LL_MDMA_ConfigTransfer(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t Configuration,
...
__STATIC_INLINE uint32_t LL_MDMA_IsEnabledBufferableWrMode(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR,
                    MDMA_CTCR_BWM) == (MDMA_CTCR_BWM)) ? 1UL : 0UL);
}
...
__STATIC_INLINE void LL_MDMA_SetRequestMode(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t RequestMode)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR, MDMA_CTCR_SWRM,
             RequestMode);
}
...
__STATIC_INLINE void LL_MDMA_SetTriggerMode(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t TriggerMode)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR, MDMA_CTCR_TRGM,
             TriggerMode);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsEnabledPacking(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR,
                    MDMA_CTCR_PKE) == (MDMA_CTCR_PKE)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_GetBufferTransferLength(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return (READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR,
                   MDMA_CTCR_TLEN) >> MDMA_CTCR_TLEN_Pos);
}
...
__STATIC_INLINE void LL_MDMA_SetDestinationBurstSize(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t Dburst)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR,
             MDMA_CTCR_DBURST, Dburst);
}
...
__STATIC_INLINE void LL_MDMA_SetDestinationIncSize(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t IncSize)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR, MDMA_CTCR_DINCOS,
             IncSize);
}
...
__STATIC_INLINE void LL_MDMA_SetSourceIncSize(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t IncSize)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR, MDMA_CTCR_SINCOS,
             IncSize);
}
...
__STATIC_INLINE void LL_MDMA_SetSourceDataSize(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t SrcDataSize)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR, MDMA_CTCR_SSIZE,
             SrcDataSize);
}
...
__STATIC_INLINE void LL_MDMA_SetDestinationIncMode(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t DestIncMode)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR, MDMA_CTCR_DINC,
             DestIncMode);
}
...
__STATIC_INLINE void LL_MDMA_SetSourceIncMode(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t SrcIncMode)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTCR, MDMA_CTCR_SINC,
             SrcIncMode);
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_MDMA_ConfigBlkCounters(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t BlockRepeatCount,
                                               uint32_t BlkDataLength)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CBNDTR,
             ...
             (BlkDataLength & MDMA_CBNDTR_BNDT_Msk));
}
...
__STATIC_INLINE void LL_MDMA_SetBlkDataLength(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t BlkDataLength)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CBNDTR, MDMA_CBNDTR_BNDT,
             (BlkDataLength & MDMA_CBNDTR_BNDT_Msk));
}
...
__STATIC_INLINE uint32_t LL_MDMA_GetBlkDataLength(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return (READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CBNDTR,
                   MDMA_CBNDTR_BNDT));
}
...
__STATIC_INLINE uint32_t LL_MDMA_GetBlkRepeatCount(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return (READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CBNDTR,
                   MDMA_CBNDTR_BRC) >> MDMA_CBNDTR_BRC_Pos);
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_MDMA_SetBlkRepeatDestAddrUpdate(MDMA_TypeDef *MDMAx, uint32_t Channel,
                                                        uint32_t DestAdrUpdateMode)
{
  uint32_t mdma_base_addr = (uint32_t)MDMAx;

  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CBNDTR, MDMA_CBNDTR_BRDUM,
             DestAdrUpdateMode);
}
...
__STATIC_INLINE void LL_MDMA_SetBlkRepeatSrcAddrUpdate(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t SrcAdrUpdateMode)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CBNDTR, MDMA_CBNDTR_BRSUM,
             SrcAdrUpdateMode);
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_MDMA_ConfigAddresses(MDMA_TypeDef *MDMAx, uint32_t Channel,  uint32_t SrcAddress,
                                             uint32_t DstAddress)
{
  uint32_t mdma_base_addr = (uint32_t)MDMAx;
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_MDMA_ConfigBlkRptAddrUpdateValue(MDMA_TypeDef *MDMAx, uint32_t Channel,
                                                         uint32_t SrctAdrUpdateValue, uint32_t DestAdrUpdateValue)
{
  uint32_t mdma_base_addr = (uint32_t)MDMAx;

  WRITE_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CBRUR,
            (SrctAdrUpdateValue & MDMA_CBRUR_SUV_Msk)  | ((DestAdrUpdateValue << MDMA_CBRUR_DUV_Pos) &
                                                          MDMA_CBRUR_DUV_Msk));
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_MDMA_SetBlkRptDestAddrUpdateValue(MDMA_TypeDef *MDMAx, uint32_t Channel,
...
__STATIC_INLINE uint32_t LL_MDMA_GetBlkRptDestAddrUpdateValue(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return (READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CBRUR,
                   MDMA_CBRUR_DUV) >> MDMA_CBRUR_DUV_Pos);
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_MDMA_SetBlkRptSrcAddrUpdateValue(MDMA_TypeDef *MDMAx, uint32_t Channel,
                                                         uint32_t SrcAdrUpdateValue)
{
  uint32_t mdma_base_addr = (uint32_t)MDMAx;

  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CBRUR, MDMA_CBRUR_SUV,
             SrcAdrUpdateValue);
}
...
/**
  ...
  *         @arg @ref LL_MDMA_REQ_DMA3_STREAM0_TC
  *         @arg @ref LL_MDMA_REQ_DMA3_STREAM1_TC
  *         @arg @ref LL_MDMA_REQ_DMA3_STREAM2_TC
  *         @arg @ref LL_MDMA_REQ_DMA3_STREAM3_TC
  *         @arg @ref LL_MDMA_REQ_DMA3_STREAM4_TC
  *         @arg @ref LL_MDMA_REQ_DMA3_STREAM5_TC
  *         @arg @ref LL_MDMA_REQ_DMA3_STREAM6_TC
  *         @arg @ref LL_MDMA_REQ_DMA3_STREAM7_TC
  *         @arg @ref LL_MDMA_REQ_FMC_DATA
  *         @arg @ref LL_MDMA_REQ_FMC_ERROR
  *         @arg @ref LL_MDMA_REQ_QUADSPI_FIFO_TH
  *         @arg @ref LL_MDMA_REQ_QUADSPI_TC
  *         @arg @ref LL_MDMA_REQ_CRYP1_IN
  *         @arg @ref LL_MDMA_REQ_CRYP1_OUT
  *         @arg @ref LL_MDMA_REQ_HASH1_IN
  *         @arg @ref LL_MDMA_REQ_SAES_IN
  *         @arg @ref LL_MDMA_REQ_SAES_OUT
...
__STATIC_INLINE void LL_MDMA_SetHWTrigger(MDMA_TypeDef *MDMAx, uint32_t Channel, uint32_t HWRequest)
{
  ...
  MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CTBR, MDMA_CTBR_TSEL,
             HWRequest);
}
...
{
  return ((READ_BIT(MDMAx->GISR0, (MDMA_GISR0_GIF0 << (Channel & 0x0000001FU))) ==
           (MDMA_GISR0_GIF0 << (Channel & 0x0000001FU))) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsActiveFlag_TE(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CISR,
                    MDMA_CISR_TEIF) == (MDMA_CISR_TEIF)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsActiveFlag_CTC(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CISR,
                    MDMA_CISR_CTCIF) == (MDMA_CISR_CTCIF)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsActiveFlag_BRT(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CISR,
                    MDMA_CISR_BRTIF) == (MDMA_CISR_BRTIF)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsActiveFlag_BT(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CISR,
                    MDMA_CISR_BTIF) == (MDMA_CISR_BTIF)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsActiveFlag_TC(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CISR,
                    MDMA_CISR_TCIF) == (MDMA_CISR_TCIF)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsActiveFlag_CRQA(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CISR,
                    MDMA_CISR_CRQA) == (MDMA_CISR_CRQA)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsActiveFlag_BSE(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CESR,
                    MDMA_CESR_BSE) == (MDMA_CESR_BSE)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsActiveFlag_ASE(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CESR,
                    MDMA_CESR_ASE) == (MDMA_CESR_ASE)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsActiveFlag_TEMD(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CESR,
                    MDMA_CESR_TEMD) == (MDMA_CESR_TEMD)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsActiveFlag_TELD(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CESR,
                    MDMA_CESR_TELD) == (MDMA_CESR_TELD)) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsEnabledIT_TE(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CCR,
                    MDMA_CCR_TEIE) == MDMA_CCR_TEIE) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsEnabledIT_CTC(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CCR,
                    MDMA_CCR_CTCIE) == MDMA_CCR_CTCIE) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsEnabledIT_BRT(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CCR,
                    MDMA_CCR_BRTIE) == MDMA_CCR_BRTIE) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsEnabledIT_BT(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CCR,
                    MDMA_CCR_BTIE) == MDMA_CCR_BTIE) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_MDMA_IsEnabledIT_TC(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
  ...
  return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr + LL_MDMA_CH_OFFSET_TAB[Channel]))->CCR,
                    MDMA_CCR_TCIE) == MDMA_CCR_TCIE) ? 1UL : 0UL);
}
