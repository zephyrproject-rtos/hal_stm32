...
#ifndef STM32MP13xx_LL_LPTIM_H
#define STM32MP13xx_LL_LPTIM_H
...
#define LL_LPTIM_TRIG_SOURCE_SAI1A            LPTIM_CFGR_TRIGSEL_2                                                 /*!<External input trigger is connected to SAI1A output*/
#define LL_LPTIM_TRIG_SOURCE_SAI1B            (LPTIM_CFGR_TRIGSEL_2 | LPTIM_CFGR_TRIGSEL_0)                        /*!<External input trigger is connected to SAI1B output*/
#define LL_LPTIM_TRIG_SOURCE_SAI2A            LPTIM_CFGR_TRIGSEL_2                                                 /*!<External input trigger is connected to SAI2A output*/
#define LL_LPTIM_TRIG_SOURCE_SAI2B            (LPTIM_CFGR_TRIGSEL_2 | LPTIM_CFGR_TRIGSEL_0)                        /*!<External input trigger is connected to SAI2B output*/
/**
  * @}
  */
