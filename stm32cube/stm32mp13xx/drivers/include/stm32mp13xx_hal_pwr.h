...
#ifndef __STM32MP13xx_HAL_PWR_H
#define __STM32MP13xx_HAL_PWR_H
...
#define __HAL_PWR_GET_FLAG(__FLAG__) ( \
                                       ...
                                       ((__FLAG__) == PWR_FLAG_11R)?((PWR->CR3 & PWR_CR3_REG11RDY) == \
                                                                     PWR_CR3_REG11RDY) : \
                                       ((__FLAG__) == PWR_FLAG_18R)?((PWR->CR3 & PWR_CR3_REG18RDY) == \
                                                                     PWR_CR3_REG18RDY) : \
                                       ((__FLAG__) == PWR_FLAG_USB)?((PWR->CR3 & PWR_CR3_USB33RDY) == \
                                                                     PWR_CR3_USB33RDY) : \
                                       ((__FLAG__) == PWR_FLAG_SB)?((PWR->MPUCR & PWR_MPUCR_SBF) ==  PWR_MPUCR_SBF) : \
                                       ((__FLAG__) == PWR_FLAG_STOP)?((PWR->MPUCR & PWR_MPUCR_STOPF) == \
                                                                      PWR_MPUCR_STOPF) : \
...
#include "stm32mp13xx_hal_pwr_ex.h"
