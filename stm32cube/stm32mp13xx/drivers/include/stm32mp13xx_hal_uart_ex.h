/**
  ******************************************************************************
  * @file    stm32mp13xx_hal_uart_ex.h
...
#ifndef STM32MP13xx_HAL_UART_EX_H
#define STM32MP13xx_HAL_UART_EX_H
    ...
    {                                                         \
      ...
      {                                                       \
        case RCC_USART1CLKSOURCE_PCLK6:                       \
          (__CLOCKSOURCE__) = UART_CLOCKSOURCE_PCLK6;         \
          break;                                              \
...
#endif /* STM32MP13xx_HAL_UART_EX_H */
