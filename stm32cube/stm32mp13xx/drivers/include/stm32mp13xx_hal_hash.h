...
#ifndef STM32MP13xx_HAL_HASH_H
#define STM32MP13xx_HAL_HASH_H
...
#endif /* (USE_HAL_HASH_REGISTER_CALLBACKS) */
{
  ...
  MDMA_HandleTypeDef         *hmdmain;         /*!< HASH In MDMA handle parameters */
...
#define HASH_ALGOSELECTION_SHA1            ((0x0U * HASH_CR_ALGO_1) + (0x0U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA224          ((0x1U * HASH_CR_ALGO_1) + (0x0U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA256          ((0x1U * HASH_CR_ALGO_1) + (0x1U * HASH_CR_ALGO_0))

#define HASH_ALGOSELECTION_SHA384          ((0x1U * HASH_CR_ALGO_3)\
                                            + (0x1U * HASH_CR_ALGO_2) + (0x0U * HASH_CR_ALGO_1)\
                                            + (0x0U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA512_224      ((0x1U * HASH_CR_ALGO_3)\
                                            + (0x1U * HASH_CR_ALGO_2) + (0x0U * HASH_CR_ALGO_1)\
                                            + (0x1U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA512_256      ((0x1U * HASH_CR_ALGO_3)\
                                            + (0x1U * HASH_CR_ALGO_2) + (0x1U * HASH_CR_ALGO_1)\
                                            + (0x0U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA512          ((0x1U * HASH_CR_ALGO_3)\
                                            + (0x1U * HASH_CR_ALGO_2) + (0x1U * HASH_CR_ALGO_1)\
                                            + (0x1U * HASH_CR_ALGO_0))

#define HASH_ALGOSELECTION_SHA3_224        ((0x0U * HASH_CR_ALGO_3)\
                                            + (0x1U * HASH_CR_ALGO_2) + (0x0U * HASH_CR_ALGO_1)\
                                            +(0x0U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA3_256        ((0x0U * HASH_CR_ALGO_3)\
                                            + (0x1U * HASH_CR_ALGO_2) + (0x0U * HASH_CR_ALGO_1)\
                                            + (0x1U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA3_384        ((0x0U * HASH_CR_ALGO_3)\
                                            + (0x1U * HASH_CR_ALGO_2) + (0x1U * HASH_CR_ALGO_1)\
                                            + (0x0U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA3_512        ((0x0U * HASH_CR_ALGO_3)\
                                            + (0x1U * HASH_CR_ALGO_2) + (0x1U * HASH_CR_ALGO_1)\
                                            + (0x1U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHAKE_128       ((0x1U * HASH_CR_ALGO_3)\
                                            + (0x0U * HASH_CR_ALGO_2) + (0x0U * HASH_CR_ALGO_1)\
                                            + (0x0U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHAKE_256       ((0x1U * HASH_CR_ALGO_3)\
                                            + (0x0U * HASH_CR_ALGO_2) + (0x0U * HASH_CR_ALGO_1)\
                                            + (0x1U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_RAWSHAKE_128    ((0x1U * HASH_CR_ALGO_3)\
                                            + (0x0U * HASH_CR_ALGO_2) + (0x1U * HASH_CR_ALGO_1)\
                                            + (0x0U * HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_RAWSHAKE_256    ((0x1U * HASH_CR_ALGO_3)\
                                            + (0x0U * HASH_CR_ALGO_2) + (0x1U * HASH_CR_ALGO_1)\
                                            + (0x1U * HASH_CR_ALGO_0))
...
/** @defgroup HASH_FULLSWAPCONTEXT_BUFFER_WSIZE Size in word of the full context swap buffer
  * @{
  */

#define HASH_FULLSWAPCONTEXT_BUFFER_WSIZE             (4 + HASH_NUMBER_OF_CSR_REGISTERS)  /*!< Save/Restore HASH_IMR + HASH_STR + HASH_CR + HASH_SHA3CFGR + HASH_CSRx */
...
#define HASH_DIGEST_LENGTH() ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA1)         ?  20U : \
                              ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA224)       ?  28U : \
                               ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA384)       ?  48U : \
                                ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA512_224)   ?  28U : \
                                 ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA512_256)   ?  32U : \
                                  ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA512)       ?  64U : \
                                   ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA3_224)     ?  28U : \
                                    ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA3_256)     ?  32U : \
                                     ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA3_384)     ?  48U : \
                                      ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA3_512)     ?  64U : \
                                       ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHAKE_128)    ?  16U : \
                                        ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHAKE_256)\
                                         ?  32U : \
                                         ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_RAWSHAKE_128)\
                                          ?  16U : \
                                          ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_RAWSHAKE_256)\
                                           ?  32U : \
                                           ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA256)\
                                            ?  32U : 16U ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
/**
...
/**
  ...
  * @note  This check is valid only for accumulate HASH processing in polling mode.
...
/**
  ...
  * @retval SET (__SIZE__ is valid) or RESET (__SIZE__ is invalid)
  */
#define IS_HASH_DMA_MULTIBUFFER_SIZE(__SIZE__)  ((READ_BIT(HASH->CR, HASH_CR_MDMAT) == 0U) ||\
                                                 (((__SIZE__) % 16U) == 0U))
...
/**
  ...
  * @param __HANDLE__ HASH handle.
  * @param __SIZE__ input data buffer size in byte.
  * @retval SET (__SIZE__ is valid) or RESET (__SIZE__ is invalid)
  */
...
#include "stm32mp13xx_hal_hash_ex.h"
/* Exported functions --------------------------------------------------------*/
