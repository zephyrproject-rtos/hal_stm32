...
#ifndef STM32MP13xx_LL_RCC_H
#define STM32MP13xx_LL_RCC_H
...
/* Clock source register offset Vs MCO1CFGR register */
#define RCC_OFFSET_MCO1CFGR        0x000UL
#define RCC_OFFSET_MCO2CFGR        0x004UL
#define RCC_OFFSET_CKPERCKSELR     0x0ECUL
#define RCC_OFFSET_TIMG1PRER       0x140UL
#define RCC_OFFSET_TIMG2PRER       0x144UL
#define RCC_OFFSET_TIMG3PRER       0x148UL
#define RCC_OFFSET_I2C12CKSELR     0x1A0UL
#define RCC_OFFSET_I2C345CKSELR    0x1A4UL
#define RCC_OFFSET_SPI2S1CKSELR    0x1A8UL
#define RCC_OFFSET_SPI2S23CKSELR   0x1ACUL
#define RCC_OFFSET_SPI45CKSELR     0x1B0UL
#define RCC_OFFSET_UART12CKSELR    0x1B4UL
#define RCC_OFFSET_UART35CKSELR    0x1B8UL
#define RCC_OFFSET_UART4CKSELR     0x1BCUL
#define RCC_OFFSET_UART6CKSELR     0x1C0UL
#define RCC_OFFSET_UART78CKSELR    0x1C4UL
#define RCC_OFFSET_LPTIM1CKSELR    0x1C8UL
#define RCC_OFFSET_LPTIM23CKSELR   0x1CCUL
#define RCC_OFFSET_LPTIM45CKSELR   0x1D0UL
#define RCC_OFFSET_SAI1CKSELR      0x1D4UL
#define RCC_OFFSET_SAI2CKSELR      0x1D8UL
#define RCC_OFFSET_FDCANCKSELR     0x1DCUL
#define RCC_OFFSET_SPDIFCKSELR     0x1E0UL
#define RCC_OFFSET_ADC12CKSELR     0x1E4UL
#define RCC_OFFSET_SDMMC12CKSELR   0x1E8UL
#define RCC_OFFSET_ETH12CKSELR     0x1ECUL
#define RCC_OFFSET_USBCKSELR       0x1F0UL
#define RCC_OFFSET_QSPICKSELR      0x1F4UL
#define RCC_OFFSET_FMCCKSELR       0x1F8UL
#define RCC_OFFSET_RNG1CKSELR      0x1FCUL
#define RCC_OFFSET_STGENCKSELR     0x200UL
#define RCC_OFFSET_DCMIPPCKSELR    0x204UL
#define RCC_OFFSET_SAESCKSELR      0x208UL

#define RCC_CONFIG_SHIFT  0U
#define RCC_MASK_SHIFT    10U
#define RCC_REG_SHIFT     22U


/* Define all reset flags mask */
#define LL_RCC_MP_RSTSCLRR_ALL  0x000001FFU
/**
  * @}
  */
...
/* 32                  22                   10             0
   --------------------------------------------------------
   | Register          |    Mask            | ClkSource   |
   | Offset            |                    | Config      |
   --------------------------------------------------------*/

#define LL_CLKSOURCE_MASK(__CLKSOURCE__) \
  (((__CLKSOURCE__) >> RCC_MASK_SHIFT  ) & 0xFFFUL)

#define LL_CLKSOURCE_CONFIG(__CLKSOURCE__) \
  (((__CLKSOURCE__) >> RCC_CONFIG_SHIFT) & 0x3FFUL)

#define LL_CLKSOURCE_REG(__CLKSOURCE__) \
  (((__CLKSOURCE__) >> RCC_REG_SHIFT   ) & 0x3FFUL)
...
typedef struct
{
  ...
  uint32_t MLAHBS_Frequency;  /*!< MLAHBS clock frequency */
  ...
  uint32_t PCLK6_Frequency;   /*!< PCLK6 clock frequency */
...
/** @defgroup RCC_LL_EC_IT IT Defines
  ...
  * @{
  */
#define LL_RCC_CIER_LSIRDYIE      RCC_MP_CIER_LSIRDYIE /*!< LSI Ready Interrupt Enable */
#define LL_RCC_CIER_LSERDYIE      RCC_MP_CIER_LSERDYIE /*!< LSE Ready Interrupt Enable */
#define LL_RCC_CIER_HSIRDYIE      RCC_MP_CIER_HSIRDYIE /*!< HSI Ready Interrupt Enable */
#define LL_RCC_CIER_HSERDYIE      RCC_MP_CIER_HSERDYIE /*!< HSE Ready Interrupt Enable */
#define LL_RCC_CIER_CSIRDYIE      RCC_MP_CIER_CSIRDYIE /*!< CSI Ready Interrupt Enable */
#define LL_RCC_CIER_PLL1RDYIE     RCC_MP_CIER_PLL1DYIE /*!< PLL1 Ready Interrupt Enable */
#define LL_RCC_CIER_PLL2RDYIE     RCC_MP_CIER_PLL2DYIE /*!< PLL2 Ready Interrupt Enable */
#define LL_RCC_CIER_PLL3RDYIE     RCC_MP_CIER_PLL3DYIE /*!< PLL3 Ready Interrupt Enable */
#define LL_RCC_CIER_PLL4RDYIE     RCC_MP_CIER_PLL4DYIE /*!< PLL4 Ready Interrupt Enable */
#define LL_RCC_CIER_LSECSSIE      RCC_MP_CIER_LSECSSIE /*!< LSE Clock Security System Interrupt Enable */
#define LL_RCC_CIER_WKUPIE        RCC_MP_CIER_WKUPIE   /*!< Wake up from CStop Interrupt Enable */
/**
  * @}
  */
...
#define LL_RCC_HSI_DIV_8                   (RCC_HSICFGR_HSIDIV_1 | RCC_HSICFGR_HSIDIV_0)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_MCOxSOURCE  MCO SOURCE selection
  * @{
  */
#define LL_RCC_MCO1SOURCE_HSI      LL_CLKSOURCE(RCC_OFFSET_MCO1CFGR, RCC_MCO1CFGR_MCO1SEL, 0U)
...
#define LL_RCC_MCO1SOURCE_LSI      LL_CLKSOURCE(RCC_OFFSET_MCO1CFGR, RCC_MCO1CFGR_MCO1SEL, \
                                                (RCC_MCO1CFGR_MCO1SEL_1 | RCC_MCO1CFGR_MCO1SEL_0))
#define LL_RCC_MCO1SOURCE_LSE      LL_CLKSOURCE(RCC_OFFSET_MCO1CFGR, RCC_MCO1CFGR_MCO1SEL, RCC_MCO1CFGR_MCO1SEL_2)
#define LL_RCC_MCO2SOURCE_MPU      LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL, 0U)
#define LL_RCC_MCO2SOURCE_AXI      LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL, RCC_MCO2CFGR_MCO2SEL_0)
#define LL_RCC_MCO2SOURCE_MLAHB    LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL, RCC_MCO2CFGR_MCO2SEL_1)
#define LL_RCC_MCO2SOURCE_PLL4     LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL, \
...
#define LL_RCC_MCO2SOURCE_HSI      LL_CLKSOURCE(RCC_OFFSET_MCO2CFGR, RCC_MCO2CFGR_MCO2SEL, \
...
#define LL_RCC_RTC_HSE_DIV_16               (RCC_RTCDIVR_RTCDIV_3 |\
...
#define LL_RCC_RTC_HSE_DIV_24               (RCC_RTCDIVR_RTCDIV_4 |\
                                             RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
...
#define LL_RCC_RTC_HSE_DIV_28               (RCC_RTCDIVR_RTCDIV_4 |\
...
#define LL_RCC_RTC_HSE_DIV_30               (RCC_RTCDIVR_RTCDIV_4 |\
                                             RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_31               (RCC_RTCDIVR_RTCDIV_4 |\
                                             RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1)
#define LL_RCC_RTC_HSE_DIV_32               (RCC_RTCDIVR_RTCDIV_4 |\
                                             RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1 |\
...
#define LL_RCC_RTC_HSE_DIV_40               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
...
#define LL_RCC_RTC_HSE_DIV_44               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_45               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_2)
#define LL_RCC_RTC_HSE_DIV_46               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_47               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1)
#define LL_RCC_RTC_HSE_DIV_48               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_49               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3)
#define LL_RCC_RTC_HSE_DIV_50               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_51               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_1)
#define LL_RCC_RTC_HSE_DIV_52               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_53               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2)
#define LL_RCC_RTC_HSE_DIV_54               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_55               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1)
#define LL_RCC_RTC_HSE_DIV_56               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_3 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1 | \
                                             RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_57               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4)
#define LL_RCC_RTC_HSE_DIV_58               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_59               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_1)
#define LL_RCC_RTC_HSE_DIV_60               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_1 | RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_61               (RCC_RTCDIVR_RTCDIV_5 | RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_2)
#define LL_RCC_RTC_HSE_DIV_62               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_0)
#define LL_RCC_RTC_HSE_DIV_63               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1)
#define LL_RCC_RTC_HSE_DIV_64               (RCC_RTCDIVR_RTCDIV_5 |\
                                             RCC_RTCDIVR_RTCDIV_4 | RCC_RTCDIVR_RTCDIV_2 | RCC_RTCDIVR_RTCDIV_1 | \
                                             RCC_RTCDIVR_RTCDIV_0)
/**
  * @}
...
#define LL_RCC_MPU_CLKSOURCE_MPUDIV             (RCC_MPCKSELR_MPUSRC_0 | RCC_MPCKSELR_MPUSRC_1) /*!< MPUDIV selection as MPU clock */
/**
  * @}
  */
...
#define LL_RCC_MPU_CLKSOURCE_STATUS_MPUDIV      (RCC_MPCKSELR_MPUSRC_0 | RCC_MPCKSELR_MPUSRC_1) /*!< MPUDIV used as MPU clock */
/**
  * @}
  */
...
#define LL_RCC_AXI_DIV_4                        (RCC_AXIDIVR_AXIDIV_0 | RCC_AXIDIVR_AXIDIV_1)  /*!< AXISS divided by 4 */
/**
  * @}
  */

/** @defgroup RCC_LL_EC_MLAHBS_CLKSOURCE  MLAHBS clock switch
  * @{
  */
#define LL_RCC_MLAHBS_CLKSOURCE_HSI              0U                        /*!< HSI selection as MLAHBS clock */
#define LL_RCC_MLAHBS_CLKSOURCE_HSE              RCC_MSSCKSELR_MLAHBSSRC_0 /*!< HSE selection as MLAHBS clock */
#define LL_RCC_MLAHBS_CLKSOURCE_CSI              RCC_MSSCKSELR_MLAHBSSRC_1 /*!< CSI selection as MLAHBS clock */
#define LL_RCC_MLAHBS_CLKSOURCE_PLL3             (RCC_MSSCKSELR_MLAHBSSRC_1 | RCC_MSSCKSELR_MLAHBSSRC_0) /*!< PLL3 selection as MLAHBS clock */
/**
  * @}
  */

/** @defgroup RCC_LL_EC_MLAHBS_CLKSOURCE_STATUS  MLAHBS clock switch status
  * @{
  */
#define LL_RCC_MLAHBS_CLKSOURCE_STATUS_HSI       0U                        /*!< HSI used as MLAHBS clock */
#define LL_RCC_MLAHBS_CLKSOURCE_STATUS_HSE       RCC_MSSCKSELR_MLAHBSSRC_0 /*!< HSE used as MLAHBS clock */
#define LL_RCC_MLAHBS_CLKSOURCE_STATUS_CSI       RCC_MSSCKSELR_MLAHBSSRC_1 /*!< CSI used as MLAHBS clock */
#define LL_RCC_MLAHBS_CLKSOURCE_STATUS_PLL3      (RCC_MSSCKSELR_MLAHBSRC_1 | RCC_MSSCKSELR_MLAHBSRC_0) /*!< PLL3 used as MLAHB clock */
/**
  * @}
  */

/** @defgroup RCC_LL_EC_MLAHB_DIV  MLAHBDIV prescaler
  * @{
  */
#define LL_RCC_MLAHB_DIV_1                        0U                   /*!< MLAHBSS not divided */
#define LL_RCC_MLAHB_DIV_2                        RCC_MLAHBDIVR_MLAHBDIV_0 /*!< MLAHBSS divided by 2 */
#define LL_RCC_MLAHB_DIV_4                        RCC_MLAHBDIVR_MLAHBDIV_1 /*!< MLAHBSS divided by 4 */
#define LL_RCC_MLAHB_DIV_8                        (RCC_MLAHBDIVR_MLAHBDIV_1 | RCC_MLAHBDIVR_MLAHBDIV_0) /*!< MLAHBSS divided by 8 */
#define LL_RCC_MLAHB_DIV_16                       RCC_MLAHBDIVR_MLAHBDIV_2                          /*!< MLAHBSS divided by 16 */
#define LL_RCC_MLAHB_DIV_32                       (RCC_MLAHBDIVR_MLAHBDIV_2 | RCC_MLAHBDIVR_MLAHBDIV_0) /*!< MLAHBSS divided by 32 */
#define LL_RCC_MLAHB_DIV_64                       (RCC_MLAHBDIVR_MLAHBDIV_2 | RCC_MLAHBDIVR_MLAHBDIV_1) /*!< MLAHBSS divided by 64 */
#define LL_RCC_MLAHB_DIV_128                      (RCC_MLAHBDIVR_MLAHBDIV_2 | RCC_MLAHBDIVR_MLAHBDIV_1 | RCC_MLAHBDIVR_MLAHBDIV_0) /*!< MLAHBSS divided by 128 */
#define LL_RCC_MLAHB_DIV_256                      RCC_MLAHBDIVR_MLAHBDIV_3                                                 /*!< MLAHBSS divided by 256 */
#define LL_RCC_MLAHB_DIV_512                      (RCC_MLAHBDIVR_MLAHBDIV_3 | RCC_MLAHBDIVR_MLAHBDIV_0)                        /*!< MLAHBSS divided by 512 */
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_APB6_DIV  APB6 prescaler
  * @{
  */
#define LL_RCC_APB6_DIV_1                       0U                                                 /*!< mlhclk not divided (default after reset) */
#define LL_RCC_APB6_DIV_2                       RCC_APB6DIVR_APB6DIV_0                             /*!< mlhclk divided by 2 */
#define LL_RCC_APB6_DIV_4                       RCC_APB6DIVR_APB6DIV_1                             /*!< mlhclk divided by 4 */
#define LL_RCC_APB6_DIV_8                       (RCC_APB6DIVR_APB6DIV_1 | RCC_APB6DIVR_APB6DIV_0)  /*!< mlhclk divided by 8 */
#define LL_RCC_APB6_DIV_16                      RCC_APB6DIVR_APB6DIV_2                             /*!< mlhclk divided by 16 */
/**
  * @}
  */
...
#define LL_RCC_MLAHB_DIV128                 (RCC_MLAHBDIVR_MLAHBDIV_2 |\
...
/** @defgroup RCC_LL_EC_I2Cx_CLKSOURCE  Peripheral I2C clock source selection
  * @{
  */
#define LL_RCC_I2C12_CLKSOURCE_PCLK1        LL_CLKSOURCE(RCC_OFFSET_I2C12CKSELR, RCC_I2C12CKSELR_I2C12SRC, 0U)
#define LL_RCC_I2C12_CLKSOURCE_PLL4R        LL_CLKSOURCE(RCC_OFFSET_I2C12CKSELR, RCC_I2C12CKSELR_I2C12SRC, \
                                                         RCC_I2C12CKSELR_I2C12SRC_0)
#define LL_RCC_I2C12_CLKSOURCE_HSI          LL_CLKSOURCE(RCC_OFFSET_I2C12CKSELR, RCC_I2C12CKSELR_I2C12SRC, \
                                                         RCC_I2C12CKSELR_I2C12SRC_1)
#define LL_RCC_I2C12_CLKSOURCE_CSI          LL_CLKSOURCE(RCC_OFFSET_I2C12CKSELR, RCC_I2C12CKSELR_I2C12SRC, \
                                                         (RCC_I2C12CKSELR_I2C12SRC_1 | RCC_I2C12CKSELR_I2C12SRC_0))

#define LL_RCC_I2C3_CLKSOURCE_PCLK6         LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C3SRC, 0U)
#define LL_RCC_I2C3_CLKSOURCE_PLL4R         LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C3SRC, \
                                                         RCC_I2C345CKSELR_I2C3SRC_0)
#define LL_RCC_I2C3_CLKSOURCE_HSI           LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C3SRC, \
                                                         RCC_I2C345CKSELR_I2C3SRC_1)
#define LL_RCC_I2C3_CLKSOURCE_CSI           LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C3SRC, \
                                                         (RCC_I2C345CKSELR_I2C3SRC_1 | RCC_I2C345CKSELR_I2C3SRC_0))

#define LL_RCC_I2C4_CLKSOURCE_PCLK6         LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C4SRC, 0U)
#define LL_RCC_I2C4_CLKSOURCE_PLL4R         LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C4SRC, \
                                                         RCC_I2C345CKSELR_I2C4SRC_0)
#define LL_RCC_I2C4_CLKSOURCE_HSI           LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C4SRC, \
                                                         RCC_I2C345CKSELR_I2C4SRC_1)
#define LL_RCC_I2C4_CLKSOURCE_CSI           LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C4SRC, \
                                                         (RCC_I2C345CKSELR_I2C4SRC_1 | RCC_I2C345CKSELR_I2C4SRC_0))

#define LL_RCC_I2C5_CLKSOURCE_PCLK6         LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C5SRC, 0U)
#define LL_RCC_I2C5_CLKSOURCE_PLL4R         LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C5SRC, \
                                                         RCC_I2C345CKSELR_I2C5SRC_0)
#define LL_RCC_I2C5_CLKSOURCE_HSI           LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C5SRC, \
                                                         RCC_I2C345CKSELR_I2C5SRC_1)
#define LL_RCC_I2C5_CLKSOURCE_CSI           LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C5SRC, \
                                                         (RCC_I2C345CKSELR_I2C5SRC_1 | RCC_I2C345CKSELR_I2C5SRC_0))
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_SPIx_CLKSOURCE  Peripheral SPI/I2S clock source selection
  * @{
  */
#define LL_RCC_SPI1_CLKSOURCE_PLL4P         LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC, 0U)
#define LL_RCC_SPI1_CLKSOURCE_PLL3Q         LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC, \
                                                         RCC_SPI2S1CKSELR_SPI1SRC_0)
#define LL_RCC_SPI1_CLKSOURCE_I2SCKIN       LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC, \
                                                         RCC_SPI2S1CKSELR_SPI1SRC_1)
#define LL_RCC_SPI1_CLKSOURCE_PER           LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC, \
                                                         (RCC_SPI2S1CKSELR_SPI1SRC_1 | RCC_SPI2S1CKSELR_SPI1SRC_0))
#define LL_RCC_SPI1_CLKSOURCE_PLL3R         LL_CLKSOURCE(RCC_OFFSET_SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC, \
                                                         RCC_SPI2S1CKSELR_SPI1SRC_2)

#define LL_RCC_SPI23_CLKSOURCE_PLL4P        LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC, 0U)
#define LL_RCC_SPI23_CLKSOURCE_PLL3Q        LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC, \
                                                         RCC_SPI2S23CKSELR_SPI23SRC_0)
#define LL_RCC_SPI23_CLKSOURCE_I2SCKIN      LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC, \
                                                         RCC_SPI2S23CKSELR_SPI23SRC_1)
#define LL_RCC_SPI23_CLKSOURCE_PER          LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC, \
                                                         (RCC_SPI2S23CKSELR_SPI23SRC_1 | RCC_SPI2S23CKSELR_SPI23SRC_0))
#define LL_RCC_SPI23_CLKSOURCE_PLL3R        LL_CLKSOURCE(RCC_OFFSET_SPI2S23CKSELR, RCC_SPI2S23CKSELR_SPI23SRC, \
                                                         RCC_SPI2S23CKSELR_SPI23SRC_2)

#define LL_RCC_SPI4_CLKSOURCE_PCLK6         LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI4SRC, 0U)
#define LL_RCC_SPI4_CLKSOURCE_PLL4Q         LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI4SRC, \
                                                         RCC_SPI45CKSELR_SPI4SRC_0)
#define LL_RCC_SPI4_CLKSOURCE_HSI           LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI4SRC, \
                                                         RCC_SPI45CKSELR_SPI4SRC_1)
#define LL_RCC_SPI4_CLKSOURCE_CSI           LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI4SRC, \
                                                         (RCC_SPI45CKSELR_SPI4SRC_1 | RCC_SPI45CKSELR_SPI4SRC_0))
#define LL_RCC_SPI4_CLKSOURCE_HSE           LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI4SRC, \
                                                         RCC_SPI45CKSELR_SPI4SRC_2)

#define LL_RCC_SPI5_CLKSOURCE_PCLK6         LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI5SRC, 0U)
#define LL_RCC_SPI5_CLKSOURCE_PLL4Q         LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI5SRC, \
                                                         RCC_SPI45CKSELR_SPI5SRC_0)
#define LL_RCC_SPI5_CLKSOURCE_HSI           LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI5SRC, \
                                                         RCC_SPI45CKSELR_SPI5SRC_1)
#define LL_RCC_SPI5_CLKSOURCE_CSI           LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI5SRC, \
                                                         (RCC_SPI45CKSELR_SPI5SRC_1 | RCC_SPI45CKSELR_SPI5SRC_0))
#define LL_RCC_SPI5_CLKSOURCE_HSE           LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI5SRC, \
                                                         RCC_SPI45CKSELR_SPI5SRC_2)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_USARTx_CLKSOURCE  Peripheral USART clock source selection
  * @{
  */
#define LL_RCC_USART1_CLKSOURCE_PCLK6       LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART1SRC, 0U)
#define LL_RCC_USART1_CLKSOURCE_PLL3Q       LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART1SRC, \
                                                         RCC_UART12CKSELR_UART1SRC_0)
#define LL_RCC_USART1_CLKSOURCE_HSI         LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART1SRC, \
                                                         RCC_UART12CKSELR_UART1SRC_1)
#define LL_RCC_USART1_CLKSOURCE_CSI         LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART1SRC, \
                                                         (RCC_UART12CKSELR_UART1SRC_1 | RCC_UART12CKSELR_UART1SRC_0))
#define LL_RCC_USART1_CLKSOURCE_PLL4Q       LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART1SRC, \
                                                         RCC_UART12CKSELR_UART1SRC_2)
#define LL_RCC_USART1_CLKSOURCE_HSE         LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART1SRC, \
                                                         (RCC_UART12CKSELR_UART1SRC_2 | RCC_UART12CKSELR_UART1SRC_0))

#define LL_RCC_USART2_CLKSOURCE_PCLK6       LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART2SRC, 0U)
#define LL_RCC_USART2_CLKSOURCE_PLL3Q       LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART2SRC, \
                                                         RCC_UART12CKSELR_UART2SRC_0)
#define LL_RCC_USART2_CLKSOURCE_HSI         LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART2SRC, \
                                                         RCC_UART12CKSELR_UART2SRC_1)
#define LL_RCC_USART2_CLKSOURCE_CSI         LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART2SRC, \
                                                         (RCC_UART12CKSELR_UART2SRC_1 | RCC_UART12CKSELR_UART2SRC_0))
#define LL_RCC_USART2_CLKSOURCE_PLL4Q       LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART2SRC, \
                                                         RCC_UART12CKSELR_UART2SRC_2)
#define LL_RCC_USART2_CLKSOURCE_HSE         LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART2SRC, \
                                                         (RCC_UART12CKSELR_UART2SRC_2 | RCC_UART12CKSELR_UART2SRC_0))

#define LL_RCC_USART35_CLKSOURCE_PCLK1      LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC, 0U)
#define LL_RCC_USART35_CLKSOURCE_PLL4Q      LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC, \
                                                         RCC_UART35CKSELR_UART35SRC_0)
#define LL_RCC_USART35_CLKSOURCE_HSI        LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC, \
                                                         RCC_UART35CKSELR_UART35SRC_1)
#define LL_RCC_USART35_CLKSOURCE_CSI        LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC, \
                                                         (RCC_UART35CKSELR_UART35SRC_1 | RCC_UART35CKSELR_UART35SRC_0))
#define LL_RCC_USART35_CLKSOURCE_HSE        LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC, \
                                                         RCC_UART35CKSELR_UART35SRC_2)

#define LL_RCC_UART4_CLKSOURCE_PCLK1        LL_CLKSOURCE(RCC_OFFSET_UART4CKSELR, RCC_UART4CKSELR_UART4SRC, 0U)
#define LL_RCC_UART4_CLKSOURCE_PLL4Q        LL_CLKSOURCE(RCC_OFFSET_UART4CKSELR, RCC_UART4CKSELR_UART4SRC, \
                                                         RCC_UART4CKSELR_UART4SRC_0)
#define LL_RCC_UART4_CLKSOURCE_HSI          LL_CLKSOURCE(RCC_OFFSET_UART4CKSELR, RCC_UART4CKSELR_UART4SRC, \
                                                         RCC_UART4CKSELR_UART4SRC_1)
#define LL_RCC_UART4_CLKSOURCE_CSI          LL_CLKSOURCE(RCC_OFFSET_UART4CKSELR, RCC_UART4CKSELR_UART4SRC, \
                                                         (RCC_UART4CKSELR_UART4SRC_1 | RCC_UART4CKSELR_UART4SRC_0))
#define LL_RCC_UART4_CLKSOURCE_HSE          LL_CLKSOURCE(RCC_OFFSET_UART4CKSELR, RCC_UART4CKSELR_UART4SRC, \
                                                         RCC_UART4CKSELR_UART4SRC_2)

#define LL_RCC_USART6_CLKSOURCE_PCLK2       LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC, 0U)
#define LL_RCC_USART6_CLKSOURCE_PLL4Q       LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC, \
                                                         RCC_UART6CKSELR_UART6SRC_0)
#define LL_RCC_USART6_CLKSOURCE_HSI         LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC, \
                                                         RCC_UART6CKSELR_UART6SRC_1)
#define LL_RCC_USART6_CLKSOURCE_CSI         LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC, \
                                                         (RCC_UART6CKSELR_UART6SRC_1 | RCC_UART6CKSELR_UART6SRC_0))
#define LL_RCC_USART6_CLKSOURCE_HSE         LL_CLKSOURCE(RCC_OFFSET_UART6CKSELR, RCC_UART6CKSELR_UART6SRC, \
                                                         RCC_UART6CKSELR_UART6SRC_2)

#define LL_RCC_UART78_CLKSOURCE_PCLK1       LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC, 0U)
#define LL_RCC_UART78_CLKSOURCE_PLL4Q       LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC, \
                                                         RCC_UART78CKSELR_UART78SRC_0)
#define LL_RCC_UART78_CLKSOURCE_HSI         LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC, \
                                                         RCC_UART78CKSELR_UART78SRC_1)
#define LL_RCC_UART78_CLKSOURCE_CSI         LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC, \
                                                         (RCC_UART78CKSELR_UART78SRC_1 | RCC_UART78CKSELR_UART78SRC_0))
#define LL_RCC_UART78_CLKSOURCE_HSE         LL_CLKSOURCE(RCC_OFFSET_UART78CKSELR, RCC_UART78CKSELR_UART78SRC, \
...
/** @defgroup RCC_LL_EC_LPTIMx_CLKSOURCE  Peripheral LPTIM clock source selection
  * @{
  */
#define LL_RCC_LPTIM1_CLKSOURCE_PCLK1       LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC, 0U)
#define LL_RCC_LPTIM1_CLKSOURCE_PLL4P       LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC, \
                                                         RCC_LPTIM1CKSELR_LPTIM1SRC_0)
#define LL_RCC_LPTIM1_CLKSOURCE_PLL3Q       LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC, \
                                                         RCC_LPTIM1CKSELR_LPTIM1SRC_1)
#define LL_RCC_LPTIM1_CLKSOURCE_LSE         LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC, \
                                                         (RCC_LPTIM1CKSELR_LPTIM1SRC_1 | RCC_LPTIM1CKSELR_LPTIM1SRC_0))
#define LL_RCC_LPTIM1_CLKSOURCE_LSI         LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC, \
                                                         RCC_LPTIM1CKSELR_LPTIM1SRC_2)
#define LL_RCC_LPTIM1_CLKSOURCE_PER         LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC, \
                                                         (RCC_LPTIM1CKSELR_LPTIM1SRC_2 | RCC_LPTIM1CKSELR_LPTIM1SRC_0))
#define LL_RCC_LPTIM1_CLKSOURCE_OFF         LL_CLKSOURCE(RCC_OFFSET_LPTIM1CKSELR, RCC_LPTIM1CKSELR_LPTIM1SRC, \
                                                         (RCC_LPTIM1CKSELR_LPTIM1SRC_2 | RCC_LPTIM1CKSELR_LPTIM1SRC_1))

#define LL_RCC_LPTIM2_CLKSOURCE_PCLK3      LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM2SRC, 0U)
#define LL_RCC_LPTIM2_CLKSOURCE_PLL4Q      LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM2SRC, \
                                                        RCC_LPTIM23CKSELR_LPTIM2SRC_0)
#define LL_RCC_LPTIM2_CLKSOURCE_PER        LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM2SRC, \
                                                        RCC_LPTIM23CKSELR_LPTIM2SRC_1)
#define LL_RCC_LPTIM2_CLKSOURCE_LSE        LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM2SRC, \
                                                        (RCC_LPTIM23CKSELR_LPTIM2SRC_1 | RCC_LPTIM23CKSELR_LPTIM2SRC_0))
#define LL_RCC_LPTIM2_CLKSOURCE_LSI        LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM2SRC, \
                                                        RCC_LPTIM23CKSELR_LPTIM2SRC_2)
#define LL_RCC_LPTIM2_CLKSOURCE_OFF        LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM2SRC, \
                                                        (RCC_LPTIM23CKSELR_LPTIM2SRC_2 | RCC_LPTIM23CKSELR_LPTIM2SRC_0))

#define LL_RCC_LPTIM3_CLKSOURCE_PCLK3      LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM3SRC, 0U)
#define LL_RCC_LPTIM3_CLKSOURCE_PLL4Q      LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM3SRC, \
                                                        RCC_LPTIM23CKSELR_LPTIM3SRC_0)
#define LL_RCC_LPTIM3_CLKSOURCE_PER        LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM3SRC, \
                                                        RCC_LPTIM23CKSELR_LPTIM3SRC_1)
#define LL_RCC_LPTIM3_CLKSOURCE_LSE        LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM3SRC, \
                                                        (RCC_LPTIM23CKSELR_LPTIM3SRC_1 | RCC_LPTIM23CKSELR_LPTIM3SRC_0))
#define LL_RCC_LPTIM3_CLKSOURCE_LSI        LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM3SRC, \
                                                        RCC_LPTIM23CKSELR_LPTIM3SRC_2)
#define LL_RCC_LPTIM3_CLKSOURCE_OFF        LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM3SRC, \
                                                        (RCC_LPTIM23CKSELR_LPTIM3SRC_2 | RCC_LPTIM23CKSELR_LPTIM3SRC_0))

#define LL_RCC_LPTIM45_CLKSOURCE_PCLK3      LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC, 0U)
#define LL_RCC_LPTIM45_CLKSOURCE_PLL4P      LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC, \
                                                         RCC_LPTIM45CKSELR_LPTIM45SRC_0)
#define LL_RCC_LPTIM45_CLKSOURCE_PLL3Q      LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC, \
                                                         RCC_LPTIM45CKSELR_LPTIM45SRC_1)
#define LL_RCC_LPTIM45_CLKSOURCE_LSE        LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC, \
                                                         (RCC_LPTIM45CKSELR_LPTIM45SRC_1 | \
                                                          RCC_LPTIM45CKSELR_LPTIM45SRC_0))
#define LL_RCC_LPTIM45_CLKSOURCE_LSI        LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC, \
                                                         RCC_LPTIM45CKSELR_LPTIM45SRC_2)
#define LL_RCC_LPTIM45_CLKSOURCE_PER        LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC, \
                                                         (RCC_LPTIM45CKSELR_LPTIM45SRC_2 | \
                                                          RCC_LPTIM45CKSELR_LPTIM45SRC_0))
#define LL_RCC_LPTIM45_CLKSOURCE_OFF        LL_CLKSOURCE(RCC_OFFSET_LPTIM45CKSELR, RCC_LPTIM45CKSELR_LPTIM45SRC, \
                                                         (RCC_LPTIM45CKSELR_LPTIM45SRC_2 | \
                                                          RCC_LPTIM45CKSELR_LPTIM45SRC_1))
/**
  * @}
...
/** @defgroup RCC_LL_EC_SAIx_CLKSOURCE  Peripheral SAI clock source selection
  * @{
  */
#define LL_RCC_SAI1_CLKSOURCE_PLL4Q         LL_CLKSOURCE(RCC_OFFSET_SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC, 0U)
#define LL_RCC_SAI1_CLKSOURCE_PLL3Q         LL_CLKSOURCE(RCC_OFFSET_SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC, \
                                                         RCC_SAI1CKSELR_SAI1SRC_0)
#define LL_RCC_SAI1_CLKSOURCE_I2SCKIN       LL_CLKSOURCE(RCC_OFFSET_SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC, \
...
#define LL_RCC_SAI1_CLKSOURCE_PLL3R         LL_CLKSOURCE(RCC_OFFSET_SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC, \
                                                         RCC_SAI1CKSELR_SAI1SRC_2)

#define LL_RCC_SAI2_CLKSOURCE_PLL4Q         LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC, 0U)
#define LL_RCC_SAI2_CLKSOURCE_PLL3Q         LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC, \
                                                         RCC_SAI2CKSELR_SAI2SRC_0)
#define LL_RCC_SAI2_CLKSOURCE_I2SCKIN       LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC, \
                                                         RCC_SAI2CKSELR_SAI2SRC_1)
#define LL_RCC_SAI2_CLKSOURCE_PER           LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC, \
                                                         (RCC_SAI2CKSELR_SAI2SRC_1 | RCC_SAI2CKSELR_SAI2SRC_0))
#define LL_RCC_SAI2_CLKSOURCE_SPDIF         LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC, \
                                                         RCC_SAI2CKSELR_SAI2SRC_2)
#define LL_RCC_SAI2_CLKSOURCE_PLL3R         LL_CLKSOURCE(RCC_OFFSET_SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC, \
...
/** @defgroup RCC_LL_EC_FDCAN_CLKSOURCE  Peripheral FDCAN clock source selection
  * @{
  */
#define LL_RCC_FDCAN_CLKSOURCE_HSE          LL_CLKSOURCE(RCC_OFFSET_FDCANCKSELR, RCC_FDCANCKSELR_FDCANSRC, 0U)
#define LL_RCC_FDCAN_CLKSOURCE_PLL3Q        LL_CLKSOURCE(RCC_OFFSET_FDCANCKSELR, RCC_FDCANCKSELR_FDCANSRC, \
                                                         RCC_FDCANCKSELR_FDCANSRC_0)
#define LL_RCC_FDCAN_CLKSOURCE_PLL4Q        LL_CLKSOURCE(RCC_OFFSET_FDCANCKSELR, RCC_FDCANCKSELR_FDCANSRC, \
                                                         RCC_FDCANCKSELR_FDCANSRC_1)
#define LL_RCC_FDCAN_CLKSOURCE_PLL4R        LL_CLKSOURCE(RCC_OFFSET_FDCANCKSELR, RCC_FDCANCKSELR_FDCANSRC, \
...
/** @defgroup RCC_LL_EC_SPDIFRX_CLKSOURCE  Peripheral SPDIFRX clock source selection
  * @{
  */
#define LL_RCC_SPDIFRX_CLKSOURCE_PLL4P      LL_CLKSOURCE(RCC_OFFSET_SPDIFCKSELR, RCC_SPDIFCKSELR_SPDIFSRC, 0U)
#define LL_RCC_SPDIFRX_CLKSOURCE_PLL3Q      LL_CLKSOURCE(RCC_OFFSET_SPDIFCKSELR, RCC_SPDIFCKSELR_SPDIFSRC, \
                                                         RCC_SPDIFCKSELR_SPDIFSRC_0)
#define LL_RCC_SPDIFRX_CLKSOURCE_HSI        LL_CLKSOURCE(RCC_OFFSET_SPDIFCKSELR, RCC_SPDIFCKSELR_SPDIFSRC, \
                                                         RCC_SPDIFCKSELR_SPDIFSRC_1)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_ADC_CLKSOURCE  Peripheral ADC clock source selection
  * @{
  */
#define LL_RCC_ADC1_CLKSOURCE_PLL4R         LL_CLKSOURCE(RCC_OFFSET_ADC12CKSELR, RCC_ADC12CKSELR_ADC1SRC, 0U)
#define LL_RCC_ADC1_CLKSOURCE_PER           LL_CLKSOURCE(RCC_OFFSET_ADC12CKSELR, RCC_ADC12CKSELR_ADC1SRC, \
                                                         RCC_ADC12CKSELR_ADC1SRC_0)
#define LL_RCC_ADC1_CLKSOURCE_PLL3Q         LL_CLKSOURCE(RCC_OFFSET_ADC12CKSELR, RCC_ADC12CKSELR_ADC1SRC, \
                                                         RCC_ADC12CKSELR_ADC1SRC_1)
#define LL_RCC_ADC2_CLKSOURCE_PLL4R         LL_CLKSOURCE(RCC_OFFSET_ADC12CKSELR, RCC_ADC12CKSELR_ADC2SRC, 0U)
#define LL_RCC_ADC2_CLKSOURCE_PER           LL_CLKSOURCE(RCC_OFFSET_ADC12CKSELR, RCC_ADC12CKSELR_ADC2SRC, \
                                                         RCC_ADC12CKSELR_ADC2SRC_0)
#define LL_RCC_ADC2_CLKSOURCE_PLL3Q         LL_CLKSOURCE(RCC_OFFSET_ADC12CKSELR, RCC_ADC12CKSELR_ADC2SRC, \
                                                         RCC_ADC12CKSELR_ADC2SRC_1)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_SDMMCx_CLKSOURCE  Peripheral SDMMC clock source selection
  * @{
  */
#define LL_RCC_SDMMC1_CLKSOURCE_HCLK6       LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC1SRC, 0U)
#define LL_RCC_SDMMC1_CLKSOURCE_PLL3R       LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC1SRC, \
                                                         RCC_SDMMC12CKSELR_SDMMC1SRC_0)
#define LL_RCC_SDMMC1_CLKSOURCE_PLL4P       LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC1SRC, \
                                                         RCC_SDMMC12CKSELR_SDMMC1SRC_1)
#define LL_RCC_SDMMC1_CLKSOURCE_HSI         LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC1SRC, \
                                                         (RCC_SDMMC12CKSELR_SDMMC1SRC_1 | \
                                                          RCC_SDMMC12CKSELR_SDMMC1SRC_0))

#define LL_RCC_SDMMC2_CLKSOURCE_HCLK6       LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC2SRC, 0U)
#define LL_RCC_SDMMC2_CLKSOURCE_PLL3R       LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC2SRC, \
                                                         RCC_SDMMC12CKSELR_SDMMC2SRC_0)
#define LL_RCC_SDMMC2_CLKSOURCE_PLL4P       LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC2SRC, \
                                                         RCC_SDMMC12CKSELR_SDMMC2SRC_1)
#define LL_RCC_SDMMC2_CLKSOURCE_HSI         LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC2SRC, \
                                                         (RCC_SDMMC12CKSELR_SDMMC2SRC_1 | \
                                                          RCC_SDMMC12CKSELR_SDMMC2SRC_0))
/**
  * @}
...
/** @defgroup RCC_LL_EC_ETH_CLKSOURCE  Peripheral ETH clock source selection
  * @{
  */
#define LL_RCC_ETH1_CLKSOURCE_PLL4P         LL_CLKSOURCE(RCC_OFFSET_ETH12CKSELR, RCC_ETH12CKSELR_ETH1SRC, 0U)
#define LL_RCC_ETH1_CLKSOURCE_PLL3Q         LL_CLKSOURCE(RCC_OFFSET_ETH12CKSELR, RCC_ETH12CKSELR_ETH1SRC, \
                                                         RCC_ETH12CKSELR_ETH1SRC_0)
#define LL_RCC_ETH1_CLKSOURCE_OFF           LL_CLKSOURCE(RCC_OFFSET_ETH12CKSELR, RCC_ETH12CKSELR_ETH1SRC, \
                                                         RCC_ETH12CKSELR_ETH1SRC_1)
#define LL_RCC_ETH2_CLKSOURCE_PLL4P         LL_CLKSOURCE(RCC_OFFSET_ETH12CKSELR, RCC_ETH12CKSELR_ETH2SRC, 0U)
#define LL_RCC_ETH2_CLKSOURCE_PLL3Q         LL_CLKSOURCE(RCC_OFFSET_ETH12CKSELR, RCC_ETH12CKSELR_ETH2SRC, \
                                                         RCC_ETH12CKSELR_ETH2SRC_0)
#define LL_RCC_ETH2_CLKSOURCE_OFF           LL_CLKSOURCE(RCC_OFFSET_ETH12CKSELR, RCC_ETH12CKSELR_ETH2SRC, \
                                                         RCC_ETH12CKSELR_ETH2SRC_1)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_USBPHY_CLKSOURCE  Peripheral USBPHY clock source selection
  * @{
  */
#define LL_RCC_USBPHY_CLKSOURCE_HSE         LL_CLKSOURCE(RCC_OFFSET_USBCKSELR, RCC_USBCKSELR_USBPHYSRC, 0U)
#define LL_RCC_USBPHY_CLKSOURCE_PLL4R       LL_CLKSOURCE(RCC_OFFSET_USBCKSELR, RCC_USBCKSELR_USBPHYSRC, \
                                                         RCC_USBCKSELR_USBPHYSRC_0)
#define LL_RCC_USBPHY_CLKSOURCE_HSE2        LL_CLKSOURCE(RCC_OFFSET_USBCKSELR, RCC_USBCKSELR_USBPHYSRC, \
                                                         RCC_USBCKSELR_USBPHYSRC_1)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_USBO_CLKSOURCE  Peripheral USBO clock source selection
  * @{
  */
#define LL_RCC_USBO_CLKSOURCE_PLL4R         LL_CLKSOURCE(RCC_OFFSET_USBCKSELR, RCC_USBCKSELR_USBOSRC, 0U)
#define LL_RCC_USBO_CLKSOURCE_PHY           LL_CLKSOURCE(RCC_OFFSET_USBCKSELR, RCC_USBCKSELR_USBOSRC, \
                                                         RCC_USBCKSELR_USBOSRC)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_QSPI_CLKSOURCE  Peripheral QSPI clock source selection
  * @{
  */
#define LL_RCC_QSPI_CLKSOURCE_ACLK          LL_CLKSOURCE(RCC_OFFSET_QSPICKSELR, RCC_QSPICKSELR_QSPISRC, 0U)
#define LL_RCC_QSPI_CLKSOURCE_PLL3R         LL_CLKSOURCE(RCC_OFFSET_QSPICKSELR, RCC_QSPICKSELR_QSPISRC, \
                                                         RCC_QSPICKSELR_QSPISRC_0)
#define LL_RCC_QSPI_CLKSOURCE_PLL4P         LL_CLKSOURCE(RCC_OFFSET_QSPICKSELR, RCC_QSPICKSELR_QSPISRC, \
                                                         RCC_QSPICKSELR_QSPISRC_1)
#define LL_RCC_QSPI_CLKSOURCE_PER           LL_CLKSOURCE(RCC_OFFSET_QSPICKSELR, RCC_QSPICKSELR_QSPISRC, \
                                                         (RCC_QSPICKSELR_QSPISRC_1 | RCC_QSPICKSELR_QSPISRC_0))
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_FMC_CLKSOURCE  Peripheral FMC clock source selection
  * @{
  */
#define LL_RCC_FMC_CLKSOURCE_ACLK           LL_CLKSOURCE(RCC_OFFSET_FMCCKSELR, RCC_FMCCKSELR_FMCSRC, 0U)
#define LL_RCC_FMC_CLKSOURCE_PLL3R          LL_CLKSOURCE(RCC_OFFSET_FMCCKSELR, RCC_FMCCKSELR_FMCSRC,\
                                                         RCC_FMCCKSELR_FMCSRC_0)
#define LL_RCC_FMC_CLKSOURCE_PLL4P          LL_CLKSOURCE(RCC_OFFSET_FMCCKSELR, RCC_FMCCKSELR_FMCSRC, \
                                                         RCC_FMCCKSELR_FMCSRC_1)
#define LL_RCC_FMC_CLKSOURCE_PER            LL_CLKSOURCE(RCC_OFFSET_FMCCKSELR, RCC_FMCCKSELR_FMCSRC, \
                                                         (RCC_FMCCKSELR_FMCSRC_1 | RCC_FMCCKSELR_FMCSRC_0))
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_RNGx_CLKSOURCE  Peripheral RNG clock source selection
  * @{
  */
#define LL_RCC_RNG1_CLKSOURCE_CSI           LL_CLKSOURCE(RCC_OFFSET_RNG1CKSELR, RCC_RNG1CKSELR_RNG1SRC, 0U)
#define LL_RCC_RNG1_CLKSOURCE_PLL4R         LL_CLKSOURCE(RCC_OFFSET_RNG1CKSELR, RCC_RNG1CKSELR_RNG1SRC, \
                                                         RCC_RNG1CKSELR_RNG1SRC_0)
#define LL_RCC_RNG1_CLKSOURCE_LSI           LL_CLKSOURCE(RCC_OFFSET_RNG1CKSELR, RCC_RNG1CKSELR_RNG1SRC, \
...
/** @defgroup RCC_LL_EC_STGEN_CLKSOURCE  Peripheral STGEN clock source selection
  * @{
  */
#define LL_RCC_STGEN_CLKSOURCE_HSI          LL_CLKSOURCE(RCC_OFFSET_STGENCKSELR, RCC_STGENCKSELR_STGENSRC, 0U)
#define LL_RCC_STGEN_CLKSOURCE_HSE          LL_CLKSOURCE(RCC_OFFSET_STGENCKSELR, RCC_STGENCKSELR_STGENSRC, \
                                                         RCC_STGENCKSELR_STGENSRC_0)
#define LL_RCC_STGEN_CLKSOURCE_OFF          LL_CLKSOURCE(RCC_OFFSET_STGENCKSELR, RCC_STGENCKSELR_STGENSRC, \
                                                         RCC_STGENCKSELR_STGENSRC_1)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_DCMIPP_CLKSOURCE  Peripheral DCMIPP clock source selection
  * @{
  */
#define LL_RCC_DCMIPP_CLKSOURCE_ACLK       LL_CLKSOURCE(RCC_OFFSET_DCMIPPCKSELR,  RCC_DCMIPPCKSELR_DCMIPPSRC, 0U)
#define LL_RCC_DCMIPP_CLKSOURCE_PLL2Q      LL_CLKSOURCE(RCC_OFFSET_DCMIPPCKSELR,  RCC_DCMIPPCKSELR_DCMIPPSRC, \
                                                        RCC_DCMIPPCKSELR_DCMIPPSRC_0)
#define LL_RCC_DCMIPP_CLKSOURCE_PLL4P      LL_CLKSOURCE(RCC_OFFSET_DCMIPPCKSELR,  RCC_DCMIPPCKSELR_DCMIPPSRC, \
                                                        RCC_DCMIPPCKSELR_DCMIPPSRC_1)
#define LL_RCC_DCMIPP_CLKSOURCE_PER        LL_CLKSOURCE(RCC_OFFSET_DCMIPPCKSELR,  RCC_DCMIPPCKSELR_DCMIPPSRC, \
                                                        (RCC_DCMIPPCKSELR_DCMIPPSRC_1 | RCC_DCMIPPCKSELR_DCMIPPSRC_0))
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_SAES_CLKSOURCE  Peripheral SAES clock source selection
  * @{
  */
#define LL_RCC_SAES_CLKSOURCE_ACLK         LL_CLKSOURCE(RCC_OFFSET_SAESCKSELR,  RCC_SAESCKSELR_SAESSRC, 0U)
#define LL_RCC_SAES_CLKSOURCE_PER          LL_CLKSOURCE(RCC_OFFSET_SAESCKSELR,  RCC_SAESCKSELR_SAESSRC, \
                                                        RCC_SAESCKSELR_SAESSRC_0)
#define LL_RCC_SAES_CLKSOURCE_PLL4R        LL_CLKSOURCE(RCC_OFFSET_SAESCKSELR,  RCC_SAESCKSELR_SAESSRC, \
                                                        RCC_SAESCKSELR_SAESSRC_1)
#define LL_RCC_SAES_CLKSOURCE_LSI          LL_CLKSOURCE(RCC_OFFSET_SAESCKSELR,  RCC_SAESCKSELR_SAESSRC, \
                                                        (RCC_SAESCKSELR_SAESSRC_1 | RCC_SAESCKSELR_SAESSRC_0))
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_CKPER_CLKSOURCE  Peripheral CKPER clock source selection
  * @{
  */
#define LL_RCC_CKPER_CLKSOURCE_HSI          LL_CLKSOURCE(RCC_OFFSET_CKPERCKSELR, RCC_CPERCKSELR_CKPERSRC, 0U)
#define LL_RCC_CKPER_CLKSOURCE_CSI          LL_CLKSOURCE(RCC_OFFSET_CKPERCKSELR, RCC_CPERCKSELR_CKPERSRC, \
                                                         RCC_CPERCKSELR_CKPERSRC_0)
#define LL_RCC_CKPER_CLKSOURCE_HSE          LL_CLKSOURCE(RCC_OFFSET_CKPERCKSELR, RCC_CPERCKSELR_CKPERSRC, \
                                                         RCC_CPERCKSELR_CKPERSRC_1)
#define LL_RCC_CKPER_CLKSOURCE_OFF          LL_CLKSOURCE(RCC_OFFSET_CKPERCKSELR, RCC_CPERCKSELR_CKPERSRC, \
                                                         (RCC_CPERCKSELR_CKPERSRC_1 | RCC_CPERCKSELR_CKPERSRC_0))
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_TIMGx_Prescaler_Selection TIMG Prescaler selection
  * @{
  */
#define LL_RCC_TIMG1PRES_DEACTIVATED        LL_CLKSOURCE(RCC_OFFSET_TIMG1PRER, RCC_TIMG1PRER_TIMG1PRE, 0U)
#define LL_RCC_TIMG1PRES_ACTIVATED          LL_CLKSOURCE(RCC_OFFSET_TIMG1PRER, RCC_TIMG1PRER_TIMG1PRE, \
                                                         RCC_TIMG1PRER_TIMG1PRE)

#define LL_RCC_TIMG2PRES_DEACTIVATED        LL_CLKSOURCE(RCC_OFFSET_TIMG2PRER, RCC_TIMG2PRER_TIMG2PRE, 0U)
#define LL_RCC_TIMG2PRES_ACTIVATED          LL_CLKSOURCE(RCC_OFFSET_TIMG2PRER, RCC_TIMG2PRER_TIMG2PRE, \
                                                         RCC_TIMG2PRER_TIMG2PRE)

#define LL_RCC_TIMG3PRES_DEACTIVATED        LL_CLKSOURCE(RCC_OFFSET_TIMG3PRER, RCC_TIMG3PRER_TIMG3PRE, 0U)
#define LL_RCC_TIMG3PRES_ACTIVATED          LL_CLKSOURCE(RCC_OFFSET_TIMG3PRER, RCC_TIMG3PRER_TIMG3PRE, \
                                                         RCC_TIMG3PRER_TIMG3PRE)
/**
  * @}
  */
...
#define LL_RCC_I2C3_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C3SRC, 0x00000000U)
#define LL_RCC_I2C4_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C4SRC, 0x00000000U)
#define LL_RCC_I2C5_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_I2C345CKSELR, RCC_I2C345CKSELR_I2C5SRC, 0x00000000U)
/**
  * @}
  */
...
#define LL_RCC_SPI4_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI4SRC, 0x00000000U)
#define LL_RCC_SPI5_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_SPI45CKSELR, RCC_SPI45CKSELR_SPI5SRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_USARTx  Peripheral USART get clock source
  * @{
  */
#define LL_RCC_USART1_CLKSOURCE       LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART1SRC, 0x00000000U)
#define LL_RCC_USART2_CLKSOURCE       LL_CLKSOURCE(RCC_OFFSET_UART12CKSELR, RCC_UART12CKSELR_UART2SRC, 0x00000000U)
#define LL_RCC_USART35_CLKSOURCE      LL_CLKSOURCE(RCC_OFFSET_UART35CKSELR, RCC_UART35CKSELR_UART35SRC, 0x00000000U)
#define LL_RCC_UART4_CLKSOURCE        LL_CLKSOURCE(RCC_OFFSET_UART4CKSELR, RCC_UART4CKSELR_UART4SRC, 0x00000000U)
...
#define LL_RCC_LPTIM2_CLKSOURCE       LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM2SRC, 0x00000000U)
#define LL_RCC_LPTIM3_CLKSOURCE       LL_CLKSOURCE(RCC_OFFSET_LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM3SRC, 0x00000000U)
...
/** @defgroup RCC_LL_EC_FDCAN  Peripheral FDCAN get clock source
  * @{
  */
#define LL_RCC_FDCAN_CLKSOURCE        LL_CLKSOURCE(RCC_OFFSET_FDCANCKSELR, RCC_FDCANCKSELR_FDCANSRC, 0x00000000U)
/**
  * @}
  */
#endif /*FDCAN1*/
...
/** @defgroup RCC_LL_EC_SPDIFRX  Peripheral SPDIFRX get clock source
  * @{
  */
#define LL_RCC_SPDIFRX_CLKSOURCE      LL_CLKSOURCE(RCC_OFFSET_SPDIFCKSELR, RCC_SPDIFCKSELR_SPDIFSRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_ADC Peripheral ADC get clock source
  * @{
  */
#define LL_RCC_ADC1_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_ADC12CKSELR, RCC_ADC12CKSELR_ADC1SRC, 0x00000000U)
#define LL_RCC_ADC2_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_ADC12CKSELR, RCC_ADC12CKSELR_ADC2SRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_SDMMCx  Peripheral SDMMC get clock source
  * @{
  */
#define LL_RCC_SDMMC1_CLKSOURCE       LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC1SRC, 0x00000000U)
#define LL_RCC_SDMMC2_CLKSOURCE       LL_CLKSOURCE(RCC_OFFSET_SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC2SRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_ETH  Peripheral ETH get clock source
  * @{
  */
#define LL_RCC_ETH1_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_ETH12CKSELR, RCC_ETH12CKSELR_ETH1SRC, 0x00000000U)
#define LL_RCC_ETH2_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_ETH12CKSELR, RCC_ETH12CKSELR_ETH2SRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_USBPHY Peripheral USBPHY get clock source
  * @{
  */
#define LL_RCC_USBPHY_CLKSOURCE       LL_CLKSOURCE(RCC_OFFSET_USBCKSELR, RCC_USBCKSELR_USBPHYSRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_USBO  Peripheral USBO get clock source
  * @{
  */
#define LL_RCC_USBO_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_USBCKSELR, RCC_USBCKSELR_USBOSRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_QSPI  Peripheral QSPI get clock source
  * @{
  */
#define LL_RCC_QSPI_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_QSPICKSELR, RCC_QSPICKSELR_QSPISRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_FMC  Peripheral FMC get clock source
  * @{
  */
#define LL_RCC_FMC_CLKSOURCE          LL_CLKSOURCE(RCC_OFFSET_FMCCKSELR, RCC_FMCCKSELR_FMCSRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_STGEN Peripheral STGEN get clock source
  * @{
  */
#define LL_RCC_STGEN_CLKSOURCE        LL_CLKSOURCE(RCC_OFFSET_STGENCKSELR, RCC_STGENCKSELR_STGENSRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_SAES Peripheral SAES get clock source
  * @{
  */
#define LL_RCC_DCMIPP_CLKSOURCE       LL_CLKSOURCE(RCC_OFFSET_DCMIPPCKSELR,  RCC_DCMIPPCKSELR_DCMIPPSRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_SAES Peripheral SAES get clock source
  * @{
  */
#define LL_RCC_SAES_CLKSOURCE         LL_CLKSOURCE(RCC_OFFSET_SAESCKSELR,  RCC_SAESCKSELR_SAESSRC, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_CKPER Peripheral CKPER get clock source
  * @{
  */
#define LL_RCC_CKPER_CLKSOURCE        LL_CLKSOURCE(RCC_OFFSET_CKPERCKSELR, RCC_CPERCKSELR_CKPERSRC, 0x00000000U)
/**
  * @}
  */
...
#define LL_RCC_TIMG3PRES              LL_CLKSOURCE(RCC_OFFSET_TIMG3PRER, RCC_TIMG3PRER_TIMG3PRE, 0x00000000U)
/**
  * @}
  */
...
/** @defgroup RCC_LL_PLL3_IF_Range RCC PLL3 Input Frequency Range
  * @{
  */
#define LL_RCC_PLL3IFRANGE_0          0U                    /*!< The PLL3 input (ref3_ck) clock range frequency
                                                                 is between 4 and 8 MHz (default after reset) */
#define LL_RCC_PLL3IFRANGE_1          RCC_PLL3CFGR1_IFRGE_0 /*!< The PLL3 input (ref3_ck) clock range frequency
...
/** @defgroup RCC_LL_PLL4_IF_Range RCC PLL4 Input Frequency Range
  * @{
  */
#define LL_RCC_PLL4IFRANGE_0          0U                     /*!< The PLL4 input (ref4_ck) clock range frequency
                                                                 is between 4 and 8 MHz (default after reset) */
#define LL_RCC_PLL4IFRANGE_1          RCC_PLL4CFGR1_IFRGE_0 /*!< The PLL4 input (ref4_ck) clock range frequency
                                                                 is between 8 and 16 MHz */
/**
  * @}
  */
...
/**
  ...
  */
#define LL_RCC_CALC_ACLK_FREQ(__ACLKINPUTCLKFREQ__, __AXIPRESCALER__) ((__ACLKINPUTCLKFREQ__) / ((__AXIPRESCALER__)\
                                                                       + 1U))

/**
  * @brief  Helper macro to calculate the MLHCLK, FCLK, HCLK4, HCLK2 and HCLK1 frequencies
  * @param  __MLHCLKINPUTCLKFREQ__ Frequency of the input of mlhclk_ck (based on HSI/HSE/CSI/PLL3P)
  * @param  __MLAHBPRESCALER__ This parameter can be one of the following values:
  *         @arg @ref LL_RCC_MLAHB_DIV_1
  *         @arg @ref LL_RCC_MLAHB_DIV_2
  *         @arg @ref LL_RCC_MLAHB_DIV_4
  *         @arg @ref LL_RCC_MLAHB_DIV_8
  *         @arg @ref LL_RCC_MLAHB_DIV_16
  *         @arg @ref LL_RCC_MLAHB_DIV_32
  *         @arg @ref LL_RCC_MLAHB_DIV_64
  *         @arg @ref LL_RCC_MLAHB_DIV_128
  *         @arg @ref LL_RCC_MLAHB_DIV_256
  *         @arg @ref LL_RCC_MLAHB_DIV_512
  * @retval MLHCLK clock frequency (in Hz)
  */
#define LL_RCC_CALC_MLHCLK_FREQ(__MLHCLKINPUTCLKFREQ__, __MLAHBPRESCALER__) \
  ((__MLHCLKINPUTCLKFREQ__) >> (__MLAHBPRESCALER__))
...
/**
  * @brief  Helper macro to calculate the PCLK6 frequency (APB6)
  * @param  __ACLKFREQ__ ACLK frequency
  * @param  __APB6PRESCALER__ This parameter can be one of the following values:
  *         @arg @ref LL_RCC_APB6_DIV_1
  *         @arg @ref LL_RCC_APB6_DIV_2
  *         @arg @ref LL_RCC_APB6_DIV_4
  *         @arg @ref LL_RCC_APB6_DIV_8
  *         @arg @ref LL_RCC_APB6_DIV_16
  * @retval PCLK6 clock frequency (in Hz)
  */
#define LL_RCC_CALC_PCLK6_FREQ(__ACLKFREQ__, __APB6PRESCALER__) ((__ACLKFREQ__) >> (__APB6PRESCALER__))
...
/**
  * @brief  Configure the mlahbs clock source
  * @rmtoll MSSCKSELR         MLAHBSRC            LL_RCC_SetMLAHBClkSource
  * @param  Source This parameter can be one of the following values:
  *         @arg @ref LL_RCC_MLAHBS_CLKSOURCE_HSI
  *         @arg @ref LL_RCC_MLAHBS_CLKSOURCE_HSE
  *         @arg @ref LL_RCC_MLAHBS_CLKSOURCE_CSI
  *         @arg @ref LL_RCC_MLAHBS_CLKSOURCE_PLL3
  * @retval None
  */
__STATIC_INLINE void LL_RCC_SetMLAHBSClkSource(uint32_t Source)
{
  MODIFY_REG(RCC->MSSCKSELR, (RCC_MSSCKSELR_MLAHBSSRC), Source);
}
...
/**
  * @brief  Set the MLHCLK (MLHCLK, MLAHB, FCLK, HCLK4, HCLK2 and HCLK1) prescaler
  * @rmtoll MLAHBDIVR         MLAHBDIV            LL_RCC_SetMLHCLKPrescaler
  * @param  Prescaler This parameter can be one of the following values:
  *         @arg @ref LL_RCC_MLAHB_DIV_1
  *         @arg @ref LL_RCC_MLAHB_DIV_2
  *         @arg @ref LL_RCC_MLAHB_DIV_4
...
{
  MODIFY_REG(RCC->MLAHBDIVR, RCC_MLAHBDIVR_MLAHBDIV, Prescaler);
}
...
/**
  * @brief  Set the APB6 prescaler
  * @rmtoll APB6DIVR         APB6            LL_RCC_SetAPB6Prescaler
  * @param  Prescaler This parameter can be one of the following values:
  *         @arg @ref LL_RCC_APB6_DIV_1
  *         @arg @ref LL_RCC_APB6_DIV_2
  *         @arg @ref LL_RCC_APB6_DIV_4
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RCC_SetAPB6Prescaler(uint32_t Prescaler)
{
  MODIFY_REG(RCC->APB6DIVR, RCC_APB6DIVR_APB6DIV, Prescaler);
}
...
/**
  ...
  * @rmtoll MSSCKSELR         MLAHBSRC           LL_RCC_GetMLAHBClkSource
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_RCC_MLAHBS_CLKSOURCE_HSI
  *         @arg @ref LL_RCC_MLAHBS_CLKSOURCE_HSE
  *         @arg @ref LL_RCC_MLAHBS_CLKSOURCE_CSI
  *         @arg @ref LL_RCC_MLAHBS_CLKSOURCE_PLL3
  */
__STATIC_INLINE uint32_t LL_RCC_GetMLAHBSClkSource(void)
{
  return (uint32_t)(READ_BIT(RCC->MSSCKSELR, RCC_MSSCKSELR_MLAHBSSRC));
}
...
/** @brief  Get the MLHCLK (MLHCLK, MLAHB, FCLK, HCLK4, HCLK2 and HCLK1) prescaler
  * @rmtoll MLAHBDIVR         MLAHBDIV           LL_RCC_GetMLHCLKPrescaler
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_RCC_MLAHB_DIV_1
  *         @arg @ref LL_RCC_MLAHB_DIV_2
  *         @arg @ref LL_RCC_MLAHB_DIV_4
...
{
  return (uint32_t)(READ_BIT(RCC->MLAHBDIVR, RCC_MLAHBDIVR_MLAHBDIV));
}
...
/**
  * @brief  Get the APB6 prescaler
  * @rmtoll APB6DIVR         APB6           LL_RCC_GetAPB6Prescaler
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_RCC_APB6_DIV_1
  *         @arg @ref LL_RCC_APB6_DIV_2
  *         @arg @ref LL_RCC_APB6_DIV_4
  ...
  *         @arg @ref LL_RCC_APB6_DIV_16
  */
__STATIC_INLINE uint32_t LL_RCC_GetAPB6Prescaler(void)
{
  return (uint32_t)(READ_BIT(RCC->APB6DIVR, RCC_APB6DIVR_APB6DIV));
}
...
/**
  ...
  * @rmtoll MCO1CFGR           *     LL_RCC_SetClockSource\n
  *         MCO2CFGR           *     LL_RCC_SetClockSource\n
  *         CKPERCKSELR        *     LL_RCC_SetClockSource\n
  *         TIMG1PRER          *     LL_RCC_SetClockSource\n
  *         TIMG2PRER          *     LL_RCC_SetClockSource\n
  *         TIMG3PRER          *     LL_RCC_SetClockSource\n
  ...
  *         USART12CKSELR      *     LL_RCC_SetClockSource\n
  *         USART35CKSELR      *     LL_RCC_SetClockSource\n
  *         UART4CKSELR        *     LL_RCC_SetClockSource\n
  ...
  *         FDCANCKSELR        *     LL_RCC_SetClockSource\n
  *         SPDIFCKSELR        *     LL_RCC_SetClockSource\n
  *         ADC12CKSELR        *     LL_RCC_SetClockSource\n
  *         SDMMC12CKSELR      *     LL_RCC_SetClockSource\n
  *         ETH12CKSELR        *     LL_RCC_SetClockSource\n
  *         USBCKSELR          *     LL_RCC_SetClockSource\n
  *         QSPICKSELR         *     LL_RCC_SetClockSource\n
  *         FMCCKSELR          *     LL_RCC_SetClockSource\n
  *         RNG1CKSELR         *     LL_RCC_SetClockSource\n
  *         STGENCKSELR        *     LL_RCC_SetClockSource\n
  *         DCMIPPCKSELR       *     LL_RCC_SetClockSource\n
  *         SAESCKSELR         *     LL_RCC_SetClockSource\n
  ...
  *         @arg @ref LL_RCC_MCO2SOURCE_MLAHB
  ...
  *         @arg @ref LL_RCC_TIMG3PRES_DEACTIVATED
  *         @arg @ref LL_RCC_TIMG3PRES_ACTIVATED
  ...
  *         @arg @ref LL_RCC_I2C3_CLKSOURCE_PCLK6
  *         @arg @ref LL_RCC_I2C3_CLKSOURCE_PLL4R
  *         @arg @ref LL_RCC_I2C3_CLKSOURCE_HSI
  *         @arg @ref LL_RCC_I2C3_CLKSOURCE_CSI
  *         @arg @ref LL_RCC_I2C4_CLKSOURCE_PCLK6
  *         @arg @ref LL_RCC_I2C4_CLKSOURCE_PLL4R
  *         @arg @ref LL_RCC_I2C4_CLKSOURCE_HSI
  *         @arg @ref LL_RCC_I2C4_CLKSOURCE_CSI
  *         @arg @ref LL_RCC_I2C5_CLKSOURCE_PCLK6
  *         @arg @ref LL_RCC_I2C5_CLKSOURCE_PLL4R
  *         @arg @ref LL_RCC_I2C5_CLKSOURCE_HSI
  *         @arg @ref LL_RCC_I2C5_CLKSOURCE_CSI
  ...
  *         @arg @ref LL_RCC_USART2_CLKSOURCE_PCLK6
  *         @arg @ref LL_RCC_USART2_CLKSOURCE_PLL3Q
  *         @arg @ref LL_RCC_USART2_CLKSOURCE_HSI
  *         @arg @ref LL_RCC_USART2_CLKSOURCE_CSI
  *         @arg @ref LL_RCC_USART2_CLKSOURCE_PLL4Q
  *         @arg @ref LL_RCC_USART2_CLKSOURCE_HSE
  *         @arg @ref LL_RCC_USART35_CLKSOURCE_PCLK1
  *         @arg @ref LL_RCC_USART35_CLKSOURCE_PLL4Q
  *         @arg @ref LL_RCC_USART35_CLKSOURCE_HSI
  *         @arg @ref LL_RCC_USART35_CLKSOURCE_CSI
  *         @arg @ref LL_RCC_USART35_CLKSOURCE_HSE
  *         @arg @ref LL_RCC_UART4_CLKSOURCE_PCLK1
  *         @arg @ref LL_RCC_UART4_CLKSOURCE_PLL4Q
  *         @arg @ref LL_RCC_UART4_CLKSOURCE_HSI
  *         @arg @ref LL_RCC_UART4_CLKSOURCE_CSI
  *         @arg @ref LL_RCC_UART4_CLKSOURCE_HSE
  ...
  *         @arg @ref LL_RCC_LPTIM2_CLKSOURCE_PCLK3
  *         @arg @ref LL_RCC_LPTIM2_CLKSOURCE_PLL4Q
  *         @arg @ref LL_RCC_LPTIM2_CLKSOURCE_PER
  *         @arg @ref LL_RCC_LPTIM2_CLKSOURCE_LSE
  *         @arg @ref LL_RCC_LPTIM2_CLKSOURCE_LSI
  *         @arg @ref LL_RCC_LPTIM3_CLKSOURCE_PCLK3
  *         @arg @ref LL_RCC_LPTIM3_CLKSOURCE_PLL4Q
  *         @arg @ref LL_RCC_LPTIM3_CLKSOURCE_PER
  ...
  *         @arg @ref LL_RCC_ADC1_CLKSOURCE_PLL4R
  *         @arg @ref LL_RCC_ADC1_CLKSOURCE_PER
  *         @arg @ref LL_RCC_ADC1_CLKSOURCE_PLL3Q
  *         @arg @ref LL_RCC_ADC2_CLKSOURCE_PLL4R
  *         @arg @ref LL_RCC_ADC2_CLKSOURCE_PER
  *         @arg @ref LL_RCC_ADC2_CLKSOURCE_PLL3Q
  *         @arg @ref LL_RCC_SDMMC1_CLKSOURCE_HCLK6
  *         @arg @ref LL_RCC_SDMMC1_CLKSOURCE_PLL3R
  *         @arg @ref LL_RCC_SDMMC1_CLKSOURCE_PLL4P
  *         @arg @ref LL_RCC_SDMMC1_CLKSOURCE_HSI
  *         @arg @ref LL_RCC_SDMMC2_CLKSOURCE_HCLK6
  *         @arg @ref LL_RCC_SDMMC2_CLKSOURCE_PLL3R
  *         @arg @ref LL_RCC_SDMMC2_CLKSOURCE_PLL4P
  *         @arg @ref LL_RCC_SDMMC2_CLKSOURCE_HSI
  *         @arg @ref LL_RCC_ETH1_CLKSOURCE_PLL4P
  *         @arg @ref LL_RCC_ETH1_CLKSOURCE_PLL3Q
  *         @arg @ref LL_RCC_ETH1_CLKSOURCE_OFF
  *         @arg @ref LL_RCC_ETH2_CLKSOURCE_PLL4P
  *         @arg @ref LL_RCC_ETH2_CLKSOURCE_PLL3Q
  *         @arg @ref LL_RCC_ETH2_CLKSOURCE_OFF
  ...
  *         @arg @ref LL_RCC_DCMIPP_CLKSOURCE_ACLK
  *         @arg @ref LL_RCC_DCMIPP_CLKSOURCE_PLL2Q
  *         @arg @ref LL_RCC_DCMIPP_CLKSOURCE_PLL4P
  *         @arg @ref LL_RCC_DCMIPP_CLKSOURCE_PER
  *         @arg @ref LL_RCC_SAES_CLKSOURCE_ACLK
  *         @arg @ref LL_RCC_SAES_CLKSOURCE_PER
  *         @arg @ref LL_RCC_SAES_CLKSOURCE_PLL4R
  *         @arg @ref LL_RCC_SAES_CLKSOURCE_LSI
  * @retval None
  */
__STATIC_INLINE void LL_RCC_SetClockSource(uint32_t ClkSource)
{
  __IO uint32_t *pReg = (__IO uint32_t *)((uint32_t)&RCC->MCO1CFGR + LL_CLKSOURCE_REG(ClkSource));
...
/**
  ...
  *         I2C345CKSELR       I2C3SRC      LL_RCC_SetI2CClockSource
  *         I2C345CKSELR       I2C4SRC      LL_RCC_SetI2CClockSource
  *         I2C345CKSELR       I2C5SRC      LL_RCC_SetI2CClockSource
  * @param  ClkSource This parameter can be one of the following values:
  *         @arg @ref LL_RCC_I2C12_CLKSOURCE_PCLK1
  *         @arg @ref LL_RCC_I2C12_CLKSOURCE_PLL4R
  *         @arg @ref LL_RCC_I2C12_CLKSOURCE_HSI
...
/**
  ...
  *         SPI45CKSELR         SPI4SRC     LL_RCC_SetSPIClockSource\n
  *         SPI45CKSELR         SPI5SRC     LL_RCC_SetSPIClockSource
  * @param  ClkSource This parameter can be one of the following values:
  *         @arg @ref LL_RCC_SPI1_CLKSOURCE_PLL4P
  *         @arg @ref LL_RCC_SPI1_CLKSOURCE_PLL3Q
  *         @arg @ref LL_RCC_SPI1_CLKSOURCE_I2SCKIN
...
/**
  ...
  * @rmtoll UART12CKSELR       UART1SRC      LL_RCC_SetUARTClockSource\n
  *         UART12CKSELR       UART2SRC      LL_RCC_SetUARTClockSource\n
  *         UART35CKSELR       UART35SRC     LL_RCC_SetUARTClockSource\n
  *         UART4CKSELR        UART4SRC      LL_RCC_SetUARTClockSource\n
...
/**
  ...
  *         LPTIM23CKSELR     LPTIM2SRC      LL_RCC_SetLPTIMClockSource\n
  *         LPTIM23CKSELR     LPTIM3SRC      LL_RCC_SetLPTIMClockSource\n
...
/**
  ...
  * @rmtoll ADC12CKSELR      ADC1SRC      LL_RCC_SetADCClockSource\n
  * @rmtoll ADC12CKSELR      ADC2SRC      LL_RCC_SetADCClockSource
  * @param  ClkSource This parameter can be one of the following values:
  *         @arg @ref LL_RCC_ADC1_CLKSOURCE_PLL4R
  *         @arg @ref LL_RCC_ADC1_CLKSOURCE_PER
  *         @arg @ref LL_RCC_ADC1_CLKSOURCE_PLL3Q
...
/**
  ...
  * @rmtoll SDMMC12CKSELR      SDMMC1SRC       LL_RCC_SetSDMMCClockSource\n
  *         SDMMC12CKSELR      SDMMC2SRC       LL_RCC_SetSDMMCClockSource
  * @param  ClkSource This parameter can be one of the following values:
  *         @arg @ref LL_RCC_SDMMC1_CLKSOURCE_HCLK6
  *         @arg @ref LL_RCC_SDMMC1_CLKSOURCE_PLL3R
  *         @arg @ref LL_RCC_SDMMC1_CLKSOURCE_PLL4P
...
/**
  * @brief  Configure ETH1 clock source
  * @rmtoll ETH12CKSELR      ETH1SRC      LL_RCC_SetETHClockSource\n
  *         ETH12CKSELR      ETH2SRC      LL_RCC_SetETHClockSource
  * @param  ClkSource This parameter can be one of the following values:
  *         @arg @ref LL_RCC_ETH1_CLKSOURCE_PLL4P
  *         @arg @ref LL_RCC_ETH1_CLKSOURCE_PLL3Q
  *         @arg @ref LL_RCC_ETH1_CLKSOURCE_OFF
...
/**
  * @brief  Configure DCMIPP clock source
  * @rmtoll DCMIPPCKSELR      DCMIPPSRC      LL_RCC_SetDCMIPPClockSource
  * @param  ClkSource This parameter can be one of the following values:
  *         @arg @ref LL_RCC_DCMIPP_CLKSOURCE_ACLK
  *         @arg @ref LL_RCC_DCMIPP_CLKSOURCE_PLL2Q
  *         @arg @ref LL_RCC_DCMIPP_CLKSOURCE_PLL4P
...
/**
  ...
  * @rmtoll SAESCKSELR      SAESSRC      LL_RCC_SetSAESClockSource
  * @param  ClkSource This parameter can be one of the following values:
  *         @arg @ref LL_RCC_SAES_CLKSOURCE_ACLK
  *         @arg @ref LL_RCC_SAES_CLKSOURCE_PER
  *         @arg @ref LL_RCC_SAES_CLKSOURCE_PLL4R
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RCC_SetSAESClockSource(uint32_t ClkSource)
{
  LL_RCC_SetClockSource(ClkSource);
}
...
/**
  ...
  * @rmtoll MCO1CFGR           *     LL_RCC_GetClockSource\n
  *         MCO2CFGR           *     LL_RCC_GetClockSource\n
  *         CKPERCKSELR        *     LL_RCC_GetClockSource\n
  *         TIMG1PRER          *     LL_RCC_GetClockSource\n
  *         TIMG2PRER          *     LL_RCC_GetClockSource\n
  *         TIMG3PRER          *     LL_RCC_GetClockSource\n
  ...
  *         USART12CKSELR      *     LL_RCC_GetClockSource\n
  *         USART35CKSELR      *     LL_RCC_GetClockSource\n
  *         UART4CKSELR        *     LL_RCC_GetClockSource\n
  ...
  *         FDCANCKSELR        *     LL_RCC_GetClockSource\n
  *         SPDIFCKSELR        *     LL_RCC_GetClockSource\n
  *         ADC12CKSELR        *     LL_RCC_GetClockSource\n
  *         SDMMC12CKSELR      *     LL_RCC_GetClockSource\n
  *         ETH12CKSELR        *     LL_RCC_GetClockSource\n
  *         USBCKSELR          *     LL_RCC_GetClockSource\n
  *         QSPICKSELR         *     LL_RCC_GetClockSource\n
  *         FMCCKSELR          *     LL_RCC_GetClockSource\n
  *         RNG1CKSELR         *     LL_RCC_GetClockSource\n
  *         STGENCKSELR        *     LL_RCC_GetClockSource\n
  *         DCMIPPCKSELR       *     LL_RCC_GetClockSource\n
  *         SAESCKSELR         *     LL_RCC_GetClockSource\n
  ...
  *         @arg @ref LL_RCC_TIMG3PRES
  *         @arg @ref LL_RCC_I2C12_CLKSOURCE
  *         @arg @ref LL_RCC_I2C3_CLKSOURCE
  *         @arg @ref LL_RCC_I2C4_CLKSOURCE
  *         @arg @ref LL_RCC_I2C5_CLKSOURCE
...
{
  __IO const uint32_t *pReg = (uint32_t *)((uint32_t)((uint32_t)(&RCC->MCO1CFGR) + LL_CLKSOURCE_REG(Periph)));
...
/**
  ...
  *         I2C345CKSELR       I2C3SRC      LL_RCC_GetI2CClockSource
  *         I2C345CKSELR       I2C4SRC      LL_RCC_GetI2CClockSource
  *         I2C345CKSELR       I2C5SRC      LL_RCC_GetI2CClockSource
  * @param  Periph This parameter can be one of the following values:
  *         @arg @ref LL_RCC_I2C12_CLKSOURCE
  *         @arg @ref LL_RCC_I2C3_CLKSOURCE
  *         @arg @ref LL_RCC_I2C4_CLKSOURCE
...
/**
  ...
  *         SPI45CKSELR         SPI4SRC     LL_RCC_GetSPIClockSource\n
  *         SPI45CKSELR         SPI5SRC     LL_RCC_GetSPIClockSource
  * @param  Periph This parameter can be one of the following values:
  *         @arg @ref LL_RCC_SPI1_CLKSOURCE
  *         @arg @ref LL_RCC_SPI23_CLKSOURCE
  *         @arg @ref LL_RCC_SPI4_CLKSOURCE
...
/**
  ...
  * @rmtoll UART12CKSELR       UART1SRC      LL_RCC_GetUARTClockSource\n
  *         UART12CKSELR       UART2SRC      LL_RCC_GetUARTClockSource\n
  *         UART35CKSELR       UART35SRC     LL_RCC_GetUARTClockSource\n
  *         UART4CKSELR        UART4SRC      LL_RCC_GetUARTClockSource\n
...
/**
  ...
  *         LPTIM23CKSELR     LPTIM2SRC      LL_RCC_GetLPTIMClockSource\n
  *         LPTIM23CKSELR     LPTIM3SRC      LL_RCC_GetLPTIMClockSource\n
...
/**
  ...
  * @rmtoll ADC12CKSELR      ADC1SRC      LL_RCC_GetADCClockSource\n
  * @rmtoll ADC12CKSELR      ADC2SRC      LL_RCC_GetADCClockSource
  * @param  Periph This parameter can be one of the following values:
  *         @arg @ref LL_RCC_ADC1_CLKSOURCE
  *         @arg @ref LL_RCC_ADC2_CLKSOURCE
  * @retval Returned value can be one of the following values:
...
/**
  ...
  * @rmtoll SDMMC12CKSELR      SDMMC1SRC       LL_RCC_GetSDMMCClockSource\n
  *         SDMMC12CKSELR      SDMMC2SRC       LL_RCC_GetSDMMCClockSource
  * @param  Periph This parameter can be one of the following values:
  *         @arg @ref LL_RCC_SDMMC1_CLKSOURCE
  *         @arg @ref LL_RCC_SDMMC2_CLKSOURCE
  * @retval Returned value can be one of the following values:
...
/**
  ...
  * @rmtoll ETH12CKSELR      ETH1SRC      LL_RCC_GetETHClockSource\n
  *         ETH12CKSELR      ETH2SRC      LL_RCC_GetETHClockSource
  * @param  Periph This parameter can be one of the following values:
  *         @arg @ref LL_RCC_ETH1_CLKSOURCE
  *         @arg @ref LL_RCC_ETH2_CLKSOURCE
  * @retval Returned value can be one of the following values:
...
/**
  ...
  * @rmtoll SAESCKSELR      DCMIPPSRC      LL_RCC_GetDCMIPPClockSource
  * @param  Periph This parameter can be one of the following values:
  *         @arg @ref LL_RCC_DCMIPP_CLKSOURCE
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_RCC_DCMIPP_CLKSOURCE_ACLK
...
/**
  * @brief  Get SAES clock source
  * @rmtoll SAESCKSELR      SAESSRC      LL_RCC_GetSAESClockSource
  * @param  Periph This parameter can be one of the following values:
  *         @arg @ref LL_RCC_SAES_CLKSOURCE
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_RCC_SAES_CLKSOURCE_ACLK
  ...
  *         @arg @ref LL_RCC_SAES_CLKSOURCE_LSI
  */
__STATIC_INLINE uint32_t LL_RCC_GetSAESClockSource(uint32_t Periph)
{
  return LL_RCC_GetClockSource(Periph);
}
...
__STATIC_INLINE void LL_RCC_ConfigMCO(uint32_t MCOxSource, uint32_t MCOxPrescaler)
{
  ...
  /* Set MCOx prescaler */
  __IO uint32_t *pReg = (__IO uint32_t *)((uint32_t)&RCC->MCO1CFGR + LL_CLKSOURCE_REG(MCOxSource));
...
/** @brief  Configure the PLL1 Clock Spreading Generator
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RCC_PLL1_ConfigCSG(uint32_t ModPeriod, uint32_t TPDFN, uint32_t RPDFN, uint32_t SSCGMode,
                                           uint32_t IncStep)
{
...
/** @brief  Configure the PLL2 Clock Spreading Generator
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RCC_PLL2_ConfigCSG(uint32_t ModPeriod, uint32_t TPDFN, uint32_t RPDFN, uint32_t SSCGMode,
                                           uint32_t IncStep)
{
...
/** @brief  Configure the PLL3 Clock Spreading Generator
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RCC_PLL3_ConfigCSG(uint32_t ModPeriod, uint32_t TPDFN, uint32_t RPDFN, uint32_t SSCGMode,
                                           uint32_t IncStep)
{
...
/** @brief  Configure the PLL4 Clock Spreading Generator
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RCC_PLL4_ConfigCSG(uint32_t ModPeriod, uint32_t TPDFN, uint32_t RPDFN, uint32_t SSCGMode,
                                           uint32_t IncStep)
{
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_LSIRDYF);
}
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_LSERDYF);
}
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_HSIRDYF);
}
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_HSERDYF);
}
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_CSIRDYF);
}
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_PLL1DYF);
}
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_PLL2DYF);
}
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_PLL3DYF);
}
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_PLL4DYF);
}
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_LSECSSF);
}
...
{
  WRITE_REG(RCC->MP_CIFR, RCC_MP_CIFR_WKUPF);
}
...
/**
  ...
  * @rmtoll MP_RSTSCLRR   MPSYSRSTF      LL_RCC_IsActiveFlag_MPSYSRST
  * @retval State of bit (1 or 0).
  */
...
/**
  * @brief  Check if RCC flag MPU reset is set or not.
  * @rmtoll MP_RSTSCLRR   MPUP0RSTF      LL_RCC_IsActiveFlag_MPURST
  * @retval State of bit (1 or 0).
  */
...
{
  WRITE_REG(RCC->MP_RSTSCLRR, LL_RCC_MP_RSTSCLRR_ALL);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_LSIRDYIE);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_LSERDYIE);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_HSIRDYIE);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_HSERDYIE);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_CSIRDYIE);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_PLL1DYIE);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_PLL2DYIE);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_PLL3DYIE);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_PLL4DYIE);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_LSECSSIE);
}
...
{
  SET_BIT(RCC->MP_CIER, RCC_MP_CIER_WKUPIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_LSIRDYIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_LSERDYIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_HSIRDYIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_HSERDYIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_CSIRDYIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_PLL1DYIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_PLL2DYIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_PLL3DYIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_PLL4DYIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_LSECSSIE);
}
...
{
  CLEAR_BIT(RCC->MP_CIER, RCC_MP_CIER_WKUPIE);
}
