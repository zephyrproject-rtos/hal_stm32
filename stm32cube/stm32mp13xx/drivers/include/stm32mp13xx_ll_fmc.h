...
#ifndef STM32MP13xx_LL_FMC_H
#define STM32MP13xx_LL_FMC_H
...
#define IS_FMC_ECC_SECTOR_SIZE(__SIZE__) (((__SIZE__) == FMC_NAND_ECC_SECTOR_SIZE_256BYTE)  || \
                                       ((__SIZE__) == FMC_NAND_ECC_SECTOR_SIZE_512BYTE)  || \
                                       ((__SIZE__) == FMC_NAND_ECC_SECTOR_SIZE_1024BYTE) || \
                                       ((__SIZE__) == FMC_NAND_ECC_SECTOR_SIZE_2048BYTE) || \
                                       ((__SIZE__) == FMC_NAND_ECC_SECTOR_SIZE_4096BYTE) || \
                                       ((__SIZE__) == FMC_NAND_ECC_SECTOR_SIZE_8192BYTE))
#define IS_FMC_ECC_ALGORITHM(__ALGO__) (((__ALGO__) == FMC_NAND_ECC_ALGO_HAMMING) || \
                                        ((__ALGO__) == FMC_NAND_ECC_ALGO_BCH))
#define IS_FMC_BCH_MODE(__MODE__) (((__MODE__) == FMC_NAND_BCH_4BIT) || \
                                   ((__MODE__) == FMC_NAND_BCH_8BIT))
#define IS_FMC_ECC_ACCESS_MODE(__MODE__) (((__MODE__) == FMC_NAND_ECC_ACCESS_MODE_READ) || \
                                          ((__MODE__) == FMC_NAND_ECC_ACCESS_MODE_WRITE))
...
#define IS_FMC_HAMMING_SIZE(__SIZE__) ((__SIZE__) == 3 || (__SIZE__) == 4)
#define IS_FMC_BCH_SIZE(__SIZE__) ((__SIZE__) == 7 || (__SIZE__) == 13)
...
typedef struct
{
  ...
  uint32_t EccSectorSize;          /*!< Defines the sector size for the extended ECC.
                                        This parameter can be any value of @ref FMC_ECC_PAGE_Size            */

  uint32_t EccAlgorithm;           /*!< Specifies ECC algorithm.
                                        This parameter can be any value of @ref FMC_ECC_ALGO                 */

  uint32_t BCHMode;                /*!< Specifies BCH mode.
                                        This parameter can be any value of @ref FMC_BCH_MODE                 */

  uint32_t EccAccessMode;          /*!< Defines the access mode for the extended ECC.
                                        This parameter can be any value of @ref FMC_ECC_ACCESS_MODE            */
...
#define FMC_NAND_ECC_ENABLE                     (FMC_PCR_ECCEN)
/**
  * @}
  */

/** @defgroup FMC_ECC_Algorithm FMC ECC algorithm
  * @{
  */
#define FMC_NAND_ECC_ALGO_HAMMING               ((uint32_t)0x00000000)
#define FMC_NAND_ECC_ALGO_BCH                   (FMC_PCR_ECCALG)
/**
  * @}
  */

/** @defgroup FMC_BCH_Mode FMC BCH mode (4-bit or 8-bit)
  * @{
  */
#define FMC_NAND_BCH_4BIT                       ((uint32_t)0x00000000)
#define FMC_NAND_BCH_8BIT                       (FMC_PCR_BCHECC)
/**
  * @}
  */

/** @defgroup FMC_ECC_Access_Mode FMC Sequencer and BCH access mode
  * @{
  */
#define FMC_NAND_ECC_ACCESS_MODE_READ           ((uint32_t)0x00000000)
#define FMC_NAND_ECC_ACCESS_MODE_WRITE          (FMC_PCR_WEN)
/**
  * @}
  */

/** @defgroup FMC_ECC_Sector_Size FMC ECC Sector Size
  * @{
  */
#define FMC_NAND_ECC_SECTOR_SIZE_256BYTE          (0U << FMC_PCR_ECCSS_Pos)
#define FMC_NAND_ECC_SECTOR_SIZE_512BYTE          (1U << FMC_PCR_ECCSS_Pos)
#define FMC_NAND_ECC_SECTOR_SIZE_1024BYTE         (2U << FMC_PCR_ECCSS_Pos)
#define FMC_NAND_ECC_SECTOR_SIZE_2048BYTE         (3U << FMC_PCR_ECCSS_Pos)
#define FMC_NAND_ECC_SECTOR_SIZE_4096BYTE         (4U << FMC_PCR_ECCSS_Pos)
#define FMC_NAND_ECC_SECTOR_SIZE_8192BYTE         (5U << FMC_PCR_ECCSS_Pos)
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
#define __FMC_ENABLE()  (FMC_Bank1_R->BTCR[0] |= FMC_BCRx_FMCEN)

/**
  * @brief  Disable the FMC Peripheral.
  * @retval None
  */
#define __FMC_DISABLE()  (FMC_Bank1_R->BTCR[0] &= ~FMC_BCRx_FMCEN)
...
/**
  * @brief  Disable the NAND ECC.
  * @param  __INSTANCE__ FMC_NAND Instance
  * @param  __BANK__     FMC_NAND Bank
  * @retval None
  */
#define __FMC_NAND_DISABLE_ECC(__INSTANCE__, __BANK__) CLEAR_BIT((__INSTANCE__)->PCR, FMC_PCR_ECCEN)

/**
  * @brief  Enable the NAND ECC.
  * @param  __INSTANCE__ FMC_NAND Instance
  * @param  __BANK__     FMC_NAND Bank
  * @retval None
  */
#define __FMC_NAND_ENABLE_ECC(__INSTANCE__, __BANK__) SET_BIT((__INSTANCE__)->PCR, FMC_PCR_ECCEN)

/**
  * @brief  Check if Hamming ECC is ready by testing FMC_SR_NWRF and FMC_SR_PEF flags of the NAND device.
  * @param  __INSTANCE__ FMC_NAND Instance
  * @retval The state of FMC_SR_NWRF and FMC_SR_PEF flags (SET if both are set, RESET otherwise).
  */
#define __FMC_NAND_IS_ECC_HAMMING_READY(__INSTANCE__)  (((__INSTANCE__)->SR & \
                                                         (FMC_SR_NWRF | FMC_SR_PEF)) == (FMC_SR_NWRF | FMC_SR_PEF))

/**
  * @brief  Set the ECC algorithm.
  * @param  __INSTANCE__ FMC_NAND Instance
  * @param  __ALGORITHM__ Either FMC_NAND_ECC_ALGO_HAMMING or FMC_NAND_ECC_ALGO_BCH
  * @retval None
  */
#define __FMC_NAND_SET_ECC_ALGORITHM(__INSTANCE__, __ALGORITHM__) \
  (MODIFY_REG((__INSTANCE__)->PCR, FMC_PCR_ECCALG, __ALGORITHM__))

/**
  * @brief  Set the ECC BCH mode (4-bit or 8-bit).
  * @param  __INSTANCE__ FMC_NAND Instance
  * @param  __MODE__ Either FMC_NAND_BCH_4BIT or FMC_NAND_BCH_8BIT
  * @retval None
  */
#define __FMC_NAND_SET_BCH_MODE(__INSTANCE__, __MODE__)  (MODIFY_REG((__INSTANCE__)->PCR, FMC_PCR_BCHECC, __MODE__))

/**
  * @brief  Set the ECC access mode for the sequencer and BCH.
  * @param  __INSTANCE__ FMC_NAND Instance
  * @param  __MODE__ Either FMC_NAND_ECC_ACCESS_MODE_READ or FMC_NAND_ECC_ACCESS_MODE_WRITE
  * @retval None
  */
#define __FMC_NAND_SET_ECC_ACCESS_MODE(__INSTANCE__, __MODE__)  (MODIFY_REG((__INSTANCE__)->PCR, FMC_PCR_WEN,__MODE__))

/**
  * @brief  Check if BCH ECC is ready from the encoder by testing FMC_BCHISR_EPBRF flag of the NAND device.
  * @param  __INSTANCE__ FMC_NAND Instance
  * @retval The state of FMC_BCHISR_EPBRF flags (SET or RESET).
  */
#define __FMC_NAND_IS_ECC_BCH_ENCODER_READY(__INSTANCE__)  (((__INSTANCE__)->BCHISR & \
                                                             FMC_BCHISR_EPBRF) == FMC_BCHISR_EPBRF)

/**
  * @brief  Check if BCH ECC is ready from the decoder by testing DERF flag of the NAND device.
  * @param  __INSTANCE__ FMC_NAND Instance
  * @retval The state of DERF flags (SET or RESET).
  */
#define __FMC_NAND_IS_ECC_BCH_DECODER_READY(__INSTANCE__)  (((__INSTANCE__)->BCHISR & \
                                                             FMC_BCHISR_DERF) == FMC_BCHISR_DERF)
...
/** @defgroup FMC_LL_NAND_Private_Functions_Group2 NAND Hamming error correction functions
  *  @{
  */
HAL_StatusTypeDef  FMC_NAND_ECC_Enable(FMC_NAND_TypeDef *Device, uint32_t Bank);
HAL_StatusTypeDef  FMC_NAND_ECC_Disable(FMC_NAND_TypeDef *Device, uint32_t Bank);
HAL_StatusTypeDef  FMC_NAND_GetECC(FMC_NAND_TypeDef *Device, uint32_t *ECCval, uint32_t Bank, uint32_t Timeout);
HAL_StatusTypeDef  FMC_NAND_ECC_SetAlgorithm(FMC_NAND_TypeDef *Device, uint32_t Algorithm);
HAL_StatusTypeDef  FMC_NAND_ECC_SetBCHMode(FMC_NAND_TypeDef *Device, uint32_t Mode);
HAL_StatusTypeDef  FMC_NAND_ECC_SetAccessMode(FMC_NAND_TypeDef *Device, uint32_t Mode);
HAL_StatusTypeDef  FMC_NAND_ECC_GetBCH(FMC_NAND_TypeDef *Device, uint32_t *ECCval, uint32_t Timeout);
HAL_StatusTypeDef  FMC_NAND_ECC_GetBCHResult(FMC_NAND_TypeDef *Device, uint32_t *BCHDSRx,
                                                      uint32_t Timeout);
void               FMC_NAND_ECC_DecodeBCHResult(const uint32_t *BCHDSRx, uint16_t *Positions,
                                                      int32_t *ErrorCount);
/**
  * @}
  */
