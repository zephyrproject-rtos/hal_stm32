...
#ifndef __STM32MP13xx_HAL_DCMIPP_H
#define __STM32MP13xx_HAL_DCMIPP_H
...
typedef struct
{
  uint32_t VStart;   /*!< Configures the DCMIPP Crop Vertical Start
                          This parameter can be one value between 0 and 0xFFF          */
  ...
  uint32_t HSize;    /*!< Configures the DCMIPP Crop Horizontal Size
                          This parameter can be one value between 1 and 0xFFF          */
...
#if (USE_HAL_DCMIPP_REGISTER_CALLBACKS == 1)
  void (* PIPE_FrameEventCallback)(struct __DCMIPP_HandleTypeDef *phdcmipp, uint32_t Pipe); /*!< DCMIPP Pipe Frame Event
                                                                                                Callback              */
  void (* PIPE_VsyncEventCallback)(struct __DCMIPP_HandleTypeDef *phdcmipp, uint32_t Pipe); /*!< DCMIPP Pipe Vsync Event
                                                                                                Callback              */
  void (* PIPE_LineEventCallback)(struct __DCMIPP_HandleTypeDef *phdcmipp, uint32_t Pipe);  /*!< DCMIPP Pipe Line Event
                                                                                                Callback              */
  void (* PIPE_LimitEventCallback)(struct __DCMIPP_HandleTypeDef *phdcmipp, uint32_t Pipe); /*!< DCMIPP Pipe Limit Event
                                                                                                Callback              */
  void (* PIPE_ErrorCallback)(struct __DCMIPP_HandleTypeDef *phdcmipp, uint32_t Pipe);      /*!< DCMIPP Pipe Error
                                                                                                Callback              */
  void (* ErrorCallback)(struct __DCMIPP_HandleTypeDef *phdcmipp);                         /*!< DCMIPP Error Callback */
  void (* MspInitCallback)(struct __DCMIPP_HandleTypeDef *phdcmipp);                       /*!< DCMIPP Msp Init
                                                                                                Callback              */
  void (* MspDeInitCallback)(struct __DCMIPP_HandleTypeDef *phdcmipp);                     /*!< DCMIPP Msp DeInit
                                                                                                Callback              */
#endif  /* USE_HAL_DCMIPP_REGISTER_CALLBACKS */
...
/**
  ...
  */
typedef void (*pDCMIPP_CallbackTypeDef)(DCMIPP_HandleTypeDef *phdcmipp); /*!< Pointer to a DCMIPP common callback
                                                                              function */
typedef void (*pDCMIPP_PIPE_CallbackTypeDef)(DCMIPP_HandleTypeDef *phdcmipp, uint32_t Pipe); /*!< Pointer to a DCMIPP
...
/** @defgroup DCMIPP_Maximum_Outstanding_Transactions DCMIPP Maximum Outstanding Transactions
  * @{
  */
#define DCMIPP_OUTSTANDING_TRANSACTION_NONE 0U                             /*!< No outstanding transaction limitation */
...
#define DCMIPP_SYNCHRO_EMBEDDED    ((uint32_t)DCMIPP_PRCR_ESS)  /*!< Embedded Synchronization */
/**
  * @}
  */
...
#define DCMIPP_LSM_ALTERNATE_2 (0x1U << DCMIPP_P0PPCR_LSM_Pos ) /*!< Interface captures one line out of two */
/**
  * @}
  */
...
#define DCMIPP_OELS_EVEN       (0x1U << DCMIPP_P0PPCR_OELS_Pos) /*!< Interface captures second line from the frame
...
#define DCMIPP_BSM_DATA_OUT_2  (0x1U << DCMIPP_P0PPCR_BSM_Pos)  /*!< Interface captures 1 data out of 2   */
#define DCMIPP_BSM_BYTE_OUT_4  (0x2U << DCMIPP_P0PPCR_BSM_Pos)  /*!< Interface captures 1 byte out of 4   */
#define DCMIPP_BSM_2BYTE_OUT_4 (0x3U << DCMIPP_P0PPCR_BSM_Pos)  /*!< Interface captures 2 byte out of 4   */
/**
  * @}
  */
...
#define DCMIPP_OEBS_EVEN       (0x1U << DCMIPP_P0PPCR_OEBS_Pos) /*!< Interface captures second data (byte or double byte)
...
#define DCMIPP_MEMORY_ADDRESS_1 0x1U /*!< Second destination address */
/**
  * @}
  */
...
#define  DCMIPP_MULTILINE_2_LINES    (0x1U << DCMIPP_P0PPCR_LINEMULT_Pos) /*!< Event after every 2   lines  */
#define  DCMIPP_MULTILINE_4_LINES    (0x2U << DCMIPP_P0PPCR_LINEMULT_Pos) /*!< Event after every 4   lines  */
#define  DCMIPP_MULTILINE_8_LINES    (0x3U << DCMIPP_P0PPCR_LINEMULT_Pos) /*!< Event after every 8   lines  */
#define  DCMIPP_MULTILINE_16_LINES   (0x4U << DCMIPP_P0PPCR_LINEMULT_Pos) /*!< Event after every 16  lines  */
#define  DCMIPP_MULTILINE_32_LINES   (0x5U << DCMIPP_P0PPCR_LINEMULT_Pos) /*!< Event after every 32  lines  */
#define  DCMIPP_MULTILINE_64_LINES   (0x6U << DCMIPP_P0PPCR_LINEMULT_Pos) /*!< Event after every 64  lines  */
#define  DCMIPP_MULTILINE_128_LINES  (0x7U << DCMIPP_P0PPCR_LINEMULT_Pos) /*!< Event after every 128 lines  */
/**
  * @}
  */
...
#define DCMIPP_IT_PARALLEL_SYNC_ERROR DCMIPP_CMIER_PRERRIE /*!< Synchronization error interrupt on parallel interface */
...
void HAL_DCMIPP_PIPE_VsyncEventCallback(DCMIPP_HandleTypeDef *phdcmipp, uint32_t Pipe);
void HAL_DCMIPP_PIPE_LineEventCallback(DCMIPP_HandleTypeDef *phdcmipp, uint32_t Pipe);
void HAL_DCMIPP_PIPE_LimitEventCallback(DCMIPP_HandleTypeDef *phdcmipp, uint32_t Pipe);
void HAL_DCMIPP_PIPE_ErrorCallback(DCMIPP_HandleTypeDef *phdcmipp, uint32_t Pipe);
void HAL_DCMIPP_ErrorCallback(DCMIPP_HandleTypeDef *phdcmipp);
...
HAL_StatusTypeDef HAL_DCMIPP_UnRegisterCallback(DCMIPP_HandleTypeDef *phdcmipp,
...
/** @defgroup DCMIPP_Exported_Functions_Group5 Peripheral Control Functions
...
/** @addtogroup DCMIPP_Exported_Functions_Group6 Peripheral State and error functions
  * @{
  */
...
#define IS_DCMIPP_DPREG_END(DPREG_END) ((DPREG_END) <= 0x3FU)
#define IS_DCMIPP_DPREG_START(DPREG_START) ((DPREG_START) <= 0x3FU)
...
#define IS_DCMIPP_PIPE_CROP_HSIZE(CROP_HSIZE)   (((CROP_HSIZE) >= 1U) && ((CROP_HSIZE) <= 0xFFEU))
#define IS_DCMIPP_PIPE_CROP_HSTART(CROP_HSTART)  (((CROP_HSTART) >= 0U) && ((CROP_HSTART) <= 0xFFEU))
#define IS_DCMIPP_PIPE_CROP_VSIZE(CROP_VSIZE)  (((CROP_VSIZE) >= 1U) && ((CROP_VSIZE) <= 0xFFEU))
#define IS_DCMIPP_PIPE_CROP_VSTART(CROP_VSTART) (((CROP_VSTART) >= 0U) && ((CROP_VSTART) <= 0xFFEU))
...
#endif /* __STM32MP13xx_HAL_DCMIPP_H */
