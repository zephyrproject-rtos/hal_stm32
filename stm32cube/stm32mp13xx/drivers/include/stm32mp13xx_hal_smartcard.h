/**
  ******************************************************************************
  * @file    stm32mp13xx_hal_smartcard.h
...
#ifndef STM32MP13xx_HAL_SMARTCARD_H
#define STM32MP13xx_HAL_SMARTCARD_H
...
typedef enum
{
  ...
  SMARTCARD_CLOCKSOURCE_PLL3Q      = 0x04U,    /*!< PLL3Q clock source  (only used by UART1) */
  ...
  SMARTCARD_CLOCKSOURCE_PCLK6      = 0x80U,    /*!< PCLK6 clock source  */
    ...
    {                                                          \
      ...
      {                                                        \
        case RCC_USART1CLKSOURCE_PCLK6:                        \
          (__CLOCKSOURCE__) = SMARTCARD_CLOCKSOURCE_PCLK6;         \
          break;                                               \
...
#include "stm32mp13xx_hal_smartcard_ex.h"
...
#endif /* STM32MP13xx_HAL_SMARTCARD_H */
