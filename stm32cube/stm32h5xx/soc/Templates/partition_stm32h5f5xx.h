/**
  ******************************************************************************
  * @file    partition_stm32h5f5xx.h
  * @author  MCD Application Team
  * @brief   CMSIS STM32H5F5xx Device Header File for Initial Setup for Secure /
...
#ifndef PARTITION_STM32H5F5XX_H
#define PARTITION_STM32H5F5XX_H
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START2     0x20060000      /* start address of SAU region 2 */
...
//   <o.6>  DMA2D_IRQn             <0=> Secure state <1=> Non-Secure state
//   <o.7>  JPEG_IRQn              <0=> Secure state <1=> Non-Secure state
//   <o.8>  GPDMA1_Channel8_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.9>  GPDMA1_Channel9_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.10> GPDMA1_Channel10_IRQn  <0=> Secure state <1=> Non-Secure state
//   <o.11> GPDMA1_Channel11_IRQn  <0=> Secure state <1=> Non-Secure state
//   <o.12> GPDMA2_Channel8_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.13> GPDMA2_Channel9_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.14> GPDMA2_Channel10_IRQn  <0=> Secure state <1=> Non-Secure state
//   <o.15> GPDMA2_Channel11_IRQn  <0=> Secure state <1=> Non-Secure state
//   <o.16> GFXTIM_IRQn            <0=> Secure state <1=> Non-Secure state
//   <o.17> LCD_IRQ_IRQn           <0=> Secure state <1=> Non-Secure state
//   <o.18> LCD_GBL_ERROR_IRQn     <0=> Secure state <1=> Non-Secure state
...
//   <o.22> OCTOSPI2_IRQn          <0=> Secure state <1=> Non-Secure state
//   <o.23> OTFDEC2_IRQn           <0=> Secure state <1=> Non-Secure state
//   <o.24> FDCAN3_IT0_IRQn        <0=> Secure state <1=> Non-Secure state
//   <o.25> FDCAN3_IT1_IRQn        <0=> Secure state <1=> Non-Secure state
//   <o.26> MDF1_FLT0_IRQn         <0=> Secure state <1=> Non-Secure state
//   <o.27> MDF1_FLT1_IRQn         <0=> Secure state <1=> Non-Secure state
//   <o.28> MDF1_FLT2_IRQn         <0=> Secure state <1=> Non-Secure state
//   <o.29> MDF1_FLT3_IRQn         <0=> Secure state <1=> Non-Secure state
//   <o.30> MDF1_FLT4_IRQn         <0=> Secure state <1=> Non-Secure state
//   <o.31> MDF1_FLT5_IRQn         <0=> Secure state <1=> Non-Secure state
*/
...
/*
//   <e>Initialize ITNS 5 (Interrupts 160..161)
*/
#define NVIC_INIT_ITNS5    1

/*
// Interrupts 160..161
//   <o.0>  ADF1_IRQn            <0=> Secure state <1=> Non-Secure state
//   <o.1>  OTG_HS_IRQn          <0=> Secure state <1=> Non-Secure state
*/
