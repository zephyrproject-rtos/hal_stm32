...
#ifndef STM32H5xx_LL_DMA2D_H
#define STM32H5xx_LL_DMA2D_H
...
/** @defgroup DMA2D_LL_EC_IT IT Defines
  ...
  * @{
  */
#define LL_DMA2D_IT_CEIE             DMA2D_IER_CEIE    /*!< Configuration Error Interrupt */
#define LL_DMA2D_IT_CTCIE            DMA2D_IER_CTCIE   /*!< CLUT Transfer Complete Interrupt */
#define LL_DMA2D_IT_CAEIE            DMA2D_IER_CAEIE   /*!< CLUT Access Error Interrupt */
#define LL_DMA2D_IT_TWIE             DMA2D_IER_TWIE    /*!< Transfer Watermark Interrupt */
#define LL_DMA2D_IT_TCIE             DMA2D_IER_TCIE    /*!< Transfer Complete Interrupt */
#define LL_DMA2D_IT_TEIE             DMA2D_IER_TEIE    /*!< Transfer Error Interrupt */
/**
  * @}
  */
...
#define LL_DMA2D_OUTPUT_MODE_ARGB2222     (DMA2D_OPFCCR_CM_1 | DMA2D_OPFCCR_CM_2 | DMA2D_OPFCCR_CM_3) /*!< ARGB2222 */
/**
  * @}
  */
...
#define LL_DMA2D_INPUT_MODE_A2             0xC                                                       /*!< A2       */
#define LL_DMA2D_INPUT_MODE_A1             0xD                                                       /*!< A1       */
#define LL_DMA2D_INPUT_MODE_ARGB222        0xE                                                       /*!< ARGB222  */
/**
  * @}
  */
...
#define LL_DMA2D_CLUT_COLOR_MODE_RGB888            0x00000001U                     /*!< RGB888   */
#define LL_DMA2D_CLUT_COLOR_MODE_RGB565            0x00000002U                     /*!< RGB565   */
#define LL_DMA2D_CLUT_COLOR_MODE_ARGB1555          0x00000003U                     /*!< ARGB1555 */
#define LL_DMA2D_CLUT_COLOR_MODE_ARGB4444          0x00000004U                     /*!< ARGB4444 */
#define LL_DMA2D_CLUT_COLOR_MODE_ARGB2222          0x0000000EU                     /*!< ARGB2222 */
/**
  * @}
  */
...
/**
  ...
  * @rmtoll FGPFCCR          CM          LL_DMA2D_FGND_SetCLUTColorMode
  * @param  DMA2Dx DMA2D Instance
...
{
  MODIFY_REG(DMA2Dx->FGPFCCR, DMA2D_FGPFCCR_CM, CLUTColorMode);
}

/**
  * @brief  Return DMA2D foreground CLUT color mode.
  * @rmtoll FGPFCCR          CM         LL_DMA2D_FGND_GetCLUTColorMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_DMA2D_CLUT_COLOR_MODE_ARGB8888
  *         @arg @ref LL_DMA2D_CLUT_COLOR_MODE_RGB888
  *         @arg @ref LL_DMA2D_CLUT_COLOR_MODE_RGB565
...
/**
  ...
  * @rmtoll BGPFCCR          CM         LL_DMA2D_BGND_SetCLUTColorMode
  * @param  DMA2Dx DMA2D Instance
  * @param  CLUTColorMode This parameter can be one of the following values:
  *         @arg @ref LL_DMA2D_CLUT_COLOR_MODE_ARGB8888
  *         @arg @ref LL_DMA2D_CLUT_COLOR_MODE_RGB888
...
{
  MODIFY_REG(DMA2Dx->BGPFCCR, DMA2D_BGPFCCR_CM, CLUTColorMode);
}

/**
  * @brief  Return DMA2D background CLUT color mode.
  * @rmtoll BGPFCCR          CM          LL_DMA2D_BGND_GetCLUTColorMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_DMA2D_CLUT_COLOR_MODE_ARGB8888
  *         @arg @ref LL_DMA2D_CLUT_COLOR_MODE_RGB888
