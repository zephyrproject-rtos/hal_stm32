/**
  ******************************************************************************
  * @file    stm32wbaxx_hal_smartcard.h
...
#ifndef STM32WBAxx_HAL_SMARTCARD_H
#define STM32WBAxx_HAL_SMARTCARD_H
...
/** @brief  Check the Baud rate range.
  * @note   The maximum Baud Rate is derived from the maximum clock on WBA (100 MHz)
  ...
  */
#define IS_SMARTCARD_BAUDRATE(__BAUDRATE__) ((__BAUDRATE__) < 12500000U)
...
#include "stm32wbaxx_hal_smartcard_ex.h"
...
#endif /* STM32WBAxx_HAL_SMARTCARD_H */
