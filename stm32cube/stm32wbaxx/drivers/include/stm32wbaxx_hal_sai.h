...
#ifndef STM32WBAxx_HAL_SAI_H
#define STM32WBAxx_HAL_SAI_H
...
#else /* defined(STM32WBA62xx) || defined(STM32WBA63xx) || defined(STM32WBA64xx) || defined(STM32WBA65xx) */
  uint32_t         MicPairsNbr; /*!< Specifies the number of microphone pairs used.
...
#include "stm32wbaxx_hal_sai_ex.h"
