...
#ifndef STM32WBAxx_HAL_SPI_EX_H
#define STM32WBAxx_HAL_SPI_EX_H
...
/** @defgroup SPI_AutonomousMode_TriggerSelection Autonomous Mode Trigger Selection
  ...
  */
#if defined (SPI1)
#define SPI_TRIG_GRP1                   (0x10000000U)      /* Trigger Group for SPI1 */
#endif /* SPI1 */
