...
#ifndef STM32WBAxx_HAL_XSPI_H
#define STM32WBAxx_HAL_XSPI_H
...
#define HAL_XSPI_STATE_CMD_CFG               (0x00000004U)  /*!< Command (regular) configured, ready for an action                      */
#define HAL_XSPI_STATE_READ_CMD_CFG          (0x00000014U)  /*!< Read command configuration done                                        */
...
#define HAL_XSPI_DELAY_BLOCK_BYPASS          ((uint32_t)XSPI_DCR1_DLYBYP)  /*!< Delay block is bypassed                      */
/**
  * @}
  */
...
/** @defgroup XSPI_OperationType XSPI Operation Type
  * @{
  */
#define HAL_XSPI_OPTYPE_COMMON_CFG           (0x00000000U)  /*!< Common configuration (indirect mode)                 */
