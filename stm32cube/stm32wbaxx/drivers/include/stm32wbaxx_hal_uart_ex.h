...
#ifndef STM32WBAxx_HAL_UART_EX_H
#define STM32WBAxx_HAL_UART_EX_H
...
#define LPUART_LPTIM1_OUT_TRG       6U   /*!< LPUART LPTIM1 channe11 Internal Trigger  */
#if defined(COMP12_COMMON)
...
#define UART_GETCLOCKSOURCE(__HANDLE__,__CLOCKSOURCE__)       \
  do {                                                        \
    ...
    {                                                         \
      ...
      {                                                       \
        case RCC_LPUART1CLKSOURCE_PCLK7:                      \
          (__CLOCKSOURCE__) = UART_CLOCKSOURCE_PCLK7;         \
          break;                                              \
...
#endif /* STM32WBAxx_HAL_UART_EX_H */
