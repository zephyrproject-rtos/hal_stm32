...
#define VREFINT_CAL_ADDR                   ((uint16_t*) (0x0BF907A5UL)) /* Internal voltage reference, address of
                                           parameter VREFINT_CAL: VrefInt ADC raw data acquired at temperature 30 DegC
                                           (tolerance: +-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
#endif /* STM32WBA62xx || STM32WBA63xx || STM32WBA64xx || STM32WBA65xx */
...
#if defined(STM32WBA62xx) || defined(STM32WBA63xx) || defined(STM32WBA64xx) || defined(STM32WBA65xx)
/* Temperature sensor */
#define TEMPSENSOR_CAL1_ADDR               ((uint16_t*) (0x0BFA0710UL)) /* Address of parameter TS_CAL1: On this series,
                                           temperature sensor ADC raw data acquired at temperature  30 DegC
                                           (tolerance: +-5 DegC), Vref+ = 3.0 V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL2_ADDR               ((uint16_t*) (0x0BFA0742UL)) /* Address of parameter TS_CAL2: On this series,
