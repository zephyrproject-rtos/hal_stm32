...
#ifndef STM32WBAxx_HAL_UART_H
#define STM32WBAxx_HAL_UART_H
...
typedef enum
{
  ...
  UART_CLOCKSOURCE_PCLK7      = 0x02U,    /*!< PCLK7 clock source     */
  UART_CLOCKSOURCE_HSI        = 0x04U,    /*!< HSI clock source       */
  UART_CLOCKSOURCE_SYSCLK     = 0x08U,    /*!< SYSCLK clock source    */
...
/** @brief  Check UART Baud rate.
  ...
  *         The maximum Baud Rate is derived from the maximum clock on WBA (i.e. 100 MHz)
...
#include "stm32wbaxx_hal_uart_ex.h"
