...
#ifndef STM32WBAxx_LL_DLYB_H
#define STM32WBAxx_LL_DLYB_H
...
#if defined (DLYB_SDMMC1) || defined (DLYB_SDMMC2) || defined (DLYB_OCTOSPI1) || defined (DLYB_OCTOSPI2) || defined(DLYB1)
