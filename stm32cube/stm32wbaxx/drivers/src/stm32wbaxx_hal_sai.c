  ...
  ******************************************************************************
  ...
  [..]
    (@) Make sure that either:
        (+@) System clock is configured or
        (+@) HSI clock is configured or
        (+@) PLL_P output is configured or
        (+@) PLL_Q output is configured or
        (+@) External clock source is configured after setting correctly
             the define constant EXTERNAL_SAI1_CLOCK_VALUE in the stm32wbaxx_hal_conf.h file.
